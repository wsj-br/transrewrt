---
title: Riscrivi testo
description: >-
  Migliora la formulazione nella stessa lingua: chiarezza, tono, lunghezza,
  grammatica e altro ancora.
translation_last_updated: '2026-07-17T21:14:46.243Z'
...
Usa **Riscrivi** per migliorare la formulazione senza cambiarne il significato principale. Il testo rimane nella stessa lingua.
...
- **Migliora chiarezza**
- **Versioni alternative** (diverse riformulazioni in una sola esecuzione)
- **Rendi formale** / **Rendi informale**
- **Abbrevia** / **Espandi**
- **Rendi tecnico**
...
:::note
**Versioni alternative** restituisce diverse riformulazioni in una **singola** esecuzione, separate da `----`. Questo differisce da **Riformula…**, che crea una cronologia delle versioni nel tempo.
:::

...
title: त्वरित शुरुआत
description: >-
  विंडोज या लिनक्स पर ट्रांसरेवर्ट स्थापित करें, या स्व-होस्टेड डॉकर वेब ऐप
  चलाएं।
---
...
:::caution
डॉकर में, एलएलएम क्रेडेंशियल पर्यावरण चर के साथ सेट किए जाते हैं (उदाहरण के लिए `PROVIDER_API_KEY`)। वे वेब यूआई में दर्ज **नहीं** किए जाते हैं। डेस्कटॉप पर, आप **सेटिंग्स → एपीआई कॉन्फ़िग** में कुंजियाँ कॉन्फ़िगर करते हैं।
:::
...
:::note
विंडोज अहस्ताक्षरित इंडी ऐप्स के लिए यूएसी या स्मार्टस्क्रीन चेतावनी दिखा सकता है। आधिकारिक गिटहब रिलीज़ पेज से डाउनलोड को प्राथमिकता दें और प्रकाशित होने पर चेकसम सत्यापित करें।
:::

...
:::tip
У Docker облікові дані LLM встановлюються за допомогою змінних середовища (наприклад, `PROVIDER_API_KEY`). Вони **не** вводяться у веб-інтерфейсі. На робочому столі ви налаштовуєте ключі в **Налаштування → Конфігурація API**.
:::
...
:::note
Windows може показувати попередження UAC або SmartScreen під час встановлення програми. Встановлювати безпечно, якщо ви завантажуєте її з офіційної сторінки GitHub Releases. Натисніть «Додаткова інформація» та «Запустити все одно», щоб встановити.
:::

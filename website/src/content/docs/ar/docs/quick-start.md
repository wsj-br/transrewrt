...
:::tip
في Docker، يتم تعيين بيانات اعتماد LLM باستخدام متغيرات البيئة (على سبيل المثال `PROVIDER_API_KEY`). إنها **غير** مدخلة في واجهة المستخدم على الويب. على سطح المكتب، تقوم بتكوين المفاتيح في **الإعدادات → تكوين API**.
:::
...
:::note
قد تُظهر Windows تحذيرات UAC أو SmartScreen عند تثبيت التطبيق. من الآمن تثبيته إذا قمت بتنزيله من صفحة إصدارات GitHub الرسمية. انقر على "مزيد من المعلومات" و "تشغيل على أي حال" للتثبيت.
:::

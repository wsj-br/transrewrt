...
description: >-
  ...
  prompturi Transform.
translation_last_updated: '2026-07-17T14:59:02.199Z'
...
2. Faceți clic pe **Generați prompt**.
3. Descrieți ce doriți să facă promptul.
4. Alegeți o presetare (Ușor) sau un model (Avansat).
5. Examinați schița și faceți clic pe **Salvați**.

## Editați un prompt

Editorul este în stânga; o zonă de testare este în dreapta.

![Editor de prompturi Transform](/images/screenshots/ro/transform-prompt-edit.png)
...
:::caution
Faceți clic pe **Salvați** înainte de **Înapoi la Rulare**. Revenirea fără salvare anulează modificările.
:::

## Testare înainte de utilizarea zilnică

Utilizați panoul de testare din dreapta cu text eșantion atunci când creați sau comparați prompturi.

Exportați și importați prompturi în bloc sub [Setări → Transformare](/docs/settings/#transform).

---
translation_last_updated: '2026-05-27T10:06:54.995Z'
...
ਡਿਫ਼ਾਲਟ ਤੌਰ 'ਤੇ ਐਪ **ਆਸਾਨ** ਮੋਡ ਵਿੱਚ ਚੱਲਦੀ ਹੈ: ਤੁਸੀਂ ਸੈਟਿੰਗਜ਼ ਵਿੱਚ ਇੱਕ **ਪ੍ਰੀਸੈਟ** (ਉਦਾਹਰਨ ਲਈ ਮੁਫ਼ਤ (OpenRouter), ਲਾਈਟ, ਜਾਂ ਟੈਕਨੀਕਲ) ਅਤੇ ਇੱਕ **ਪ੍ਰਦਾਤਾ** ਚੁਣਦੇ ਹੋ, ਬਿਨਾਂ ਮਾਡਲ ID ਚੁਣੇ। ਜੇ ਤੁਸੀਂ [**ਸੈਟਿੰਗਜ਼** > **ਆਮ ਸੈਟਿੰਗਜ਼**](#general-settings) ਵਿੱਚ **ਉੱਨਤ** 'ਤੇ ਸਵਿੱਚ ਕਰਨਾ ਚਾਹੁੰਦੇ ਹੋ, ਤਾਂ [**ਸੈਟਿੰਗਜ਼** > **ਮਾਡਲ**](#models) ਤੋਂ ਕਲਾਸਿਕ ਮਾਡਲ ਸੂਚੀ ਪ੍ਰਾਪਤ ਕਰ ਸਕਦੇ ਹੋ।
...
- **ਆਸਾਨ** ਮੋਡ ਵਿੱਚ, ਇੱਕ **ਪ੍ਰੀਸੈਟ** ਇੱਕ ਪ੍ਰੀਸੈਟ ਹੁੰਦਾ ਹੈ (ਮੁਫ਼ਤ (OpenRouter), ਲਾਈਟ, ਉੱਨਤ, ਜਾਂ ਟੈਕਨੀਕਲ) ਜੋ ਤੁਹਾਡੇ ਚੁਣੇ ਹੋਏ **ਪ੍ਰਦਾਤਾ** (OpenRouter, OpenAI, Ollama, ਅਤੇ ਹੋਰ) ਲਈ ਇੱਕ ਮਾਡਲ ਨਾਲ ਮੇਲ ਖਾਂਦਾ ਹੈ। ਸਿਰਫ਼ ਉਹ ਸਕਿੱਲਜ਼ ਜੋ ਮੌਜੂਦਾ ਪ੍ਰਦਾਤਾ ਲਈ ਮੈਪਿੰਗ ਰੱਖਦੀਆਂ ਹਨ, ਟੂਲਬਾਰ ਵਿੱਚ ਦਿਖਾਈ ਦਿੰਦੀਆਂ ਹਨ। ਤੁਸੀਂ ਅਨੁਵਾਦ, ਪੁਨਰਲੇਖਨ, ਅਤੇ ਰੂਪਾਂਤਰਿਤ ਕਰੋ 'ਤੇ ਸਕਿੱਲ ਚੁਣਦੇ ਹੋ।
- **ਉੱਨਤ** ਮੋਡ ਵਿੱਚ, ਇੱਕ **ਮਾਡਲ** AI ਇੰਜਣ ਹੁੰਦਾ ਹੈ ਜਿਸਨੂੰ ਤੁਸੀਂ ਸਿੱਧੇ ਚੁਣਦੇ ਹੋ। ਮਾਡਲ ਆਈਡੀਜ਼ **ਪ੍ਰਦਾਤਾ ਪ੍ਰੀਫਿਕਸ** ਦੀ ਵਰਤੋਂ ਕਰਦੀਆਂ ਹਨ (ਉਦਾਹਰਨ ਲਈ `openrouter/…`, `openai/…`, `ollama/…`)।
- ਇੱਕ **API ਕੁੰਜੀ** (ਜਾਂ, Ollama ਲਈ, ਇੱਕ **ਬੇਸ URL**) ਉਹ ਤਰੀਕਾ ਹੈ ਜਿਸ ਨਾਲ ਐਪ ਉਸ ਪ੍ਰਦਾਤਾ ਤੱਕ ਪਹੁੰਚਦੀ ਹੈ।
...
**ਆਸਾਨ** ਮੋਡ ਵਿੱਚ, ਟੂਲਬਾਰ ਵਿੱਚ ਇੱਕ **ਪ੍ਰੀਸੈਟ ਚੁਣਨ ਵਾਲਾ** ਹੁੰਦਾ ਹੈ ਜਿਸ ਵਿੱਚ ਅੰਦਰੂਨੀ ਪ੍ਰੀਸੈਟ **ਮੁਫ਼ਤ (OpenRouter)**, **ਲਾਈਟ**, **ਉੱਨਤ**, ਅਤੇ **ਟੈਕਨੀਕਲ** ਹੁੰਦੇ ਹਨ। ਕਿਹੜੇ ਪ੍ਰੀਸੈਟ ਦਿਖਾਈ ਦਿੰਦੇ ਹਨ, ਇਹ [**ਸੈਟਿੰਗਜ਼** > **ਆਮ ਸੈਟਿੰਗਜ਼**](#general-settings) ਵਿੱਚ ਤੁਸੀਂ ਚੁਣੇ ਹੋਏ **ਪ੍ਰਦਾਤਾ** 'ਤੇ ਨਿਰਭਰ ਕਰਦਾ ਹੈ—ਉਦਾਹਰਨ ਲਈ, **ਮੁਫ਼ਤ (OpenRouter)** ਸਿਰਫ਼ ਤਾਂ ਸੂਚੀਬੱਧ ਹੁੰਦਾ ਹੈ ਜਦੋਂ ਪ੍ਰਦਾਤਾ OpenRouter ਹੁੰਦਾ ਹੈ। ਜੇ **ਪ੍ਰਦਾਤਾ** **Ollama** ਹੈ, ਤਾਂ ਟੂਲਬਾਰ ਪ੍ਰੀਸੈਟਾਂ ਦੀ ਬਜਾਏ ਤੁਹਾਡੇ ਮਸ਼ੀਨ 'ਤੇ ਸਥਾਪਿਤ ਸਥਾਨਕ ਮਾਡਲਾਂ ਨੂੰ ਸੂਚੀਬੱਧ ਕਰਦਾ ਹੈ।
...
- **ਆਸਾਨ** (ਡਿਫ਼ਾਲਟ): ਇੱਕ **ਪ੍ਰਦਾਤਾ** (OpenRouter, OpenAI, Anthropic, Google Gemini, DeepSeek, Groq, Mistral, xAI, Cerebras, ਜਾਂ Ollama) ਚੁਣੋ। ਕਲਾਊਡ ਪ੍ਰਦਾਤਾ ਟੂਲਬਾਰ ਵਿੱਚ ਅੰਦਰੂਨੀ ਪ੍ਰੀਸੈਟਾਂ ਦੀ ਵਰਤੋਂ ਕਰਦੇ ਹਨ। **Ollama** ਪ੍ਰੀਸੈਟਾਂ ਦੀ ਬਜਾਏ ਤੁਹਾਡੀ ਮਸ਼ੀਨ 'ਤੇ ਸਥਾਪਿਤ ਮਾਡਲਾਂ ਨੂੰ ਸੂਚੀਬੱਧ ਕਰਦਾ ਹੈ। ਆਸਾਨ ਮੋਡ ਵਿੱਚ, **ਪ੍ਰੀਸੈਟਾਂ ਦਾ ਕੈਟਲਾਗ** ਕੈਟਲਾਗ ਵਰਜਨ ਅਤੇ ਆਖਰੀ ਅਪਡੇਟ ਸਮਾਂ ਦਿਖਾਉਂਦਾ ਹੈ; ਪ੍ਰੋਜੈਕਟ ਰਿਪੋਜ਼ਟਰੀ ਤੋਂ ਨਵੀਨਤਮ ਸਕਿੱਲ ਸੂਚੀ ਪ੍ਰਾਪਤ ਕਰਨ ਲਈ **ਪ੍ਰੀਸੈਟਾਂ ਦਾ ਕੈਟਲਾਗ ਤਾਜ਼ਾ ਕਰੋ** 'ਤੇ ਕਲਿੱਕ ਕਰੋ (ਐਪ ਪਿਛੋਕੜ ਵਿੱਚ ਨਿਯਮਤ ਤੌਰ 'ਤੇ ਜਾਂਚ ਵੀ ਕਰਦੀ ਹੈ)।
- **ਉੱਨਤ**: ਟੂਲਬਾਰ ਵਿੱਚ ਵਿਅਕਤੀਗਤ ਮਾਡਲਾਂ ਨੂੰ ਚੁਣੋ; [**ਸੈਟਿੰਗਜ਼** > **ਮਾਡਲ**](#models) ਹੇਠਾਂ ਸੂਚੀ ਨੂੰ ਪਰਬੰਧਿਤ ਕਰੋ।
...
- ਇੱਕ ਵੱਖਰਾ ਪ੍ਰੀਸੈਟ (ਆਸਾਨ) ਜਾਂ ਮਾਡਲ (ਉੱਨਤ) ਚੁਣੋ
- ਇੱਕ ਛੋਟਾ ਇਨਪੁਟ ਵਰਤੋਂ
- [**ਸੈਟਿੰਗਜ਼** > **ਆਮ ਸੈਟਿੰਗਜ਼**](#general-settings) ਵਿੱਚ **ਰੀਅਲ-ਟਾਈਮ ਅਨੁਵਾਦ (ਟਾਈਪ ਕਰਦੇ ਸਮੇਂ)** ਨੂੰ ਬੰਦ ਕਰੋ
- ਸਧਾਰਨ ਕੰਮਾਂ ਲਈ ਮੁਫ਼ਤ ਮਾਡਲਾਂ ਦੀ ਵਰਤੋਂ ਕਰੋ (ਵੇਖੋ [ਮਾਡਲ](#models))

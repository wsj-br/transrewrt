...
- [ਅਨੁਵਾਦ ਕਰੋ](#translate)
  - [ਟਰਾਂਸਲੇਟ ਟੈਕਸਟ](#translate-text)
  - [ਭਾਸ਼ਾ ਚੋਣ](#language-selection)
  - [ਮਦਦਗਾਰ ਟਰਾਂਸਲੇਸ਼ਨ ਸੈਟਿੰਗਾਂ](#helpful-translation-settings)
  - [ਤੁਹਾਡੇ ਟਰਾਂਸਲੇਸ਼ਨ ਨੂੰ ਸੁਧਾਰਨਾ](#refining-translation)
- [Rewrite](#rewrite)
- [Transform](#transform)
  - [ਮੌਜੂਦਾ ਪ੍ਰੋਂਪਟ ਚਲਾਓ](#run-an-existing-prompt)
  - [ਜੇ ਤੁਹਾਡੇ ਕੋਲ ਕੋਈ ਪ੍ਰੋਂਪਟ ਨਹੀਂ ਹਨ](#if-you-have-no-prompts-yet)
  - [ਇੱਕ ਪ੍ਰੋਂਪਟ ਤੇਜ਼ੀ ਨਾਲ ਬਣਾਓ](#create-a-prompt-quickly)
  - [ਇੱਕ ਪ੍ਰੋਂਪਟ ਸੋਧੋ](#edit-a-prompt)
  - [ਇੱਕ ਪ੍ਰੋਂਪਟ ਦੀ ਜਾਂਚ ਕਰੋ ਇਸਤਮਾਲ ਕਰਨ ਤੋਂ ਪਹਿਲਾਂ](#test-a-prompt-before-using-it)
- [ਡੈਸ਼ਬੋਰਡ](#dashboard)
...
- [ਸੈਟਿੰਗਾਂ](#settings)
  ...
  - [Transform (ਸੈਟਿੰਗਾਂ ਟੈਬ)](#transform-settings-tab)
  - [ਉਪਭੋਗਤਾ](#users)
  - [API ਕੌਂਫਿਗਰੇਸ਼ਨ](#api-config)
  - [ਬਾਰੇ](#about)
- [ਆਮ ਸਮੱਸਿਆਵਾਂ](#common-issues)
  - [ਐਪ ਟੈਕਸਟ ਨੂੰ ਟਰਾਂਸਲੇਟ, ਰੀਰਾਈਟ ਜਾਂ ਟ੍ਰਾਂਸਫਾਰਮ ਨਹੀਂ ਕਰ ਰਹੀ](#the-app-will-not-translate-rewrite-or-transform-text)
  - [ਮਾਡਲ ਦੀ ਸੂਚੀ ਖਾਲੀ ਹੈ](#the-model-list-is-empty)
  ...
  - [ਡੈਸ਼ਬੋਰਡ ਸਾਰਾਂਸ਼ ਖਾਲੀ ਦਿਖਾਈ ਦੇ ਰਿਹਾ ਹੈ](#dashboard-summary-looks-empty)
  ...
  - [ਇਤਿਹਾਸ ਪੰਨਾ ਸਾਈਡਬਾਰ ਤੋਂ ਗਾਇਬ ਹੈ](#the-history-page-is-missing-from-the-sidebar)
  - [ਵੈੱਬ ਐਪ: ਅਚਾਨਕ ਲੌਗਿਨ ਪੰਨੇ 'ਤੇ ਮੁੜ ਦਿਓ](#web-app-redirected-to-the-login-page-unexpectedly)
  - [ਵੈੱਬ ਪ੍ਰਸ਼ਾਸਕ: ਪਾਸਵਰਡ ਭੁੱਲ ਜਾਂ ਗੁਆਚਿਆ](#web-admin-forgot-or-lost-a-password)
  - [ਡੈਸ਼ਬੋਰਡ ਹੋਰ ਉਪਭੋਗਤਾਵਾਂ ਲਈ ਕੋਈ ਡਾਟਾ ਨਹੀਂ ਦਿਖਾਉਂਦਾ (ਵੈੱਬ)](#dashboard-shows-no-data-for-other-users-web)
  - [ਮੈਂ ਇੱਕ ਪ੍ਰੋਂਪਟ ਬਦਲਿਆ ਅਤੇ ਸੋਧਾਂ ਗੁਆ ਦਿੱਤੀਆਂ](#i-changed-a-prompt-and-lost-the-edits)
- [ਤੁਰੰਤ ਸੁਝਾਅ](#quick-tips)
- [ਅਸਵੀਕਰਣ](#disclaimer)
- [ਲਾਇਸੈਂਸ](#license)
...
ਇੱਕ ਸਫਲ ਟਰਾਂਸਲੇਸ਼ਨ ਤੋਂ ਬਾਅਦ, ਤੁਸੀਂ ਨਤੀਜੇ ਨੂੰ ਆਉਟਪੁੱਟ ਪੈਨਲ ਵਿੱਚ ਸੁਧਾਰ ਸਕਦੇ ਹੋ:

1. **ਜੋੜੋ…** — ਆਉਟਪੁੱਟ ਵਿੱਚ ਕੋਈ ਪਾਠ ਚੁਣਿਆ ਨਾ ਹੋਣ 'ਤੇ, ਇੱਕ ਹੀ ਇਨਪੁੱਟ ਦਾ ਵੱਖਰਾ ਸ਼ਬਦਾਂ ਨਾਲ ਪੂਰਾ ਅਨੁਵਾਦ ਪ੍ਰਾਪਤ ਕਰੋ। ਤੁਸੀਂ **ਪੰਜ** ਵਰਜਨ ਤੱਕ ਸਟੋਰ ਕਰ ਸਕਦੇ ਹੋ ਅਤੇ ਵਰਜਨ ਡ੍ਰਾਪਡਾਊਨ ਵਿੱਚ ਉਨ੍ਹਾਂ ਵਿਚਕਾਰ ਬਦਲ ਸਕਦੇ ਹੋ। ਜਦੋਂ ਕੋਈ ਪਾਠ ਚੁਣਿਆ ਹੋਵੇ, **ਜੋੜੋ…** ਚੋਣ ਦੇ ਨੇੜੇ ਸ਼ਬਦ ਵਿਕਲਪ ਖੋਲ੍ਹਦਾ ਹੈ (ਜਿਵੇਂ ਕਿ ਸੱਜੇ-ਕਲਿੱਕ ਕਰਨ ਨਾਲ)। ਚੋਣ ਦੇ ਬਿਨਾਂ, **ਜੋੜੋ…** ਪੰਜ ਵਰਜਨ ਤੱਕ ਪਹੁੰਚਣ 'ਤੇ ਅਸਮਰੱਥ ਹੈ; ਚੋਣ ਦੇ ਨਾਲ, ਇਹ ਪੰਜ ਵਰਜਨਾਂ 'ਤੇ ਵੀ ਕੰਮ ਕਰਦਾ ਹੈ (ਸ਼ਬਦ ਵਿਕਲਪ ਹੀ, ਵਰਜਨ 5 ਨੂੰ ਅਪਡੇਟ ਕਰਨਾ)।
2. **ਸ਼ਬਦ ਵਿਕਲਪ** — ਆਉਟਪੁੱਟ ਵਿੱਚ ਇੱਕ ਜਾਂ ਇੱਕ ਤੋਂ ਵੱਧ ਸ਼ਬਦ ਚੁਣੋ (ਜੇ ਤੁਸੀਂ ਸਿਰਫ਼ ਸ਼ਬਦ ਦੇ ਹਿੱਸੇ ਨੂੰ ਚੁਣਦੇ ਹੋ, ਤਾਂ ਐਪ ਚੋਣ ਨੂੰ ਪੂਰੇ ਸ਼ਬਦਾਂ ਤੱਕ ਵਧਾਉਂਦਾ ਹੈ), ਫਿਰ ਸੱਜੇ-ਕਲਿੱਕ ਕਰੋ ਜਾਂ **ਜੋੜੋ…** 'ਤੇ ਕਲਿੱਕ ਕਰੋ। ਚੋਣ ਦੇ ਨੇੜੇ ਵਿਕਲਪਾਂ ਦੀ ਇੱਕ ਛੋਟੀ ਸੂਚੀ ਪ੍ਰਗਟ ਹੁੰਦੀ ਹੈ; ਇਸਨੂੰ ਬਦਲਣ ਲਈ ਇੱਕ 'ਤੇ ਕਲਿੱਕ ਕਰੋ। ਜੇ ਤੁਹਾਡੇ ਕੋਲ ਪੰਜ ਵਰਜਨ ਤੋਂ ਘੱਟ ਹਨ, ਤਾਂ ਸੋਧਿਆ ਗਿਆ ਆਉਟਪੁੱਟ ਇੱਕ ਨਵੇਂ ਵਰਜਨ ਵਜੋਂ ਸੁਰੱਖਿਅਤ ਕੀਤਾ ਜਾਂਦਾ ਹੈ; ਪੰਜ ਵਰਜਨਾਂ 'ਤੇ, ਸਿਰਫ਼ **ਵਰਜਨ 5** ਨੂੰ ਅਪਡੇਟ ਕੀਤਾ ਜਾਂਦਾ ਹੈ। ਕੋਈ ਚੋਣ ਨਾ ਹੋਣ 'ਤੇ ਸੱਜੇ-ਕਲਿੱਕ ਕੁਝ ਨਹੀਂ ਕਰਦਾ। ਬਿਨਾਂ ਆਉਟਪੁੱਟ ਬਦਲੇ ਰੱਦ ਕਰਨ ਲਈ **Esc** ਦਬਾਓ ਜਾਂ ਸੂਚੀ ਦੇ ਬਾਹਰ ਕਲਿੱਕ ਕਰੋ।
3. **ਲਾਗਤ** — ਹਰ ਪੂਰਾ **ਜੋੜੋ…** (ਕੋਈ ਚੋਣ ਨਹੀਂ) ਅਤੇ ਹਰ ਸ਼ਬਦ-ਵਿਕਲਪ ਦੀ ਬੇਨਤੀ ਮੁੜ ਮਾਡਲ ਦੀ ਵਰਤੋਂ ਕਰਦੀ ਹੈ ਅਤੇ ਵਰਤੋਂ ਦੀ ਲਾਗਤ ਵਿੱਚ ਵਾਧਾ ਕਰ ਸਕਦੀ ਹੈ (ਇੱਕ ਆਮ ਅਨੁਵਾਦ ਚਲਾਉਣ ਦੇ ਸਮਾਨ)।

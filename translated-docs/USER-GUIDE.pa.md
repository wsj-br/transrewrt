---
translation_last_updated: '2026-05-18T15:42:49.187Z'
...
ਡਿਫਾਲਟ ਵਜੋਂ ਐਪ **ਆਸਾਨ** ਮੋਡ ਵਿੱਚ ਚੱਲਦੀ ਹੈ: ਤੁਸੀਂ ਸੈਟਿੰਗਾਂ ਵਿੱਚ ਇੱਕ **ਕੁਸ਼ਲਤਾ** (ਉਦਾਹਰਨ ਵਜੋਂ ਮੁਫ਼ਤ, ਤੇਜ਼, ਜਾਂ ਤਕਨੀਕੀ) ਅਤੇ ਇੱਕ **ਪ੍ਰਦਾਤਾ** ਚੁਣਦੇ ਹੋ, ਬਿਨਾਂ ਮਾਡਲ ID ਚੁਣੇ। ਜੇ ਤੁਸੀਂ [**ਸੈਟਿੰਗਾਂ** > **ਆਮ ਸੈਟਿੰਗਾਂ**](#general-settings) ਵਿੱਚ ਪੁਰਾਣੀ ਮਾਡਲ ਸੂਚੀ ਚਾਹੁੰਦੇ ਹੋ ਤਾਂ **ਉੱਨਤ** ਵਿੱਚ ਬਦਲੋ [**ਸੈਟਿੰਗਾਂ** > **ਮਾਡਲ**](#models) ਤੋਂ।
...
- [ਸੈਟਿੰਗਜ਼](#settings)
  ...
  - [ਰੂਪਾਂਤਰਿਤ ਕਰੋ (ਸੈਟਿੰਗਾਂ ਟੈਬ)](#transform-settings)
  - [ਯੂਜ਼ਰ](#users)
...
- **ਆਸਾਨ** ਮੋਡ ਵਿੱਚ, ਇੱਕ **ਕੁਸ਼ਲਤਾ** ਇੱਕ ਪ੍ਰੀਸੈਟ (ਮੁਫ਼ਤ, ਤੇਜ਼, ਉੱਨਤ, ਤਕਨੀਕੀ, ਕਾਨੂੰਨੀ) ਹੈ ਜੋ ਤੁਹਾਡੇ ਚੁਣੇ ਹੋਏ **ਪ੍ਰਦਾਤਾ** (OpenRouter, OpenAI, Ollama, ਅਤੇ ਹੋਰ) ਲਈ ਇੱਕ ਮਾਡਲ ਨਾਲ ਜੋੜੀ ਜਾਂਦੀ ਹੈ। ਤੁਸੀਂ ਅਨੁਵਾਦ, ਪੁਨਰਲੇਖਨ, ਅਤੇ ਰੂਪਾਂਤਰਿਤ ਕਰੋ 'ਤੇ ਟੂਲਬਾਰ ਵਿੱਚ ਕੁਸ਼ਲਤਾ ਚੁਣਦੇ ਹੋ।
- **ਉੱਨਤ** ਮੋਡ ਵਿੱਚ, ਇੱਕ **ਮਾਡਲ** ਉਹ AI ਇੰਜਣ ਹੈ ਜੋ ਤੁਸੀਂ ਸਿੱਧਾ ਚੁਣਦੇ ਹੋ। ਮਾਡਲ ID ਇੱਕ **ਪ੍ਰਦਾਤਾ ਪੂਰਕ** ਵਰਤਦੇ ਹਨ (ਉਦਾਹਰਨ ਵਜੋਂ `openrouter/…`, `openai/…`, `ollama/…`)।
- ਇੱਕ **API ਕੁੰਜੀ** (ਜਾਂ, Ollama ਲਈ, ਇੱਕ **ਬੇਸ URL**) ਹੈ ਕਿ ਐਪ ਉਸ ਪ੍ਰਦਾਤਾ ਤੱਕ ਕਿਵੇਂ ਪਹੁੰਚਦੀ ਹੈ।

ਜੇ ਤੁਸੀਂ **ਡੈਸਕਟਾਪ ਐਪ** ਵਰਤ ਰਹੇ ਹੋ, ਤਾਂ ਹਰ ਪ੍ਰਦਾਤਾ ਲਈ [**ਸੈਟਿੰਗਾਂ** > **API ਕਾਨਫਿਗ**](#api-config) ਵਿੱਚ ਕੁੰਜੀਆਂ ਜੋੜੋ। ਸਿਰਫ OpenRouter ਦੀ ਵਰਤੋਂ ਲਈ, ਹੇਠਾਂ [ਮੁਫ਼ਤ OpenRouter API ਕੁੰਜੀ ਕਿਵੇਂ ਪ੍ਰਾਪਤ ਕਰੀਏ](#how-to-get-an-api-key-desktop-app) ਨੂੰ ਦੇਖੋ। ਜੇ ਤੁਸੀਂ API ਕੁੰਜੀ ਵਰਤਣਾ ਨਹੀਂ ਚਾਹੁੰਦੇ, ਤਾਂ ਤੁਸੀਂ Ollama (ਜੋ [ollama.com](https://ollama.com) ਤੋਂ ਹੈ) ਨੂੰ ਇੰਸਟਾਲ ਕਰ ਸਕਦੇ ਹੋ ਅਤੇ ਸਥਾਨਕ ਮਾਡਲਾਂ ਦੀ ਵਰਤੋਂ ਕਰ ਸਕਦੇ ਹੋ, ਜਿਵੇਂ `translategemma:4b`।
...
**ਆਸਾਨ** ਮੋਡ ਵਿੱਚ, ਟੂਲਬਾਰ ਇੱਕ **ਕੁਸ਼ਲਤਾ ਚੋਣਕਰਤਾ** (ਮੁਫ਼ਤ, ਤੇਜ਼, ਉੱਨਤ, ਤਕਨੀਕੀ, ਕਾਨੂੰਨੀ, ਅਤੇ ਸਮਾਨ ਪ੍ਰੀਸੈਟ) ਦਿਖਾਉਂਦਾ ਹੈ। ਕੁਸ਼ਲਤਾਵਾਂ ਉਸ **ਪ੍ਰਦਾਤਾ** 'ਤੇ ਨਿਰਭਰ ਕਰਦੀਆਂ ਹਨ ਜੋ ਤੁਸੀਂ [**ਸੈਟਿੰਗਾਂ** > **ਆਮ ਸੈਟਿੰਗਾਂ**](#general-settings) ਵਿੱਚ ਚੁਣਿਆ। ਜੇ **ਪ੍ਰਦਾਤਾ** **Ollama** ਹੈ, ਤਾਂ ਟੂਲਬਾਰ ਤੁਹਾਡੇ ਇੰਸਟਾਲ ਕੀਤੇ ਸਥਾਨਕ ਮਾਡਲਾਂ ਦੀ ਸੂਚੀ ਦਿਖਾਉਂਦਾ ਹੈ ਨਾ ਕਿ ਕੁਸ਼ਲਤਾਵਾਂ।
...
- **ਆਸਾਨ** (ਡਿਫਾਲਟ): ਇੱਕ **ਪ੍ਰਦਾਤਾ** (OpenRouter, OpenAI, Anthropic, Google Gemini, DeepSeek, Groq, Mistral, xAI, Cerebras, ਜਾਂ Ollama) ਚੁਣੋ। ਕਲਾਉਡ ਪ੍ਰਦਾਤਾ ਟੂਲਬਾਰ ਵਿੱਚ ਬਣੇ-ਬਣਾਏ ਕੁਸ਼ਲਤਾ ਪ੍ਰੀਸੈਟ ਦੀ ਵਰਤੋਂ ਕਰਦੇ ਹਨ। **Ollama** ਤੁਹਾਡੇ ਮਸ਼ੀਨ 'ਤੇ ਇੰਸਟਾਲ ਕੀਤੇ ਮਾਡਲਾਂ ਨੂੰ ਕੁਸ਼ਲਤਾਵਾਂ ਦੇ ਬਦਲੇ ਸੂਚੀਬੱਧ ਕਰਦਾ ਹੈ।
- **ਉੱਨਤ**: ਟੂਲਬਾਰ ਵਿੱਚ ਵਿਅਕਤੀਗਤ ਮਾਡਲ ਚੁਣੋ; ਸੂਚੀ ਨੂੰ [**ਸੈਟਿੰਗਜ਼** > **ਮਾਡਲ**](#models) ਦੇ ਅਧੀਨ ਪ੍ਰਬੰਧਿਤ ਕਰੋ।

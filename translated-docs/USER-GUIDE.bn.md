---
translation_last_updated: '2026-05-27T10:06:28.052Z'
...
ডিফল্টভাবে অ্যাপটি **সহজ** মোডে চলে: আপনি **প্রিসেট** (যেমন ফ্রি (ওপেনরাউটার), লাইট, বা টেকনিক্যাল) এবং **প্রদানকারী** নির্বাচন করেন সেটিংসে, মডেল আইডি নির্বাচন না করেই। [**সেটিংস** > **সাধারণ সেটিংস**](#general-settings) এ ক্লাসিক মডেল তালিকা পেতে **উন্নত** মোডে স্যুইচ করুন [**সেটিংস** > **মডেলগুলি**](#models) থেকে।
...
- **সহজ** মোডে, একটি **প্রিসেট** হল একটি প্রিসেট (ফ্রি (ওপেনরাউটার), লাইট, উন্নত, বা টেকনিক্যাল) যা আপনার নির্বাচিত **প্রদানকারী** (ওপেনরাউটার, ওপেনএআই, ওলামা, এবং অন্যান্য) এর জন্য একটি মডেলের সাথে মানচিত্র করে। শুধুমাত্র সেই দক্ষতাগুলি টুলবারে প্রদর্শিত হয় যেগুলির বর্তমান প্রদানকারীর জন্য একটি মানচিত্র রয়েছে। আপনি অনুবাদ, পুনঃলেখন, এবং রূপান্তর করার জন্য দক্ষতা নির্বাচন করেন।
...
**সহজ** মোডে, টুলবারে একটি **প্রিসেট সিলেক্টর** প্রদর্শিত হয় বিল্ট-ইন প্রিসেটগুলি **ফ্রি (ওপেনরাউটার)**, **লাইট**, **উন্নত**, এবং **টেকনিক্যাল**। কোন প্রিসেটগুলি প্রদর্শিত হবে তা নির্ভর করে আপনি [**সেটিংস** > **সাধারণ সেটিংস**](#general-settings) এ যে **প্রদানকারী** নির্বাচন করেছেন তার উপর—যেমন, **ফ্রি (ওপেনরাউটার)** শুধুমাত্র তখন তালিকাভুক্ত হয় যখন প্রদানকারী ওপেনরাউটার। যদি **প্রদানকারী** **ওলামা** হয়, টুলবার আপনার ইনস্টল করা স্থানীয় মডেলগুলি প্রদর্শন করে প্রিসেটগুলির পরিবর্তে।
...
- **সহজ** (ডিফল্ট): একটি **প্রদানকারী** নির্বাচন করুন (ওপেনরাউটার, ওপেনএআই, অ্যানথ্রোপিক, গুগল জেমিনি, ডিপসীক, গ্রোক, মিস্ট্রাল, এক্সএআই, সেরেব্রাস, বা ওলামা)। ক্লাউড প্রদানকারীরা টুলবারে বিল্ট-ইন প্রিসেটগুলি ব্যবহার করে। **ওলামা** আপনার মেশিনে ইনস্টল করা মডেলগুলি প্রদর্শন করে প্রিসেটগুলির পরিবর্তে। সহজ মোডে, **প্রিসেটের তালিকা** ক্যাটালগ সংস্করণ এবং শেষ আপডেট সময় দেখায়; সর্বশেষ দক্ষতার তালিকা পেতে **প্রিসেট তালিকা রিফ্রেশ করুন** এ ক্লিক করুন (অ্যাপটি পটভূমিতে সময়ে সময়ে চেক করে)।
...
- একটি ভিন্ন প্রিসেট (সহজ) বা মডেল (উন্নত) নির্বাচন করুন

...
- [অনুবাদ করুন](#translate)
  ...
  - [গ্লসারি ব্যবহার](#using-the-glossary)
- [পুনরায় লিখন](#rewrite)
- [রূপান্তর](#transform)
  - [বিদ্যমান প্রম্পট চালান](#run-an-existing-prompt)
  - [যদি আপনার কাছে এখনও কোনো প্রম্পট না থাকে](#if-you-have-no-prompts-yet)
...
- [সাধারণ সমস্যা](#common-issues)
  ...
  - [টেক্সট খুব ছোট বা পড়তে অসুবিধা হচ্ছে](#the-text-is-too-small-or-hard-to-read)
  ...
  - [সাইডবার থেকে ইতিহাস পৃষ্ঠাটি অনুপস্থিত](#the-history-page-is-missing-from-the-sidebar)
  - [ওয়েব অ্যাপ: অপ্রত্যাশিতভাবে লগইন পৃষ্ঠায় পুনঃনির্দেশিত](#web-app-redirected-to-the-login-page-unexpectedly)
  - [ওয়েব অ্যাডমিন: পাসওয়ার্ড ভুলে গেছেন বা হারিয়ে ফেলেছেন](#web-admin-forgot-or-lost-a-password)
  - [অন্যান্য ব্যবহারকারীদের জন্য ড্যাশবোর্ডে কোনো ডেটা দেখাচ্ছে না (ওয়েব)](#dashboard-shows-no-data-for-other-users-web)
...
1. **Rephrase…** — আউটপুটে কোন টেক্সট নির্বাচিত না থাকলে, একই ইনপুটের একটি সম্পূর্ণ অনুবাদ অন্য শব্দের সাথে পান। মডেলটি আপনার কাছে ইতিমধ্যেই থাকা প্রতিটি সংস্করণ গ্রহণ করে যাতে নতুন শব্দগুলি তাদের সকলের থেকে আলাদা হতে পারে। আপনি **পাঁচটি** সংস্করণ পর্যন্ত সংরক্ষণ করতে পারেন এবং সংস্করণ ড্রপডাউনে তাদের মধ্যে পরিবর্তন করতে পারেন। টেক্সট নির্বাচিত থাকলে, **Rephrase…** নির্বাচনের কাছে শব্দ বিকল্পগুলি খুলে দেয় (ডান-ক্লিকের মতো)। কোন নির্বাচন ছাড়া, পাঁচটি সংস্করণে পৌঁছালে **Rephrase…** নিষ্ক্রিয় হয়ে যায়; একটি নির্বাচনের সাথে, এটি এখনও পাঁচটি সংস্করণে কাজ করে (শব্দ বিকল্পগুলি শুধুমাত্র, সংস্করণ 5 আপডেট করে)। একটি পূর্ণ পুনঃবিবেচনা চলাকালীন, বাতিল করতে **Stop Translate** ক্লিক করুন; আউটপুটটি পুনঃবিবেচনা শুরু হওয়ার সময় সক্রিয় সংস্করণে ফিরে আসে।
2. **শব্দ বিকল্পগুলি** — আউটপুটে একটি বা একাধিক শব্দ বা একটি সংক্ষিপ্ত বাক্যাংশ নির্বাচন করুন (যদি আপনি শুধুমাত্র একটি শব্দের অংশ নির্বাচন করেন, অ্যাপটি নির্বাচনের জন্য পূর্ণ শব্দে প্রসারিত করে), তারপর ডান-ক্লিক করুন বা **Rephrase…** ক্লিক করুন। নির্বাচনের কাছে বিকল্পগুলির একটি সংক্ষিপ্ত তালিকা প্রদর্শিত হয়; একটিতে ক্লিক করে এটি প্রতিস্থাপন করুন। প্রতিটি বিকল্প আপনার নির্বাচনের চেয়ে কিছুটা বিস্তৃত পরিসর প্রতিস্থাপন করতে পারে (যেমন একটি পার্শ্ববর্তী পূর্বপদ বা আর্টিকেল) যাতে বাক্যটি ব্যাকরণগত থাকে। যদি আপনার পাঁচটির কম সংস্করণ থাকে, তবে সম্পাদিত আউটপুটটি একটি নতুন সংস্করণ হিসাবে সংরক্ষিত হয়; পাঁচটি সংস্করণে, কেবলমাত্র **সংস্করণ 5** আপডেট হয়। কোন নির্বাচন ছাড়া ডান-ক্লিক করা কিছুই করে না। আউটপুট পরিবর্তন না করে বাতিল করতে **Esc** চাপুন বা তালিকার বাইরে ক্লিক করুন।
3. **খরচ** — প্রতিটি পূর্ণ **Rephrase…** (কোন নির্বাচন নেই) এবং প্রতিটি শব্দ-বিকল্প অনুরোধ আবার মডেলটি ব্যবহার করে এবং ব্যবহারের খরচ বাড়াতে পারে (সাধারণ অনুবাদ চলনের মতো)।

...
- [সাধারণ সমস্যা](#common-issues)
  - [অ্যাপটি অনুবাদ, পুনরায় লিখন, বা টেক্সট রূপান্তর করতে পারছে না](#the-app-will-not-translate-rewrite-or-transform-text)
  - [মডেল তালিকা খালি](#the-model-list-is-empty)
  - [ফলাফল খুব ধীর বা খুব ব্যয়বহুল](#the-result-is-too-slow-or-too-expensive)
  - [ইন্টারফেসটি ভুল ভাষায় আছে](#the-interface-is-in-the-wrong-language)
  - [টেক্সটটি খুব ছোট বা পড়তে কঠিন](#the-text-is-too-small-or-hard-to-read)
  ...
  - [সাইডবার থেকে ইতিহাস পৃষ্ঠা অনুপস্থিত](#the-history-page-is-missing-from-the-sidebar)
  - [ওয়েব অ্যাপ: অপ্রত্যাশিতভাবে লগইন পৃষ্ঠায় পুনর্নির্দেশিত](#web-app-redirected-to-the-login-page-unexpectedly)
  - [ওয়েব প্রশাসক: পাসওয়ার্ড ভুলে গেছেন বা হারিয়ে ফেলেছেন](#web-admin-forgot-or-lost-a-password)

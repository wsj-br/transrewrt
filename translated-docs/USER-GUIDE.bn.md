---
translation_last_updated: '2026-05-21T23:10:33.279Z'
...
ডিফল্টভাবে অ্যাপটি **সহজ** মোডে চলে: আপনি **দক্ষতা** নির্বাচন করেন (যেমন ফ্রি (ওপেনরাউটার), লাইট, বা টেকনিক্যাল) এবং সেটিংসে একটি **প্রদানকারী** নির্বাচন করেন, মডেল আইডি নির্বাচন না করেই। যদি আপনি [**সেটিংস** > **সাধারণ সেটিংস**](#general-settings) থেকে ক্লাসিক মডেল তালিকা চান তবে **উন্নত** মোডে স্যুইচ করুন [**সেটিংস** > **মডেলগুলি**](#models) থেকে।
...
- **সহজ** মোডে, একটি **দক্ষতা** হল একটি প্রিসেট (ফ্রি (ওপেনরাউটার), লাইট, উন্নত, বা টেকনিক্যাল) যা আপনার নির্বাচিত **প্রদানকারী** (ওপেনরাউটার, ওপেনএআই, ওলামা, এবং অন্যান্য) এর জন্য একটি মডেলের সাথে মানচিত্র করে। শুধুমাত্র সেই দক্ষতাগুলি যা বর্তমান প্রদানকারীর জন্য একটি মানচিত্র রয়েছে তা টুলবারে প্রদর্শিত হয়। আপনি অনুবাদ, পুনঃলেখন, এবং রূপান্তরের জন্য দক্ষতা নির্বাচন করেন।
- **উন্নত** মোডে, একটি **মডেল** হল AI ইঞ্জিন যা আপনি সরাসরি নির্বাচন করেন। মডেল আইডি একটি **প্রদানকারী প্রিফিক্স** ব্যবহার করে (যেমন `openrouter/…`, `openai/…`, `ollama/…`)।
- একটি **API কী** (অথবা, ওলামার জন্য, একটি **বেস URL**) হল কিভাবে অ্যাপটি সেই প্রদানকারীর সাথে সংযোগ স্থাপন করে।
...
**সহজ** মোডে, টুলবারে একটি **দক্ষতা নির্বাচনকারী** প্রদর্শিত হয় যার মধ্যে অন্তর্নির্মিত প্রিসেটগুলি **ফ্রি (ওপেনরাউটার)**, **লাইট**, **উন্নত**, এবং **টেকনিক্যাল** রয়েছে। কোন দক্ষতাগুলি প্রদর্শিত হবে তা নির্ভর করে আপনি [**সেটিংস** > **সাধারণ সেটিংস**](#general-settings) এ যে **প্রদানকারী** নির্বাচন করেছেন তার উপর—যেমন, **ফ্রি (ওপেনরাউটার)** শুধুমাত্র তখন তালিকাভুক্ত হয় যখন প্রদানকারী ওপেনরাউটার হয়। যদি **প্রদানকারী** **ওলামা** হয়, তবে টুলবারে আপনার ইনস্টল করা স্থানীয় মডেলগুলি দক্ষতার পরিবর্তে তালিকাভুক্ত হয়।
...
- **ENTER এর জন্য আচরণ** নিয়ন্ত্রণ করে যখন আপনি `Enter` চাপেন:
  - **Enter** অনুবাদ বা পুনঃলেখন চালায় (ডিফল্ট)।
  - **Shift + Enter** অনুবাদ বা পুনঃলেখন চালায়; সাধারণ **Enter** একটি নতুন লাইন সন্নিবেশ করে।
...
3. আপনি প্রম্পটটি কী করতে চান তা বর্ণনা করুন।
4. একটি দক্ষতা (সহজ) বা মডেল (উন্নত) নির্বাচন করুন।
...
- **সহজ** (ডিফল্ট): একটি **প্রদানকারী** নির্বাচন করুন (ওপেনরাউটার, ওপেনএআই, অ্যানথ্রোপিক, গুগল জেমিনি, ডিপসীক, গ্রোক, মিস্ট্রাল, এক্সএআই, সেরেব্রাস, বা ওলামা)। ক্লাউড প্রদানকারীরা টুলবারে অন্তর্নির্মিত দক্ষতা প্রিসেটগুলি ব্যবহার করে। **ওলামা** দক্ষতার পরিবর্তে আপনার মেশিনে ইনস্টল করা মডেলগুলি তালিকাভুক্ত করে। সহজ মোডে, **দক্ষতা তালিকা** তালিকা সংস্করণ এবং শেষ আপডেট সময় দেখায়; সর্বশেষ দক্ষতার তালিকা প্রকল্প রিপোজিটরি থেকে আনতে **দক্ষতা তালিকা রিফ্রেশ করুন** এ ক্লিক করুন (অ্যাপটি পটভূমিতে সময়ে সময়ে পরীক্ষা করে)।
- **উন্নত**: টুলবারে পৃথক মডেলগুলি নির্বাচন করুন; [**সেটিংস** > **মডেলগুলি**](#models) এর অধীনে তালিকাটি পরিচালনা করুন।

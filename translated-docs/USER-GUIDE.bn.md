...
- [অনুবাদ করুন](#translate)
  ...
  - [আপনার অনুবাদ পরিমার্জন](#refining-your-translation)
  - [গ্লসারি ব্যবহার করা](#using-the-glossary)
- [পুনরায় লিখন](#rewrite)
  - [টেক্সট পুনরায় লিখুন](#rewrite-text)
  - [আপনার পুনরায় লিখন পরিমার্জন করা](#refining-your-rewrite)
- [রূপান্তর](#transform)
  - [একটি বিদ্যমান প্রম্পট চালান](#run-an-existing-prompt)
  - [যদি আপনার এখনও কোনো প্রম্পট না থাকে](#if-you-have-no-prompts-yet)
...
- [সেটিংস](#settings)
  ...
  - [গ্লসারি (সেটিংস ট্যাব)](#glossary-settings-tab)
  - [ব্যবহারকারীগণ](#users)
  - [API কনফিগারেশন](#api-config)
  - [সম্পর্কে](#about)
- [সাধারণ সমস্যাগুলি](#common-issues)
  - [অ্যাপটি টেক্সট অনুবাদ, পুনরায় লিখন বা রূপান্তর করবে না](#the-app-will-not-translate-rewrite-or-transform-text)
  ...
  - [ইতিহাস পৃষ্ঠাটি সাইডবার থেকে অনুপস্থিত](#the-history-page-is-missing-from-the-sidebar)
  - [ওয়েব অ্যাপ: অপ্রত্যাশিতভাবে লগইন পৃষ্ঠায় পুনঃনির্দেশিত হয়েছে](#web-app-redirected-to-the-login-page-unexpectedly)
  - [ওয়েব প্রশাসক: একটি পাসওয়ার্ড ভুলে গেছেন বা হারিয়েছেন](#web-admin-forgot-or-lost-a-password)
...
![মডেল নির্বাচক](../images/screenshots/bn/preset-selector.png)
...
9. ঐচ্ছিকভাবে ফলাফলটি **Rephrase…** বা শব্দ বিকল্পগুলি দিয়ে পরিশোধিত করুন — [আপনার অনুবাদ পরিশোধিত করা](#refining-translation) দেখুন।
...
### আপনার অনুবাদ পরিশোধন করা

একটি সফল অনুবাদের পরে, আউটপুট হেডারে **Rephrase…** এবং সংস্করণ ড্রপডাউনটি **To:** ভাষা নির্বাচকের পাশে প্রদর্শিত হয়। আপনি সেখানে ফলাফলটি পরিশোধিত করতে পারেন:

1. **পুনরায় লিখুন…** — আউটপুটে কোনো টেক্সট নির্বাচিত না থাকলে, একই ইনপুটের ভিন্ন শব্দ ব্যবহার করে আরেকটি সম্পূর্ণ অনুবাদ পান। মডেলটি আপনার কাছে থাকা প্রতিটি সংস্করণ গ্রহণ করে যাতে নতুন শব্দগুলি তাদের সবগুলি থেকে ভিন্ন হতে পারে। আপনি সর্বোচ্চ **পাঁচটি** সংস্করণ সংরক্ষণ করতে পারেন এবং সংস্করণ ড্রপডাউনে তাদের মধ্যে স্যুইচ করতে পারেন। টেক্সট নির্বাচিত থাকলে, **পুনরায় লিখুন…** নির্বাচনের কাছাকাছি শব্দের বিকল্পগুলি খোলে (রাইট-ক্লিকের মতোই)। নির্বাচন ছাড়া, পাঁচটি সংস্করণে পৌঁছানোর পরে **পুনরায় লিখুন…** নিষ্ক্রিয় হয়ে যায়; একটি নির্বাচন সহ, এটি এখনও পাঁচটি সংস্করণে কাজ করে (শুধুমাত্র শব্দের বিকল্প, সংস্করণ 5 আপডেট করা)। একটি সম্পূর্ণ পুনরায় লিখন চলাকালীন, বাতিল করতে **অনুবাদ থামান** ক্লিক করুন; আউটপুট সেই সংস্করণে ফিরে আসে যা পুনরায় লিখন শুরু হওয়ার সময় সক্রিয় ছিল।
2. **শব্দের বিকল্প** — আউটপুটে এক বা একাধিক শব্দ বা একটি ছোট বাক্য নির্বাচন করুন (যদি আপনি একটি শব্দের শুধুমাত্র অংশ নির্বাচন করেন, অ্যাপটি নির্বাচনটিকে সম্পূর্ণ শব্দে প্রসারিত করে), তারপর রাইট-ক্লিক করুন বা **পুনরায় লিখুন…** ক্লিক করুন। নির্বাচনের কাছাকাছি বিকল্পগুলির একটি সংক্ষিপ্ত তালিকা প্রদর্শিত হয়; এটি প্রতিস্থাপন করতে একটিতে ক্লিক করুন। প্রতিটি বিকল্প আপনার নির্বাচনের চেয়ে কিছুটা বিস্তৃত স্থান প্রতিস্থাপন করতে পারে (উদাহরণস্বরূপ একটি সংলগ্ন অব্যয় বা নিবন্ধ) যাতে বাক্যটি ব্যাকরণগতভাবে সঠিক থাকে। যদি আপনার পাঁচটি সংস্করণের কম থাকে, তবে সম্পাদিত আউটপুট একটি নতুন সংস্করণ হিসাবে সংরক্ষিত হয়; পাঁচটি সংস্করণে, শুধুমাত্র **সংস্করণ 5** আপডেট করা হয়। কোনো নির্বাচন ছাড়া রাইট-ক্লিক করলে কার্সারের নিচে থাকা শব্দটি নির্বাচিত হয় (অথবা সেখানে কোনো শব্দ না থাকলে কিছুই হয় না)। আউটপুট পরিবর্তন না করে বাতিল করতে **Esc** চাপুন বা তালিকার বাইরে ক্লিক করুন।
3. **খরচ** — প্রতিটি সম্পূর্ণ **পুনরায় লিখুন…** (কোনো নির্বাচন নেই) এবং প্রতিটি শব্দ-বিকল্প অনুরোধ মডেলটিকে আবার ব্যবহার করে এবং ব্যবহারের খরচ বাড়াতে পারে (একটি স্বাভাবিক অনুবাদ চালানোর মতোই)।
...
একটি **গ্লসারি** হল একটি নির্দিষ্ট ভাষা জোড়ার জন্য উৎস/লক্ষ্য শব্দ জোড়ার একটি তালিকা। যখন গ্লসারি চালু থাকে, Transrewrt মডেলের কাছে মিলে যাওয়া শব্দগুলি পাঠায় যাতে আপনার পছন্দের শব্দগুলি অনুবাদের সময় সামঞ্জস্যপূর্ণ থাকে (উদাহরণস্বরূপ একটি পণ্যের নাম, একটি ব্র্যান্ডের শব্দ, বা একটি চাকরির শিরোনাম যা সর্বদা একই ভাবে অনুবাদ করা উচিত)।

**অনুবাদ** পৃষ্ঠায় এটি ব্যবহার করতে:

1. ইনপুট প্যানেলে **গ্লসারি** সুইচটি চালু করুন (স্বয়ংক্রিয় নির্বাহ এবং স্বয়ংক্রিয় কপি সুইচের পাশে)।
2. আপনার **থেকে** এবং **প্রতি** ভাষাগুলি চয়ন করুন এবং স্বাভাবিকভাবে অনুবাদ করুন। সেই ভাষা জোড়ার জন্য সংরক্ষিত শব্দগুলি স্বয়ংক্রিয়ভাবে প্রয়োগ করা হয়।
3. ফ্লাইতে একটি নতুন জোড়া ক্যাপচার করতে, **গ্লসারিতে যোগ করুন** ক্লিক করুন (**থেকে:** ভাষা নির্বাচকের পাশে)। ডায়ালগটি আপনার বর্তমান ভাষাগুলির সাথে পূর্ব-পূরণ করা হয় তাই আপনাকে কেবল **উৎস শব্দ** এবং **লক্ষ্য শব্দ** পূরণ করতে হবে।
4. আপনার সমস্ত শব্দ পর্যালোচনা করতে আউটপুট ফুটারে **গ্লসারি** লিঙ্কটি (বা ডায়ালগের ভিতরে **গ্লসারি পরিচালনা করুন** লিঙ্ক) ব্যবহার করে [**সেটিংস** > **গ্লসারি**](#glossary-settings) তে যান।

আপনি [**সেটিংস** > **গ্লসারি**](#glossary-settings) ট্যাবে শব্দগুলি যুক্ত, সম্পাদনা, আমদানি এবং রপ্তানি করতে পারেন — নীচে দেখুন।

<br/>

> ℹ️ **দ্রষ্টব্য**<br/>
> গ্লসারি শব্দগুলি **ভাষা জোড়া** দ্বারা মিলে যায়, তাই ইংরেজি → ফরাসি-এর জন্য সংরক্ষিত একটি শব্দ ইংরেজি → জার্মান অনুবাদ করার সময় প্রয়োগ করা হয় না। উৎস হিসাবে **ভাষা শনাক্ত করুন** ব্যবহার করা যাবে না, কারণ শব্দগুলি মেলানোর জন্য একটি নির্দিষ্ট উৎস ভাষা প্রয়োজন।
...
আপনি যখন মূল অর্থ পরিবর্তন না করে শব্দবিন্যাস উন্নত করতে চান তখন **পুনরায় লিখুন** ব্যবহার করুন। টেক্সট একই ভাষায় থাকে (এটি অনুবাদ করা হয় না)।

![পুনরায় লিখন ওয়ার্কস্পেস](../images/screenshots/bn/rewrite.png)
...
<a id="rewrite-text"></a>
### টেক্সট পুনরায় লিখুন

1. **পুনরায় লিখন** খুলুন।
2. একটি **মোড** বেছে নিন (উদাহরণস্বরূপ **স্পষ্টতা উন্নত করুন** অথবা **আনুষ্ঠানিক করুন**)।
3. ঐচ্ছিকভাবে আপনার লেখার ভাষার জন্য **থেকে** সেট করুন (অথবা **ভাষা শনাক্ত করুন** রেখে দিন)।
4. **ইনপুট**-এ টেক্সট টাইপ করুন অথবা পেস্ট করুন।
5. **পুনরায় লিখন** ক্লিক করুন।
6. **আউটপুট**-এ ফলাফল পড়ুন।
7. ঐচ্ছিকভাবে **পুনরায় শব্দবিন্যাস…** বা শব্দের বিকল্প ব্যবহার করে ফলাফল পরিমার্জন করুন — [আপনার পুনরায় লিখন পরিমার্জন করা](#refining-rewrite) দেখুন।
...
> ℹ️ **দ্রষ্টব্য**<br/>
> পুনরায় লিখন মোড **বিকল্প সংস্করণ** আউটপুটে `----` দ্বারা পৃথক করা একটি **একক** রানে বেশ কয়েকটি পুনর্গঠন প্রদান করে। এটি **পুনরায় শব্দবিন্যাস করুন...** থেকে আলাদা, যা সময়ের সাথে সাথে একটি সংস্করণ ইতিহাস তৈরি করে (প্রতি ক্লিকে একটি নতুন বৈকল্পিক)। [আপনার পুনরায় লিখন পরিমার্জন করা](#refining-rewrite) দেখুন।

<br/>

<a id="refining-rewrite"></a>
### আপনার পুনরায় লিখন পরিমার্জন করা

একটি সফল পুনরায় লিখনের পরে, **পুনরায় শব্দবিন্যাস করুন...** এবং সংস্করণ ড্রপডাউন ওয়ার্কস্পেসের আউটপুট দিকে প্রদর্শিত হয় (বিভক্ত লেআউটে, আউটপুট কলামের উপরের টুলবারে, রান মেট্রিক্সের পাশে; স্ট্যাক করা লেআউটে, **থেকে:**-এর পাশে আউটপুট প্যানেলের উপরে)। আপনি সেখানে ফলাফল পরিমার্জন করতে পারেন — [আপনার অনুবাদ পরিমার্জন করা](#refining-translation)-এর মতোই ধারণা, তবে লেখাটি একই ভাষায় থাকে এবং বর্তমান পুনরায় লিখন **মোড** বজায় রাখে:

1. **পুনরায় লিখন…** — আউটপুটে কোন টেক্সট নির্বাচিত না থাকলে, একই ইনপুটের সম্পূর্ণ পুনরায় লিখন করুন ভিন্ন শব্দবন্ধে, এখনও নির্বাচিত মোড প্রয়োগ করে (যেমন স্পষ্ট, সংক্ষিপ্ত, বা আরও আনুষ্ঠানিক)। মডেল আপনার কাছে থাকা প্রতিটি সংস্করণ গ্রহণ করে তাই নতুন শব্দবন্ধগুলি তাদের থেকে আলাদা হতে পারে। আপনি সর্বাধিক **পাঁচটি** সংস্করণ সংরক্ষণ করতে পারেন এবং সংস্করণ ড্রপডাউনটিতে স্যুইচ করতে পারেন। টেক্সট নির্বাচিত থাকলে, **পুনরায় লিখন…** নির্বাচনের নিকটে শব্দের বিকল্পগুলি খুলে দেয় (ডান-ক্লিকের মতো)। কোন নির্বাচন ছাড়া, **পুনরায় লিখন…** পাঁচটি সংস্করণে পৌঁছালে নিষ্ক্রিয় হয়; নির্বাচনের সাথে, এটি এখনও পাঁচটি সংস্করণে কাজ করে (শব্দের বিকল্পগুলি শুধুমাত্র, সংস্করণ ৫ আপডেট করে)। যখন একটি পূর্ণ পুনরায় লিখন চলছে, তখন **থামান পুনরায় লিখন** ক্লিক করে বাতিল করুন; আউটপুটটি পুনরায় লিখন শুরু হওয়ার সময় সক্রিয় সংস্করণে ফিরে আসে।
2. **শব্দের বিকল্প** — আউটপুটে এক বা একাধিক শব্দ বা একটি সংক্ষিপ্ত বাক্যাংশ নির্বাচন করুন (যদি আপনি শুধুমাত্র একটি শব্দের অংশ নির্বাচন করেন, অ্যাপটি নির্বাচনের জন্য পূর্ণ শব্দে সম্প্রসারিত করে), তারপর ডান-ক্লিক করুন বা **পুনরায় লিখন…** ক্লিক করুন। নির্বাচনের নিকটে বিকল্পগুলির একটি সংক্ষিপ্ত তালিকা প্রদর্শিত হয়; একটি ক্লিক করে এটি প্রতিস্থাপন করুন। প্রতিটি বিকল্প আপনার নির্বাচনের চেয়ে কিছুটা বিস্তৃত পরিসর প্রতিস্থাপন করতে পারে যাতে বাক্যটি ব্যাকরণগত থাকে। যদি আপনার পাঁচটির কম সংস্করণ থাকে, তবে সম্পাদিত আউটপুটটি একটি নতুন সংস্করণ হিসাবে সংরক্ষিত হয়; পাঁচটি সংস্করণে, শুধুমাত্র **সংস্করণ ৫** আপডেট হয়। কোন নির্বাচন ছাড়া ডান-ক্লিক করলে কার্সরের নিচে শব্দটি নির্বাচন হয় (অথবা সেখানে কোন শব্দ না থাকলে কিছুই হয় না)। **Esc** চাপুন বা তালিকার বাইরে ক্লিক করুন বাতিল করতে এবং আউটপুট পরিবর্তন না করতে।
3. **খরচ** — প্রতিটি পূর্ণ **পুনরায় লিখন…** (কোন নির্বাচন নেই) এবং প্রতিটি শব্দ-বিকল্প অনুরোধ আবার মডেলটি ব্যবহার করে এবং ব্যবহারের খরচে যোগ করতে পারে (একটি সাধারণ পুনরায় লিখন চলার মতো)।
...
![ওয়ার্কস্পেস রূপান্তর করুন](../images/screenshots/bn/transform.png)
...
![প্রম্পট এডিটর রূপান্তর করুন](../images/screenshots/bn/transform-prompt-edit.png)
...
| সাধারণ সেটিংস | yes | yes | yes | **AI অভিজ্ঞতা** (Easy / Advanced) অন্তর্ভুক্ত করে |
  ...
  | গ্লসারি         |   হ্যাঁ   |     হ্যাঁ     |        হ্যাঁ         | অনুবাদের সময় প্রয়োগ করা শব্দ জোড়া        |
  | ব্যবহারকারীরা | - | yes | - | |
  | API কনফিগ | yes | yes | - | |
...
![সেটিংস মডেল ট্যাব](../images/screenshots/bn/settings-general.png)
...
### গ্লসারি (সেটিংস ট্যাব)

অনুবাদ করার সময় প্রয়োগ করা শব্দ-জোড়া পরিচালনা করতে **সেটিংস** > **গ্লসারি** ব্যবহার করুন ( [গ্লসারি ব্যবহার করা](#using-the-glossary) দেখুন)। প্রতিটি শব্দের একটি **উৎস ভাষা**, **লক্ষ্য ভাষা**, **উৎস শব্দ**, এবং **লক্ষ্য শব্দ** থাকে।

আপনি পারবেন:

- **একটি শব্দ যোগ করুন** — টেবিলের নীচের সারিতে তথ্য পূরণ করুন (ভাষাগুলি নির্বাচন করুন, উৎস এবং লক্ষ্য শব্দ টাইপ করুন) এবং **+** বোতামে ক্লিক করুন।
- **শব্দ খুঁজুন** — **উৎস ভাষা**, **লক্ষ্য ভাষা**, বা সাধারণ **টেক্সট** দ্বারা তালিকা ফিল্টার করুন; রিসেট করতে **ফিল্টারগুলি সাফ করুন** ক্লিক করুন।
- **একটি শব্দ মুছুন** — এর সারিতে থাকা ট্র্যাশ-বিন আইকনে ক্লিক করুন।
- **আমদানি** — `.csv`, `.xlsx`, বা `.xls` ফাইল থেকে শব্দ লোড করুন। ফাইলে `source_language`, `target_language`, `source_text`, এবং `target_text` কলাম থাকা উচিত।
- **CSV এক্সপোর্ট করুন** / **XLSX এক্সপোর্ট করুন** — ব্যাকআপ বা শেয়ার করার জন্য আপনার সমস্ত শব্দ ডাউনলোড করুন।
- **টেমপ্লেট CSV** / **টেমপ্লেট XLSX** — পূরণ এবং আমদানি করার জন্য সঠিক কলাম হেডার সহ একটি খালি ফাইল ডাউনলোড করুন।

<br/>

> ℹ️ **দ্রষ্টব্য**<br/>
> **ডেস্কটপ অ্যাপে**, গ্লসারি স্থানীয়ভাবে সংরক্ষিত হয়। **ওয়েব সংস্করণে**, প্রতিটি ব্যবহারকারীর নিজস্ব গ্লসারি থাকে, তাই আপনার শব্দগুলি অন্য ব্যবহারকারীদের প্রভাবিত করে না।
...
API কীগুলি সিস্টেম বা Docker এনভায়রনমেন্ট ভেরিয়েবলের মাধ্যমে কনফিগার করা হয় - সেগুলি ওয়েব UI তে প্রবেশ করানো হয় না। কাস্টম প্রদানকারীর জন্য, `CUSTOM_PROVIDER_NAME`, `CUSTOM_PROVIDER_URL`, এবং `CUSTOM_PROVIDER_API_KEY` সেট করুন (তিনটিই প্রয়োজনীয়)। এই পৃষ্ঠাটি দেখায় কোন প্রদানকারীদের একটি কী কনফিগার করা আছে এবং `Test` বোতামে ক্লিক করে প্রতিটি পরীক্ষা করার অনুমতি দেয়।
...
> 💡 **টিপ** <br/>
> আপনি যদি API কী ব্যবহার করতে বা ব্যবহারের জন্য অর্থ প্রদান করতে না চান, তাহলে আপনি [Ollama ডাউনলোড](https://ollama.com) করতে পারেন এবং আপনার মেশিনে বিনামূল্যে মডেলগুলি (যেমন `translategemma:4b`) স্থানীয়ভাবে চালাতে পারেন। বিকল্পভাবে, আপনি তাদের বিনামূল্য মডেলগুলি ব্যবহার করার জন্য একটি বিনামূল্য OpenRouter অ্যাকাউন্ট (কোনও ক্রেডিট কার্ডের প্রয়োজন নেই) তৈরি করতে পারেন, অথবা Cerebras, Google, Groq, Mistral AI, বা [NVIDIA](https://build.nvidia.com/) থেকে একটি বিনামূল্য API কী পেতে পারেন।

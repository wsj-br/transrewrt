---
translation_last_updated: '2026-05-17T23:34:07.673Z'
...
- **ง่าย และ ขั้นสูง** - โหมดง่าย (ค่าเริ่มต้น): ทักษะที่คัดสรรแล้วตามผู้ให้บริการ (ฟรี, เร็ว, ขั้นสูง, เชิงเทคนิค, ด้านกฎหมาย) โดยไม่ต้องเลือกโมเดล ID; โหมดขั้นสูง: รายการโมเดลทั้งหมดจากผู้ให้บริการที่คุณตั้งค่าไว้
- **โมเดล และ ค่าใช้จ่าย** - แดชบอร์ดค่าใช้จ่ายและการใช้งาน (สรุป, ตามโมเดล, การเรียกใช้ API ทั้งหมด) พร้อมฟีเจอร์ส่งออก; OpenRouter แสดงค่าใช้จ่ายจริง ส่วนผู้ให้บริการอื่นใช้การประมาณการ

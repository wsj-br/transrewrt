...
- **การแปลง** - คำแนะนำ AI แบบกำหนดเอง สร้างและจัดการคำแนะนำ ภาษาปลายทางเสริมต่อคำแนะนำ
- **อภิธานศัพท์** - จัดเก็บคู่คำศัพท์ต้นทาง/ปลายทางต่อคู่ภาษาและนำไปใช้ระหว่างการแปล เพื่อให้คำศัพท์ที่เลือกมีความสอดคล้องกัน จัดการคำศัพท์ในการตั้งค่า (เพิ่ม/แก้ไข/ลบ นำเข้า CSV/XLSX และส่งออกเทมเพลต)
- **ประวัติ** - ประวัติการดำเนินการทั้งหมดพร้อมข้อความนำเข้า/ส่งออก การกรอง และการส่งออก
- **ง่าย & ขั้นสูง** - โหมดง่าย (ค่าเริ่มต้น): การตั้งค่าล่วงหน้าที่คัดสรรมาต่อผู้ให้บริการ (**ฟรี (OpenRouter)**, **มาตรฐาน**, **ขั้นสูง**, **เทคนิค**; เฉพาะการตั้งค่าล่วงหน้าที่มีการจับคู่สำหรับผู้ให้บริการที่เลือกเท่านั้นที่จะปรากฏ) โดยไม่ต้องเลือก ID โมเดล; โหมดขั้นสูง: รายการโมเดลทั้งหมดจากผู้ให้บริการที่กำหนดค่าของคุณ
- **โมเดล & ค่าใช้จ่าย** - แดชบอร์ดค่าใช้จ่ายและการใช้งาน (สรุป ตามโมเดล การโททั้งหมด) พร้อมการส่งออก; OpenRouter แสดงค่าใช้จ่ายจริง ผู้ให้บริการรายอื่นใช้ค่าประมาณ
- **UI** - อินเทอร์เฟซหลายภาษา (30+ ภาษา รองรับ RTL) ฟอนต์ ...
- **โหมดเว็บ** - รองรับผู้ใช้หลายคนพร้อมบทบาทผู้ดูแลระบบ
- **เดสก์ท็อป** - แอป Electron สำหรับ Windows และ Linux
- **โฮสต์เอง** - อิมเมจ Docker สำหรับ amd64 & arm64 (พร้อมสำหรับ Raspberry Pi)

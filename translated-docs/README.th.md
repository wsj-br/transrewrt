---
translation_last_updated: '2026-06-02T15:31:46.945Z'
...
- **ง่าย และ ขั้นสูง** - โหมดง่าย (ค่าเริ่มต้น): พรีเซ็ตที่จัดเตรียมไว้ตามผู้ให้บริการ (**ฟรี (OpenRouter)**, **มาตรฐาน**, **ขั้นสูง**, **เทคนิค**; จะแสดงเฉพาะพรีเซ็ตที่มีการแมปกับผู้ให้บริการที่เลือกเท่านั้น) โดยไม่ต้องเลือก ID ของโมเดล; โหมดขั้นสูง: รายการโมเดลทั้งหมดจากผู้ให้บริการที่คุณตั้งค่าไว้
- **โมเดล และ ค่าใช้จ่าย** - แดชบอร์ดค่าใช้จ่ายและการใช้งาน (สรุป, ตามโมเดล, การเรียกใช้ API ทั้งหมด) พร้อมฟังก์ชันส่งออก; OpenRouter แสดงค่าใช้จ่ายจริง ส่วนผู้ให้บริการอื่นใช้การประมาณการ
- **UI** - อินเทอร์เฟซหลายภาษา (มากกว่า 30 ภาษา, รองรับ RTL), แบบอักษร, ...

---
translation_last_updated: '2026-05-27T10:07:52.747Z'
...
- **ง่าย และ ขั้นสูง** - โหมดง่าย (ค่าเริ่มต้น): ทักษะที่คัดสรรแล้วตามผู้ให้บริการ (**ฟรี (OpenRouter)**, **ไลต์**, **ขั้นสูง**, **เทคนิคอล**; จะแสดงเฉพาะทักษะที่มีการแมปไว้สำหรับผู้ให้บริการที่เลือกเท่านั้น) โดยไม่ต้องเลือกโมเดล ID; โหมดขั้นสูง: รายการโมเดลทั้งหมดจากผู้ให้บริการที่คุณตั้งค่าไว้
- **โมเดล และ ค่าใช้จ่าย** - แดชบอร์ดค่าใช้จ่ายและการใช้งาน (สรุป, ตามโมเดล, การเรียกใช้ API ทั้งหมด) พร้อมฟีเจอร์ส่งออก; OpenRouter แสดงยอดการใช้จ่ายจริง ส่วนผู้ให้บริการอื่นใช้ค่าประมาณการ
- **UI** - อินเตอร์เฟซหลายภาษา (มากกว่า 30 ภาษา, รองรับ RTL), ฟอนต์, ...

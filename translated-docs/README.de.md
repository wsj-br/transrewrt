---
translation_last_updated: '2026-03-30T00:46:08.520Z'
...
> ℹ️ **HINWEIS**<br/>
> Windows zeigt möglicherweise eine dieser Sicherheitswarnungen an (üblich bei nicht signierten/indie-Apps):
...
>
> Dies geschieht, weil die App nicht von Microsoft oder einem großen Herausgeber signiert ist – sie ist sicher, wenn Sie sie aus unseren offiziellen GitHub-Releases heruntergeladen haben
...
| `TZ`             | `Europe/London`         | IANA-Zeitzone für serverseitige Zeit (Logging usw.); die Benutzeroberfläche richtet sich weiterhin nach dem Browser. Siehe [Docker → Zeitzone](#docker-timezone) |
...
> ⚠️ **WARNUNG**<br/>
> Ändern Sie das Standardadministratorkennwort unverzüglich auf jedem netzwerkzugänglichen Host.

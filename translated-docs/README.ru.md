---
translation_last_updated: '2026-05-17T23:33:26.563Z'
...
- **Простой и Расширенный** — Простой режим (по умолчанию): подбор навыков по поставщику (Бесплатно, Быстро, Расширенный, Технический, Юридический) без выбора идентификаторов моделей; Расширенный режим: полный список моделей от настроенных вами поставщиков
- **Модели и стоимость** — панели мониторинга расходов и использования (Сводка, По модели, Все вызовы) с возможностью экспорта; OpenRouter показывает фактические расходы, другие поставщики используют оценки

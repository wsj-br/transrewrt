---
translation_last_updated: '2026-04-15T22:30:11.722Z'
...
- **Рерайт** — исправление грамматики, улучшение ясности, формальный/неформальный стиль, сокращение, расширение, технический текст
- **Трансформация** — пользовательские промпты ИИ; создание и управление промптами, возможность указать целевой язык для каждого промпта
- **История** — полная история выполнения с вводом/выводом текста, фильтрацией и экспорт
- **Модели и стоимость** — выбор моделей от любого настроенного провайдера; панель мониторинга расходов и использования с логами, сводками по моделям/операциям/дням
- **Интерфейс пользователя** — интерфейс на нескольких языках (более 30 языков, поддержка RTL), шрифты, ...
...
- **Самостоятельное размещение** — образ Docker для amd64 и arm64 (готово к использованию на Raspberry Pi)

---
translation_last_updated: '2026-05-29T23:39:50.707Z'
...
- **Простой и расширенный** — Простой режим (по умолчанию): подобранные пресеты для каждого поставщика (**Бесплатно (OpenRouter)**, **Стандартный**, **Расширенный**, **Технический**; отображаются только пресеты, соответствующие выбранному поставщику), без выбора идентификаторов моделей; Расширенный режим: полный список моделей от настроенных поставщиков
- **Модели и стоимость** — панели мониторинга расходов и использования (Сводка, По модели, Все вызовы) с возможностью экспорта; OpenRouter показывает фактические расходы, для других поставщиков используются оценки
- **Пользовательский интерфейс** — интерфейс на нескольких языках (30+ языков, поддержка RTL), шрифты, ...

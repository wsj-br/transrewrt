...
- **अनुवाद करें** - दर्जनों भाषाओं के बीच, स्वचालित स्रोत पहचान के साथ
- **पुनर्लेखन** - व्याकरण ठीक करें, स्पष्टता में सुधार करें, औपचारिक/अनौपचारिक, संक्षिप्त करें, विस्तृत करें, तकनीकी
- **रूपांतरण** - कस्टम AI प्रॉम्प्ट; प्रॉम्प्ट बनाएं और प्रबंधित करें, प्रति प्रॉम्प्ट वैकल्पिक लक्ष्य भाषा
- **शब्दावली** - भाषा जोड़ी के अनुसार स्रोत/लक्ष्य शब्द जोड़े स्टोर करें और अनुवाद के दौरान उन्हें लागू करें ताकि चुने गए शब्द सुसंगत रहें; सेटिंग्स में शब्दों का प्रबंधन करें (जोड़ें/संपादित करें/हटाएं, CSV/XLSX आयात और टेम्पलेट निर्यात)
- **इतिहास** - इनपुट/आउटपुट पाठ, फ़िल्टरिंग और निर्यात के साथ पूर्ण निष्पादन इतिहास
- **आसान और उन्नत** - आसान मोड (डिफ़ॉल्ट): प्रदाता के अनुसार क्यूरेटेड प्रीसेट (**मुक्त (OpenRouter)**, **मानक**, **उन्नत**, **तकनीकी**; केवल चयनित प्रदाता के लिए मैपिंग वाले प्रीसेट दिखाई देते हैं) मॉडल आईडी चुने बिना; उन्नत मोड: आपके कॉन्फ़िगर किए गए प्रदाताओं से पूर्ण मॉडल सूची
- **मॉडल और लागत** - लागत और उपयोग डैशबोर्ड (सारांश, मॉडल द्वारा, सभी कॉल) निर्यात के साथ; OpenRouter वास्तविक खर्च दिखाता है, अन्य प्रदाता अनुमानों का उपयोग करते हैं
- **UI** - बहुभाषी इंटरफ़ेस (30+ भाषाएं, RTL समर्थन), फ़ॉन्ट, ...
- **वेब मोड** - व्यवस्थापक भूमिकाओं के साथ बहु-उपयोगकर्ता समर्थन
- **डेस्कटॉप** - विंडोज और लिनक्स के लिए इलेक्ट्रॉन ऐप
- **सेल्फ-होस्टेड** - amd64 और arm64 (रास्पबेरी पाई-तैयार) के लिए डॉकर इमेज
...
![Settings - model selection](../images/screenshots/hi/settings-general.png)

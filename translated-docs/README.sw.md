...
![Kubadilisha - kihariri cha maelezo](../images/screenshots/sw/transform-prompt-edit.png)
...
![Mipangilio - uteuzi wa modeli](../images/screenshots/sw/settings-general.png)

---
translation_last_updated: '2026-05-27T10:07:13.506Z'
...
По умолчанию приложение работает в режиме **Простой**: вы выбираете **пресет** (например, Бесплатно (OpenRouter), Lite или Technical) и **поставщика** в разделе Настройки, не указывая идентификаторы моделей. Переключитесь в режим **Расширенный** в разделе [**Настройки** > **Основные настройки**](#general-settings), если хотите использовать классический список моделей из раздела [**Настройки** > **Модели**](#models).
...
- В режиме **Простой** **пресет** — это предустановка (Бесплатно (OpenRouter), Lite, Расширенный или Technical), которая сопоставляется с моделью выбранного вами **поставщика** (OpenRouter, OpenAI, Ollama и другие). В панели инструментов отображаются только навыки, имеющие сопоставление с текущим поставщиком. Вы выбираете навык при использовании функций Перевести, Переписать и Преобразовать.
...
- **Ключ API** (или, для Ollama, **базовый URL**) — это способ, с помощью которого приложение подключается к поставщику.
...
- **Простой** (по умолчанию): выберите **поставщика** (OpenRouter, OpenAI, Anthropic, Google Gemini, DeepSeek, Groq, Mistral, xAI, Cerebras или Ollama). Для облачных поставщиков используются встроенные пресеты на панели инструментов. **Ollama** отображает модели, установленные на вашем компьютере, вместо пресетов. В режиме Простой раздел **Каталог пресетов** показывает версию каталога и время последнего обновления; нажмите **Обновить каталог пресетов**, чтобы получить актуальный список навыков из репозитория проекта (приложение также периодически проверяет обновления в фоновом режиме).
...
![Settings Models tab](../images/screenshots/ru/settings-general.png)

...
После успешного перевода вы можете уточнить результат в панели вывода:

1. **Перефразировать…** — если в выводе не выделен текст, получите ещё один полный перевод того же ввода с другими формулировками. Можно сохранить до **пяти** версий и переключаться между ними в раскрывающемся списке версий. При выделенном тексте **Перефразировать…** открывает варианты слов рядом с выделением (так же, как при щелчке правой кнопкой мыши). Без выделения **Перефразировать…** отключается после достижения пяти версий; при выделении он продолжает работать на пяти версиях (только варианты слов, обновляя пятую версию).
2. **Варианты слов** — выделите одно или несколько слов в выводе (если выделена только часть слова, приложение расширит выделение до целых слов), затем щёлкните правой кнопкой мыши или нажмите **Перефразировать…**. Рядом с выделением появится короткий список вариантов; нажмите на один из них, чтобы заменить его. Если сохранено менее пяти версий, отредактированный вывод сохраняется как новая версия; при наличии пяти версий обновляется только **версия 5**. Щелчок правой кнопкой мыши без выделения не выполняет никаких действий. Нажмите **Esc** или щёлкните вне списка, чтобы отменить изменения без модификации вывода.
3. **Стоимость** — каждый полный вызов **Перефразировать…** (без выделения) и каждый запрос вариантов слов повторно использует модель и может увеличить стоимость использования (так же, как при обычном запуске перевода).

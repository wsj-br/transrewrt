...
- [Перевести](#translate)
  ...
  - [Уточнение вашего перевода](#refining-translation)
- [Перезапись](#rewrite)
- [Преобразование](#transform)
  - [Запустить существующую подсказку](#run-an-existing-prompt)
  - [Если у вас еще нет подсказок](#if-you-have-no-prompts-yet)
  - [Создать подсказку быстро](#create-a-prompt-quickly)
  - [Изменить подсказку](#edit-a-prompt)
  - [Проверить подсказку перед использованием](#test-a-prompt-before-using-it)
- [Панель управления](#dashboard)
  - [Отфильтровать данные](#filter-the-data)
  - [Вкладки панели управления](#dashboard-tabs)
  - [Экспорт данных](#export-data)
  - [Удалить сохраненные записи для модели](#delete-stored-records-for-a-model)
- [История](#history)
  - [Отфильтровать историю](#filter-the-history)
...
- [Распространенные проблемы](#common-issues)
  ...
  - [Текст слишком маленький или труден для чтения](#the-text-is-too-small-or-hard-to-read)
  - [Сводка панели управления выглядит пустой](#dashboard-summary-looks-empty)
  - [Стоимость показывает "недоступно" или кажется неверной](#cost-shows-not-available-or-seems-wrong)
  ...
  - [Я изменил подсказку и потерял правки](#i-changed-a-prompt-and-lost-the-edits)

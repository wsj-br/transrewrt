---
translation_last_updated: '2026-05-02T22:45:15.406Z'
...
- Перевести** - перевести текст с одного языка на другой.
- **Переписать** - перефразировать текст в другом стиле, например сделать его более понятным, коротким или формальным.
...
- Используйте [**История](#history), чтобы просмотреть предыдущие операции и их полный ввод и вывод текста.
- Регулярно выполняйте экспорт запросов, если вы создаете библиотеку запросов, которую хотите сохранить в безопасности (см. [Преобразовать запросы](#transform-prompts)), или если вы хотите поделиться ею с другими.

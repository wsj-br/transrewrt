...
- **ਟਰਾਂਸਲੇਟ** - ਦਰਜਨਾਂ ਭਾਸ਼ਾਵਾਂ ਦੇ ਵਿਚਕਾਰ, ਆਟੋਮੈਟਿਕ ਸਰੋਤ ਖੋਜ ਨਾਲ
- **Rewrite** - ਵਿਆਕਰਨ ਠੀਕ ਕਰੋ, ਸਪੱਸ਼ਟਤਾ ਵਧਾਓ, ਰਸਮੀ/ਅਣ-ਰਸਮੀ, ਛੋਟਾ ਕਰੋ, ਵਧਾਓ, ਤਕਨੀਕੀ
- **Transform** - ਕਸਟਮ AI ਪ੍ਰੋਂਪਟ; ਪ੍ਰੋਂਪਟ ਬਣਾਓ ਅਤੇ ਪ੍ਰਬੰਧਿਤ ਕਰੋ, ਪ੍ਰੋਂਪਟ ਪ੍ਰਤੀ ਵਿਕਲਪਿਕ ਨਿਸ਼ਾਨਾ ਭਾਸ਼ਾ
- **ਸ਼ਬਦ-ਕੋਸ਼** - ਭਾਸ਼ਾ ਜੋੜੀ ਪ੍ਰਤੀ ਸਰੋਤ/ਨਿਸ਼ਾਨਾ ਸ਼ਬਦ ਜੋੜੇ ਸਟੋਰ ਕਰੋ ਅਤੇ ਟਰਾਂਸਲੇਸ਼ਨ ਦੌਰਾਨ ਉਹਨਾਂ ਨੂੰ ਲਾਗੂ ਕਰੋ ਤਾਂ ਜੋ ਚੁਣੇ ਹੋਏ ਸ਼ਬਦ ਇਕਸਾਰ ਰਹਿਣ; ਸੈਟਿੰਗਾਂ ਵਿੱਚ ਸ਼ਬਦਾਂ ਦਾ ਪ੍ਰਬੰਧਨ ਕਰੋ (ਜੋੜੋ/ਸੋਧੋ/ਮਿਟਾਓ, CSV/XLSX ਆਯਾਤ ਅਤੇ ਟੈਮਪਲੇਟ ਨਿਰਯਾਤ)
- **ਇਤਿਹਾਸ** - ਇਨਪੁੱਟ/ਆਉਟਪੁੱਟ ਟੈਕਸਟ, ਫਿਲਟਰਿੰਗ, ਅਤੇ ਨਿਰਯਾਤ ਨਾਲ ਪੂਰਾ ਐਗਜ਼ੀਕਿਊਸ਼ਨ ਇਤਿਹਾਸ
- **ਸੌਖਾ & ਤਕਨੀਕੀ** - ਸੌਖਾ ਮੋਡ (ਡਿਫਾਲਟ): ਪ੍ਰੋਵਾਈਡਰ (**ਮੁਫ਼ਤ (OpenRouter)**, **ਸਟੈਂਡਰਡ**, **ਤਕਨੀਕੀ**, **ਤਕਨੀਕੀ**; ਸਿਰਫ਼ ਉਹ ਪ੍ਰੀਸੈੱਟ ਦਿਖਾਏ ਜਾਂਦੇ ਹਨ ਜਿਨ੍ਹਾਂ ਵਿੱਚ ਚੁਣੇ ਹੋਏ ਪ੍ਰੋਵਾਈਡਰ ਲਈ ਮੈਪਿੰਗ ਹੁੰਦੀ ਹੈ) ਲਈ ਕਿਊਰੇਟ ਕੀਤੇ ਪ੍ਰੀਸੈੱਟ ਮਾਡਲ ID ਚੁਣੇ ਬਿਨਾਂ; ਤਕਨੀਕੀ ਮੋਡ: ਤੁਹਾਡੇ ਕੌਂਫਿਗਰ ਕੀਤੇ ਪ੍ਰੋਵਾਈਡਰਾਂ ਤੋਂ ਪੂਰੀ ਮਾਡਲ ਸੂਚੀ
- **ਮਾਡਲ & ਲਾਗਤ** - ਲਾਗਤ ਅਤੇ ਵਰਤੋਂ ਡੈਸ਼ਬੋਰਡ (ਸਾਰਾਂਸ਼, ਮਾਡਲ ਦੁਆਰਾ, ਸਾਰੇ ਕਾਲ) ਨਿਰਯਾਤ ਨਾਲ; OpenRouter ਅਸਲ ਖਰਚ ਦਿਖਾਉਂਦਾ ਹੈ, ਹੋਰ ਪ੍ਰੋਵਾਈਡਰ ਅਨੁਮਾਨਾਂ ਦੀ ਵਰਤੋਂ ਕਰਦੇ ਹਨ
- **UI** - ਬਹੁ-ਭਾਸ਼ਾਈ ਇੰਟਰਫੇਸ (30+ ਭਾਸ਼ਾਵਾਂ, RTL ਸਪੋਰਟ), ਫੌਂਟ, ...
- **Web ਮੋਡ** - ਪ੍ਰਸ਼ਾਸਕ ਭੂਮਿਕਾਵਾਂ ਨਾਲ ਮਲਟੀ-ਯੂਜ਼ਰ ਸਪੋਰਟ
- **Desktop** - Windows ਅਤੇ Linux ਲਈ ਇਲੈਕਟ੍ਰੋਨ ਐਪ
- **Self-hosted** - amd64 & arm64 (Raspberry Pi-ready) ਲਈ Docker ਚਿੱਤਰ
...
![Settings - model selection](../images/screenshots/pa/settings-general.png)

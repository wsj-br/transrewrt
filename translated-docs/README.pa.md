---
translation_last_updated: '2026-03-31T22:57:45.522Z'
...
- [ਸਥਾਪਤਾ](#installation)
  ...
  - [ਡੌਕਰ](#docker)
  - [ਟਾਈਮਜ਼ੋਨ ਨੂੰ ਕਾਨਫਿਗਰ ਕਰਨਾ](#configuring-the-timezone)
- [OpenRouter API ਕੁੰਜੀ ਪ੍ਰਾਪਤ ਕਰਨਾ](#getting-an-openrouter-api-key)
- [ਕਾਨਫਿਗਰੇਸ਼ਨ ਅਤੇ ਵਾਤਾਵਰਣ](#configuration-and-environment)
...
[ਅੰਗਰੇਜ਼ੀ (ਯੂਕੇ)](../README.md) · [ਪੋਰਟੁਗੀਜ਼ (ਬੀਆਰ)](README.pt-BR.md) · [ਅਰਬੀ](README.ar.md) · [ਬੰਗਾਲੀ](README.bn.md) · [ਕੈਟਲਾਨ](README.ca.md) · [ਸਰਲੀਕ੍ਰਿਤ ਚੀਨੀ](README.zh-CN.md) · [ਪਰੰਪਰਾਗਤ ਚੀਨੀ](README.zh-TW.md) · [ਕਰੋਏਸ਼ੀਅਨ](README.hr.md) · [ਚੈੱਕ](README.cs.md) · [ਡੱਚ](README.nl.md) · [ਅੰਗਰੇਜ਼ੀ (ਯੂ. ਐੱਸ.)](README.en-US.md) · [ਫਿਲੀਪੀਨੋ](README.tl.md) · [ਫ਼ਰਾਂਸੀਸੀ](README.fr.md) · [ਜਰਮਨ](README.de.md) · [ਯੂਨਾਨੀ](README.el.md) · [ਹਿੰਦੀ](README.hi.md) · [ਹੰਗੇਰੀਅਨ](README.hu.md) · [ਇਤਾਲਵੀ](README.it.md) · [ਜਾਪਾਨੀ](README.ja.md) · [ਜਾਵਾਨੀਜ਼](README.jv.md) · [ਕੋਰੀਆਈ](README.ko.md) · [ਮਲਾਇਆਲਮ](README.ms.md) · [ਫ਼ਾਰਸੀ](README.fa.md) · [ਪੋਲਿਸ਼](README.pl.md) · [ਪੋਰਟੁਗੀਜ਼ (ਪੀਟੀ)](README.pt.md) · [ਪੰਜਾਬੀ](README.pa.md) · [ਰੋਮਾਨੀਆਈ](README.ro.md) · [ਰੂਸੀ](README.ru.md) · [ਸਲੋਵਾਕ](README.sk.md) · [ਸਪੈਨਿਸ਼](README.es.md) · [ਸਵਾਹਿਲੀ](README.sw.md) · [ਸਵੀਡਿਸ਼](README.sv.md) · [ਤੇਲਗੂ](README.te.md) · [ਥਾਈ](README.th.md) · [ਤੁਰਕੀ](README.tr.md) · [ਯੂਕਰੇਨੀਅਨ](README.uk.md) · [ਵੀਅਤਨਾਮੀ](README.vi.md)
...
> ℹ️ **ਨੋਟ**  
>
> ਡੌਕਰ ਵਿੱਚ, LLM ਪ੍ਰਮਾਣ ਪੱਤਰਾਂ ਨੂੰ ਵਾਤਾਵਰਣ ਚਲਾ ਕੇ ਜਿਵੇਂ `OPENROUTER_API_KEY`, `OPENAI_API_KEY`, `CEREBRAS_API_KEY`, … (ਵੈੱਬ UI ਵਿੱਚ ਨਹੀਂ) ਸੈੱਟ ਕੀਤਾ ਜਾਂਦਾ ਹੈ। ਡੈਸਕਟਾਪ (ਇਲੈਕਟ੍ਰਾਨ) ਵਿੱਚ ਤੁਸੀਂ **ਸੈਟਿੰਗਾਂ → API** ਵਿੱਚ ਕੁੰਜੀਆਂ ਨੂੰ ਕਾਨਫਿਗਰ ਕਰਦੇ ਹੋ।
...
ਇਸੇ ਸਾਰ ਲਈ [ਸਥਾਪਤਾ → ਲੀਨਕਸ](#linux-electron) ਵੇਖੋ।

> ℹ️ **ਨੋਟ**  
>
> ਮੈਕਓਐੱਸ ਨੂੰ ਫਿਲਹਾਲ ਸਮਰਥਨ ਨਹੀਂ ਮਿਲਿਆ ਹੈ। Transrewrt ਵਿੰਡੋਜ਼, ਲੀਨਕਸ, ਅਤੇ ਡੌਕਰ ਲਈ ਉਪਲਬਧ ਹੈ।
...
> ℹ️ **ਨੋਟ**  
>
> Windows ਇੱਕ ਇਹਨਾਂ ਸੁਰੱਖਿਆ ਚੇਤਾਵਨੀਆਂ ਵਿੱਚੋਂ ਇੱਕ ਵਿਖਾ ਸਕਦਾ ਹੈ (ਅਣ-ਦਸਤਖਤ/ਸਵੈ-ਨਿਰਮਿਤ ਐਪਾਂ ਲਈ ਆਮ):
>
> - **ਯੂਜ਼ਰ ਅਕਾਊਂਟ ਕੰਟਰੋਲ (UAC)**: "ਕੀ ਤੁਸੀਂ ਇਸ ਅਣਜਾਣ ਪ੍ਰਕਾਸ਼ਕ ਤੋਂ ਐਪ ਨੂੰ ਆਪਣੇ ਡਿਵਾਈਸ 'ਤੇ ਤਬਦੀਲੀਆਂ ਕਰਨ ਦੀ ਆਗਿਆ ਦੇਣਾ ਚਾਹੁੰਦੇ ਹੋ?" → **ਹਾਂ** 'ਤੇ ਕਲਿੱਕ ਕਰੋ।
> - **Microsoft Defender SmartScreen**: "Windows ਨੇ ਤੁਹਾਡੇ PC ਨੂੰ ਸੁਰੱਖਿਅਤ ਰੱਖਿਆ" → **ਹੋਰ ਜਾਣਕਾਰੀ** → **ਫਿਰ ਵੀ ਚਲਾਓ** 'ਤੇ ਕਲਿੱਕ ਕਰੋ।
>
> ਇਹ ਇਸ ਲਈ ਹੁੰਦਾ ਹੈ ਕਿਉਂਕਿ ਐਪ Microsoft ਜਾਂ ਕਿਸੇ ਵੱਡੇ ਪ੍ਰਕਾਸ਼ਕ ਦੁਆਰਾ ਦਸਤਖਤ ਨਹੀਂ ਕੀਤੀ ਗਈ ਹੈ—ਇਹ ਸੁਰੱਖਿਅਤ ਹੈ ਜੇਕਰ ਇਸਨੂੰ ਸਾਡੇ ਅਧਿਕਾਰਤ GitHub ਰਿਲੀਜ਼ ਤੋਂ ਡਾਊਨਲੋਡ ਕੀਤਾ ਗਿਆ ਹੈ
...
> ⚠️ **ਚੇਤਾਵਨੀ**  
>
> ਜੇਕਰ ਤੁਸੀਂ ਕਿਸੇ ਹੋਰ ਡਿਵਾਈਸ, ਕੰਟੇਨਰ ਜਾਂ ਸੇਵਾ ਤੋਂ Ollama ਦੀ ਵਰਤੋਂ ਕਰ ਰਹੇ ਹੋ, ਤਾਂ Ollama ਨੂੰ ਬਾਹਰੀ ਕਨੈਕਸ਼ਨਾਂ ਨੂੰ ਆਗਿਆ ਦੇਣ ਲਈ ਕਾਨਫਿਗਰ ਕਰਨਾ ਨਾ ਭੁੱਲੋ (ਸਿਰਫ਼ localhost ਨਹੀਂ)।

ਸੀਮਾਵਾਂ, BYOK, ਅਤੇ ਹੋਰਾਂ ਲਈ, [OpenRouter ਪ੍ਰਮਾਣਕਰਨ](https://openrouter.ai/docs/api/reference/authentication) ਵੇਖੋ।

## ਕਾਨਫਿਗਰੇਸ਼ਨ ਅਤੇ ਵਾਤਾਵਰਨ
...
| `CONFIG_PATH` | `/app/data/config.json` | ਕਾਨਫਿਗ ਫਾਈਲ ਲਈ ਮਾਰਗ |
| `TZ` | `Europe/London` | ਸਰਵਰ-ਪਾਸੇ ਸਮਾਂ (ਲਾਗਿੰਗ, ਆਦਿ) ਲਈ IANA ਟਾਈਮਜ਼ੋਨ; UI ਅਜੇ ਵੀ ਬਰਾਊਜ਼ਰ ਦੀ ਪਾਲਣਾ ਕਰਦੀ ਹੈ। [ਡਾਕਰ → ਟਾਈਮਜ਼ੋਨ](#docker-timezone) ਵੇਖੋ |
...
| `OLLAMA_URL` | *(ਖਾਲੀ)* | Ollama ਬੇਸ URL (ਉਦਾਹਰਣ ਲਈ `http://host.docker.internal:11434`) |
...
> ⚠️ **ਚੇਤਾਵਨੀ**  
>
> ਕਿਸੇ ਵੀ ਨੈੱਟਵਰਕ-ਐਕਸੈੱਸਯੋਗ ਹੋਸਟ 'ਤੇ ਡਿਫਾਲਟ ਐਡਮਿਨ ਪਾਸਵਰਡ ਨੂੰ ਤੁਰੰਤ ਬਦਲੋ।

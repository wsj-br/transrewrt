---
translation_last_updated: '2026-03-31T23:46:04.678Z'
...
>   - **Microsoft Defender SmartScreen**: "Windows ha protegido su PC" → Haga clic en **Más información** → **Ejecutar de todas formas**.
>
> Esto ocurre porque la aplicación no está firmada por Microsoft ni por un editor importante; es segura si se descarga desde nuestras versiones oficiales en GitHub
>  (verifique el hash SHA256 a continuación).

---
translation_last_updated: '2026-03-31T22:58:19.446Z'
...
[Tiếng Anh (UK)](../README.md) · [Português (BR)](README.pt-BR.md) · [العربية](README.ar.md) · [বাংলা](README.bn.md) · [Català](README.ca.md) · [Tiếng Trung (Giản thể)](README.zh-CN.md) · [Tiếng Trung (Phồn thể)](README.zh-TW.md) · [Hrvatski](README.hr.md) · [Čeština](README.cs.md) · [Nederlands](README.nl.md) · [Tiếng Anh (US)](README.en-US.md) · [Tiếng Filipino](README.tl.md) · [Français](README.fr.md) · [Deutsch](README.de.md) · [Ελληνικά](README.el.md) · [हिन्दी](README.hi.md) · [Magyar](README.hu.md) · [Italiano](README.it.md) · [日本語](README.ja.md) · [Basa Jawa](README.jv.md) · [한국어](README.ko.md) · [Bahasa Melayu](README.ms.md) · [فارسی](README.fa.md) · [Polski](README.pl.md) · [Português (PT)](README.pt.md) · [ਪੰਜਾਬੀ](README.pa.md) · [Română](README.ro.md) · [Русский](README.ru.md) · [Slovenčina](README.sk.md) · [Español](README.es.md) · [Kiswahili](README.sw.md) · [Svenska](README.sv.md) · [తెలుగు](README.te.md) · [ภาษาไทย](README.th.md) · [Türkçe](README.tr.md) · [Українська](README.uk.md) · [Tiếng Việt](README.vi.md)
...
Tóm tắt bảng điều khiển — sử dụng
...
Xem [Cài đặt → Linux](#linux-electron) để biết phần tóm tắt tương tự.
...
> ℹ️ **LƯU Ý**  
>
> Windows có thể hiển thị một trong các cảnh báo bảo mật sau (bình thường đối với các ứng dụng chưa được ký hoặc ứng dụng độc lập):
>
> - **User Account Control (UAC)**: "Bạn có muốn cho phép ứng dụng từ nhà xuất bản không xác định này thực hiện thay đổi trên thiết bị của bạn không?" → Nhấp **Có**.
> - **Microsoft Defender SmartScreen**: "Windows đã bảo vệ PC của bạn" → Nhấp **Thêm thông tin** → **Vẫn chạy**.
>
> Điều này xảy ra vì ứng dụng chưa được ký bởi Microsoft hoặc một nhà xuất bản lớn — ứng dụng an toàn nếu được tải từ bản phát hành chính thức trên GitHub của chúng tôi
>  (xác minh checksum SHA256 bên dưới).
...
> ⚠️ **CẢNH BÁO**  
>
> Nếu bạn đang sử dụng Ollama từ một thiết bị, bộ chứa hoặc dịch vụ khác, hãy nhớ cấu hình Ollama cho phép kết nối từ xa (không chỉ localhost).
...
| `TZ`                 | `Europe/London`         | Múi giờ IANA cho thời gian phía máy chủ (ghi nhật ký, v.v.); giao diện người dùng vẫn theo trình duyệt. Xem [Docker → timezone](#docker-timezone) |

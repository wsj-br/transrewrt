---
translation_last_updated: '2026-04-28T00:50:38.683Z'
...
- قم بتصدير التعليمات بانتظام إذا كنت تبني مكتبة تعليمات ترغب في الحفاظ عليها (انظر [تعليمات التحويل](#transform-prompts)) أو إذا كنت ترغب في مشاركتها مع الآخرين.

---
translation_last_updated: '2026-05-18T15:42:51.839Z'
...
డిఫాల్ట్‌గా, యాప్ **సులభం** మోడ్‌లో నడుస్తుంది: మీరు **స్కిల్** (ఉదాహరణకు ఉచితం, వేగంగా, లేదా సాంకేతిక) మరియు సెట్టింగ్స్‌లో **ప్రొవైడర్**ను ఎంచుకుంటారు, మోడల్ ఐడీలను ఎంచుకోకుండా. మీరు [**సెట్టింగ్స్** > **సాధారణ సెట్టింగ్లు**](#general-settings)లో క్లాసిక్ మోడల్ జాబితాను పొందాలనుకుంటే **అడ్వాన్స్డ్** మోడ్‌కు మారండి [**సెట్టింగ్స్** > **మోడల్‌లు**](#models).
...
- [సెట్టింగ్స్](#settings)
  ...
  - [మార్చు (సెట్టింగ్స్ ట్యాబ్)](#transform-settings)
  - [వాడుకరులు](#users)
...
- **సులభం** మోడ్‌లో, **స్కిల్** అనేది మీ ఎంచుకున్న **ప్రొవైడర్** (ఓపెన్‌రౌటర్, ఓపెన్‌ఏఐ, ఓలామా, మరియు ఇతరులు) కోసం మోడల్‌కు మ్యాప్ అయ్యే ప్రీసెట్ (ఉచితం, వేగంగా, అడ్వాన్స్డ్, సాంకేతిక, చట్టపరమైన). మీరు అనువదించు, పునర్రచన, మరియు మార్చు టూల్‌బార్‌లో స్కిల్‌ను ఎంచుకుంటారు.
- **అడ్వాన్స్డ్** మోడ్‌లో, **మోడల్** అనేది మీరు నేరుగా ఎంచుకునే AI ఇంజిన్. మోడల్ ఐడీలు **ప్రొవైడర్ ప్రిఫిక్స్** ఉపయోగిస్తాయి (ఉదాహరణకు `openrouter/…`, `openai/…`, `ollama/…`).
- **API కీ** (లేదా, ఓలామా కోసం, **బేస్ URL**) అనేది యాప్ ఆ ప్రొవైడర్‌ను ఎలా చేరుకుంటుంది.

మీరు **డెస్క్‌టాప్ యాప్** ఉపయోగిస్తున్నట్లయితే, మీరు ఉపయోగించే ప్రతి ప్రొవైడర్ కోసం [**సెట్టింగ్స్** > **API కాన్ఫిగ్**](#api-config)లో కీలు జోడించండి. ఓపెన్‌రౌటర్ మాత్రమే ఉపయోగించాలనుకుంటే, క్రింద [ఉచిత ఓపెన్‌రౌటర్ API కీ పొందడం ఎలా](#how-to-get-an-api-key-desktop-app) చూడండి. మీరు API కీ ఉపయోగించాలనుకుంటే, మీరు ఓలామాను ఇన్‌స్టాల్ చేయవచ్చు ( [ollama.com](https://ollama.com) నుండి) మరియు స్థానిక మోడల్‌లను ఉపయోగించవచ్చు, ఉదాహరణకు `translategemma:4b`.
...
5. **అనువదించు**లో, టూల్‌బార్‌లో **స్కిల్** (సులభం) లేదా **మోడల్** (అడ్వాన్స్డ్)ను ఎంచుకోండి.
6. [**సెట్టింగ్స్** > **భాషలు**](#languages)ను ఓపెన్ చేయండి మరియు మీ **అత్యధిక ఉపయోగించే భాషలు**ని ఎంచుకోండి, మీ అత్యధిక ఉపయోగించే భాషలు మొదట కనిపించాలంటే.
7. ప్రతిదీ పనిచేస్తుందో లేదో నిర్ధారించడానికి ఒక సులభమైన అనువాదాన్ని నడపండి, తరువాత **పునర్రచన** మరియు **మార్చు**ని ప్రయత్నించండి.

ఈ క్రమం ముఖ్యమైనది. ఇది అత్యంత సాధారణ మొదటి-ఉపయోగ సమస్యను నివారిస్తుంది: యాప్ పని చేసే API కనెక్షన్ లేదా ఎంచుకున్న స్కిల్/మోడల్ ఉన్నప్పుడు పని చేయడానికి ప్రయత్నించడం.
...
- ఎడమవైపు, ప్రస్తుత పేజీ పేరు చూపిస్తుంది.
- కుడివైపు, **స్కిల్ లేదా మోడల్ ఎంపిక** మరియు **ఇంటర్ఫేస్ భాష** నియంత్రణను చూపిస్తుంది.

 **సులభం** మోడ్‌లో, టూల్‌బార్‌లో **స్కిల్ ఎంపిక** (ఉచితం, వేగంగా, అడ్వాన్స్డ్, సాంకేతిక, చట్టపరమైన, మరియు సమాన ప్రీసెట్‌లు) చూపిస్తుంది. స్కిల్‌లు మీరు [**సెట్టింగ్స్** > **సాధారణ సెట్టింగ్లు**](#general-settings)లో ఎంచుకున్న **ప్రొవైడర్**పై ఆధారపడి ఉంటాయి. **ప్రొవైడర్** **ఓలామా** అయితే, టూల్‌బార్ మీ ఇన్‌స్టాల్ చేసిన స్థానిక మోడల్‌లను స్కిల్‌ల బదులుగా జాబితా చేస్తుంది.
...
1. **అనువదించు**ను ఓపెన్ చేయండి.
2. **నుంచి**లో ఒక భాషను ఎంచుకోండి.
3. **కు**లో ఒక భాషను ఎంచుకోండి.
4. టూల్‌బార్‌లో ఒక స్కిల్ (సులభం) లేదా మోడల్ (అడ్వాన్స్డ్)ను ఎంచుకోండి.
...
మీరు ప్రాంప్ట్ ఎడిటర్‌లో **ప్రాంప్ట్ జనరేట్ చేయండి**, **ప్రాంప్ట్‌ను మెరుగుపరచండి**, లేదా **ప్రాంప్ట్ అనువాదం** ఉపయోగించినప్పుడు, **సులభం** మోడ్ అనువాదం మరియు పునర్రచన వంటి అదే నైపుణ్య ఎంపికను అందిస్తుంది; **అడ్వాన్స్డ్** మోడ్ మోడల్ జాబితాను ఉపయోగిస్తుంది.
...
**సులభం** మోడ్‌లో, మోడల్ ఎంపిక టూల్‌బార్‌లో నైపుణ్యాల ద్వారా మరియు సాధారణ సెట్టింగ్లలో **ప్రొవైడర్** ద్వారా జరుగుతుంది; **మోడల్‌లు** ట్యాబ్ దాచబడింది.

<br/>

> ℹ️ **గమనిక**<br/>
> వెబ్ వెర్షన్‌లో, ప్రతి వాడుకరికి వారి స్వంత కాన్ఫిగరేషన్ ఉంటుంది. AI అనుభవం, ప్రొవైడర్, ఎంచుకున్న మోడల్స్ లేదా నైపుణ్యాలు, భాషలు, సాధారణ ఎంపికలు, మరియు మార్చు ప్రాంప్ట్‌ల వంటి సెట్టింగ్లు ప్రతి వాడుకరి కోసం నిల్వ చేయబడతాయి. మీరు చేసిన మార్పులు ఇతర వాడుకరులను ప్రభావితం చేయవు.
...
- **సులభం** (డిఫాల్ట్): ఒక **ప్రొవైడర్** (ఓపెన్‌రౌటర్, ఓపెన్‌ఏఐ, యాంథ్రోపిక్, గూగుల్ జెమిని, డీప్‌సీక్, గ్రోక్, మిస్ట్రల్, ఎక్స్ఏఐ, సెరెబ్రస్, లేదా ఓలామా)ను ఎంచుకోండి. క్లౌడ్ ప్రొవైడర్లు టూల్‌బార్‌లో బిల్ట్-ఇన్ నైపుణ్య ప్రీసెట్‌లను ఉపయోగిస్తారు. **ఓలామా** మీ యంత్రంలో ఇన్‌స్టాల్ చేసిన మోడల్‌లను నైపుణ్యాల బదులు జాబితా చేస్తుంది.
- **అడ్వాన్స్డ్**: టూల్‌బార్‌లో వ్యక్తిగత మోడల్‌లను ఎంచుకోండి; జాబితాను [**సెట్టింగ్లు** > **మోడల్స్**](#models) కింద నిర్వహించండి.
...
- మీరు టూల్‌బార్‌లో **నైపుణ్యం** (సులభం) లేదా **మోడల్** (అడ్వాన్స్డ్) ఎంచుకున్నారు
- **సులభం** మోడ్‌లో, [**సెట్టింగ్స్** > **సాధారణ సెట్టింగ్లు**](#general-settings) లో పనిచేసే కీ (లేదా ఓలామా URL) మరియు ఆ ప్రొవైడర్ కోసం కనీసం ఒక నైపుణ్యం ఉన్న **ప్రొవైడర్** ఉంది

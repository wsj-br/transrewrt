---
translation_last_updated: '2026-05-24T17:53:10.809Z'
...
డిఫాల్ట్ ప్రకారం యాప్ **Easy** మోడ్‌లో రన్ అవుతుంది: మీరు మోడల్ IDలను ఎంచుకోకుండానే, సెట్టింగ్స్‌లో ఒక **నైపుణ్యం** (ఉదాహరణకు Free (OpenRouter), Lite, లేదా Technical) మరియు ఒక **ప్రొవైడర్**ని ఎంచుకుంటారు. మీరు [**Settings** > **General Settings**](#general-settings)లో **Advanced** మోడ్‌కి మారితే, [**Settings** > **Models**](#models) నుండి క్లాసిక్ మోడల్ జాబితాను పొందవచ్చు.
...
- **Easy** మోడ్‌లో, **నైపుణ్యం** అనేది ఒక ప్రీసెట్ (Free (OpenRouter), Lite, Advanced, లేదా Technical), ఇది మీరు ఎంచుకున్న **ప్రొవైడర్** (OpenRouter, OpenAI, Ollama మరియు ఇతరాలు) కోసం ఒక మోడల్‌కు మ్యాప్ చేయబడుతుంది. ప్రస్తుత ప్రొవైడర్‌కు మ్యాపింగ్ ఉన్న నైపుణ్యాలు మాత్రమే టూల్‌బార్‌లో కనిపిస్తాయి. మీరు Translate, Rewrite మరియు Transform లలో నైపుణ్యాన్ని ఎంచుకుంటారు.
- **Advanced** మోడ్‌లో, **మోడల్** అనేది మీరు నేరుగా ఎంచుకునే AI ఇంజిన్. మోడల్ IDలు **ప్రొవైడర్ ప్రిఫిక్స్** (ఉదాహరణకు `openrouter/…`, `openai/…`, `ollama/…`) ఉపయోగిస్తాయి.
- **API key** (లేదా Ollama కోసం **base URL**) ద్వారా యాప్ ఆ ప్రొవైడర్‌ను సంప్రదిస్తుంది.
...
**Easy** మోడ్‌లో, టూల్‌బార్ బిల్ట్-ఇన్ ప్రీసెట్లు అయిన **Free (OpenRouter)**, **Lite**, **Advanced**, మరియు **Technical** లతో కూడిన **నైపుణ్యం సెలెక్టర్**ను చూపుతుంది. [**Settings** > **General Settings**](#general-settings)లో మీరు ఎంచుకున్న **ప్రొవైడర్** ఆధారంగా ఏ నైపుణ్యాలు కనిపించాలో నిర్ణయించబడుతుంది—ఉదాహరణకు, ప్రొవైడర్ OpenRouter అయినప్పుడు మాత్రమే **Free (OpenRouter)** జాబితా చేయబడుతుంది. **ప్రొవైడర్** గనుక **Ollama** అయితే, టూల్‌బార్ నైపుణ్యాలకు బదులుగా మీరు ఇన్‌స్టాల్ చేసిన స్థానిక మోడల్‌లను చూపుతుంది.
...
1. **New prompt** పై క్లిక్ చేయండి.
2. **Generate prompt** పై క్లిక్ చేయండి.
3. ప్రాంప్ట్ ఏమి చేయాలో వివరించండి.
4. ఒక నైపుణ్యం (Easy) లేదా మోడల్ (Advanced) ఎంచుకోండి.
...
- **Easy** (డిఫాల్ట్): ఒక **ప్రొవైడర్** (OpenRouter, OpenAI, Anthropic, Google Gemini, DeepSeek, Groq, Mistral, xAI, Cerebras, లేదా Ollama) ఎంచుకోండి. క్లౌడ్ ప్రొవైడర్లు టూల్‌బార్‌లోని బిల్ట్-ఇన్ నైపుణ్య ప్రీసెట్లను ఉపయోగిస్తారు. **Ollama** నైపుణ్యాలకు బదులుగా మీ మెషీన్‌లో ఇన్‌స్టాల్ చేయబడిన మోడల్‌లను చూపుతుంది. Easy మోడ్‌లో, **Skills catalog** క్యాటలాగ్ వెర్షన్ మరియు చివరి నవీకరణ సమయాన్ని చూపుతుంది; ప్రాజెక్ట్ రిపోజిటరీ నుండి తాజా నైపుణ్యాల జాబితాను పొందడానికి **Refresh skills catalog** పై క్లిక్ చేయండి (యాప్ బ్యాక్‌గ్రౌండ్‌లో కూడా క్రమానుగతంగా తనిఖీ చేస్తుంది).
- **Advanced**: టూల్‌బార్‌లో వ్యక్తిగత మోడల్‌లను ఎంచుకోండి; [**Settings** > **Models**](#models) కింద జాబితాను నిర్వహించండి.
...
- వేరే నైపుణ్యం (Easy) లేదా మోడల్ (Advanced) ఎంచుకోండి
- తక్కువ నిడివి గల ఇన్‌పుట్‌ను ఉపయోగించండి
- [**Settings** > **General Settings**](#general-settings)లో **Real-time translation (while typing)** ఆఫ్ చేయండి
- సాధారణ పనుల కోసం ఉచిత మోడల్‌లను ఉపయోగించండి ([Models](#models) చూడండి)

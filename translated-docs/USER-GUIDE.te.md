...
ఒక విజయవంతమైన అనువాదం తర్వాత, మీరు అవుట్‌పుట్ ప్యానెల్‌లో ఫలితాన్ని మెరుగుపరచవచ్చు:

1. **మరలా వ్రాయండి…** — అవుట్పుట్‌లో ఎటువంటి పాఠ్యం ఎంపిక చేయబడకపోతే, అదే ఇన్‌పుట్‌కు వేరే పదబంధంతో మరో పూర్తి అనువాదాన్ని పొందండి. మీరు **ఐదు** వెర్షన్ల వరకు నిల్వ చేయవచ్చు మరియు వాటిని వెర్షన్ డ్రాప్‌డౌన్‌లో మారుస్తారు. పాఠ్యం ఎంపిక చేయబడితే, **మరలా వ్రాయండి…** ఎంపికకు సమీపంలో పద ప్రత్యామ్నాయాలను తెరుస్తుంది (కుడి-క్లిక్ చేయడం వంటి). ఎంపిక లేకుండా, మీరు ఐదు వెర్షన్లను చేరుకున్నప్పుడు **మరలా వ్రాయండి…** అచ్ఛాదితం అవుతుంది; ఎంపికతో, ఇది ఐదు వెర్షన్ల వద్ద ఇంకా పనిచేస్తుంది (పద ప్రత్యామ్నాయాలు మాత్రమే, వెర్షన్ 5 ను నవీకరించడం).
2. **పద ప్రత్యామ్నాయాలు** — అవుట్పుట్‌లో ఒకటి లేదా ఎక్కువ పదాలను ఎంపిక చేయండి (మీరు పదం యొక్క కేవలం భాగాన్ని మాత్రమే ఎంపిక చేస్తే, యాప్ ఎంపికను పూర్తి పదాలకు విస్తరించుతుంది), తరువాత కుడి-క్లిక్ చేయండి లేదా **మరలా వ్రాయండి…** క్లిక్ చేయండి. ఎంపికకు సమీపంలో ప్రత్యామ్నాయాల చిన్న జాబితా కనిపిస్తుంది; దాన్ని మార్చడానికి ఒకదానిని క్లిక్ చేయండి. మీ వద్ద ఐదు వెర్షన్ల కంటే తక్కువ ఉంటే, సవరించిన అవుట్పుట్ కొత్త వెర్షన్‌గా సేవ్ చేయబడుతుంది; ఐదు వెర్షన్ల వద్ద, కేవలం **వెర్షన్ 5** మాత్రమే నవీకరించబడుతుంది. ఎంపిక లేకుండా కుడి-క్లిక్ చేయడం ఏమి చేయదు. అవుట్పుట్‌ను మార్చకుండా రద్దు చేయడానికి **Esc** నొక్కండి లేదా జాబితా వెలుపల క్లిక్ చేయండి.
3. **ఖర్చులు** — ప్రతి పూర్తి **మరలా వ్రాయండి…** (ఎంపిక లేకుండా) మరియు ప్రతి పద-ప్రత్యామ్నాయ అభ్యర్థన మోడల్‌ను మళ్లీ ఉపయోగిస్తుంది మరియు వినియోగ ఖర్చుకు జోడించవచ్చు (సాధారణ అనువాద రన్‌తో సమానం).

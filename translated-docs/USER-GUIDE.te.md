---
translation_last_updated: '2026-05-27T10:11:01.899Z'
...
డిఫాల్ట్‌గా యాప్ **సులభం** మోడ్‌లో రన్ అవుతుంది: మీరు మోడల్ IDలను ఎంచుకోకుండానే సెట్టింగ్స్‌లో ఒక **ప్రిసెట్** (ఉదాహరణకు Free (OpenRouter), Lite, లేదా Technical) మరియు ఒక **ప్రొవైడర్**ను ఎంచుకుంటారు. మీరు [**సెట్టింగ్స్** > **సాధారణ సెట్టింగ్లు**](#general-settings)లో **అడ్వాన్స్డ్** మోడ్‌కు మారితే, [**సెట్టింగ్స్** > **మోడల్‌లు**](#models) నుండి క్లాసిక్ మోడల్ జాబితాను ఉపయోగించవచ్చు.
...
- **సులభం** మోడ్‌లో, **ప్రిసెట్** (Free (OpenRouter), Lite, Advanced, లేదా Technical) అనేది మీరు ఎంచుకున్న **ప్రొవైడర్** (OpenRouter, OpenAI, Ollama మరియు ఇతరాలు) కోసం ఒక మోడల్‌కు మ్యాప్ చేయబడి ఉంటుంది. ప్రస్తుత ప్రొవైడర్‌కు మ్యాపింగ్ ఉన్న స్కిల్స్ మాత్రమే టూల్‌బార్‌లో కనిపిస్తాయి. మీరు అనువాదం, పునర్రచన మరియు మార్చు విభాగాలలో స్కిల్‌ను ఎంచుకుంటారు.
- **అడ్వాన్స్డ్** మోడ్‌లో, **మోడల్** అనేది మీరు నేరుగా ఎంచుకునే AI ఇంజిన్. మోడల్ IDలు **ప్రొవైడర్ ప్రిఫిక్స్**ను (ఉదాహరణకు `openrouter/…`, `openai/…`, `ollama/…`) ఉపయోగిస్తాయి.
- ఒక **API కీ** (లేదా, Ollama కోసం ఒక **బేస్ URL**) ద్వారా యాప్ ఆ ప్రొవైడర్‌ను సంప్రదిస్తుంది.
...
**సులభం** మోడ్‌లో, టూల్‌బార్ బిల్ట్-ఇన్ ప్రిసెట్‌లైన **Free (OpenRouter)**, **Lite**, **Advanced**, మరియు **Technical**తో కూడిన **ప్రిసెట్ సెలెక్టర్**ను చూపుతుంది. ఏ ప్రిసెట్‌లు కనిపిస్తాయనేది మీరు [**సెట్టింగ్స్** > **సాధారణ సెట్టింగ్లు**](#general-settings)లో ఎంచుకున్న **ప్రొవైడర్**పై ఆధారపడి ఉంటుంది—ఉదాహరణకు, ప్రొవైడర్ OpenRouter అయినప్పుడు మాత్రమే **Free (OpenRouter)** జాబితా చేయబడుతుంది. **ప్రొవైడర్** గనుక **Ollama** అయితే, టూల్‌బార్ ప్రిసెట్‌లకు బదులుగా మీ సిస్టమ్‌లో ఇన్‌స్టాల్ చేయబడిన స్థానిక మోడల్‌లను చూపుతుంది.
...
- **సులభం** (డిఫాల్ట్): ఒక **ప్రొవైడర్**ను ఎంచుకోండి (OpenRouter, OpenAI, Anthropic, Google Gemini, DeepSeek, Groq, Mistral, xAI, Cerebras, లేదా Ollama). క్లౌడ్ ప్రొవైడర్లు టూల్‌బార్‌లోని బిల్ట్-ఇన్ ప్రిసెట్‌లను ఉపయోగిస్తారు. **Ollama** ప్రిసెట్‌లకు బదులుగా మీ మెషీన్‌లో ఇన్‌స్టాల్ చేయబడిన మోడల్‌లను చూపుతుంది. సులభం మోడ్‌లో, **ప్రిసెట్ల క్యాటలాగ్** క్యాటలాగ్ వెర్షన్ మరియు చివరి నవీకరణ సమయాన్ని చూపుతుంది; ప్రాజెక్ట్ రిపోజిటరీ నుండి తాజా స్కిల్ జాబితాను పొందడానికి **ప్రిసెట్ల క్యాటలాగ్‌ను రిఫ్రెష్ చేయండి** క్లిక్ చేయండి (యాప్ బ్యాక్‌గ్రౌండ్‌లో కూడా క్రమానుగతంగా తనిఖీ చేస్తుంది).
- **అడ్వాన్స్డ్**: టూల్‌బార్‌లో వ్యక్తిగత మోడల్‌లను ఎంచుకోండి; [**సెట్టింగ్స్** > **మోడల్‌లు**](#models) కింద జాబితాను నిర్వహించండి.

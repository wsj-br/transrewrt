![ట్రాన్స్‌రీవ్రట్ బ్యానర్](../images/transrewrt_banner.png)
...
- [అనువాదం](#translate)
  ...
  - [సహాయకరమైన అనువాద సెట్టింగ్‌లు](#helpful-translation-settings)
  - [మీ అనువాదాన్ని మెరుగుపరచడం](#refining-your-translation)
  - [గ్లోసరీని ఉపయోగించడం](#using-the-glossary)
- [పునర్వ్యవస్థీకరణ](#rewrite)
  - [వచనాన్ని పునర్వ్యవస్థీకరించండి](#rewrite-text)
  - [మీ పునర్వ్యవస్థీకరణను మెరుగుపరచడం](#refining-your-rewrite)
- [రూపాంతరం](#transform)
  - [ఇప్పటికే ఉన్న ప్రాంప్ట్‌ను అమలు చేయండి](#run-an-existing-prompt)
...
- [డాష్బోర్డ్](#dashboard)
  ...
  - [డాష్బోర్డ్ ట్యాబ్‌లు](#dashboard-tabs)
  - [డేటాను ఎగుమతి చేయండి](#export-data)
  - [మోడల్ కోసం నిల్వ చేసిన రికార్డులను తొలగించండి](#delete-stored-records-for-a-model)
- [చరిత్ర](#history)
  - [చరిత్రను వడపోత చేయండి](#filter-the-history)
  - [చరిత్ర డేటాను ఎగుమతి చేయండి](#export-history-data)
- [సెట్టింగ్స్](#settings)
  - [సాధారణ సెట్టింగ్స్](#general-settings)
  - [మాడల్స్](#models)
  - [భాషలు](#languages)
  - [వ్యయ ట్రాకింగ్](#cost-tracking)
  - [రూపాంతరం (సెట్టింగ్స్ ట్యాబ్)](#transform-settings-tab)
  - [గ్లోసరీ (సెట్టింగ్స్ ట్యాబ్)](#glossary-settings-tab)
  - [వినియోగదారులు](#users)
  - [API కాన్ఫిగరేషన్](#api-config)
  - [గురించి](#about)
- [సాధారణ సమస్యలు](#common-issues)
  - [యాప్ వచనాన్ని అనువదించదు, పునర్వ్యవస్థీకరించదు లేదా రూపాంతరం చేయదు](#the-app-will-not-translate-rewrite-or-transform-text)
  ...
  - [వచనం చాలా చిన్నదిగా లేదా చదవడానికి కష్టంగా ఉంది](#the-text-is-too-small-or-hard-to-read)
  - [డాష్బోర్డ్ సారాంశం ఖాళీగా కనిపిస్తుంది](#dashboard-summary-looks-empty)
  - [ఖర్చు "అందుబాటులో లేదు" అని చూపిస్తుంది లేదా తప్పుగా అనిపిస్తుంది](#cost-shows-not-available-or-seems-wrong)
  - [మొత్తం ఖర్చు నా ప్రొవైడర్ బిల్లుతో సరిపోలడం లేదు](#total-cost-does-not-match-my-provider-bill)
  - [చరిత్ర పేజీ సైడ్‌బార్ నుండి లేదు](#the-history-page-is-missing-from-the-sidebar)
  - [వెబ్ యాప్: ఊహించని విధంగా లాగిన్ పేజీకి దారి మళ్లించబడింది](#web-app-redirected-to-the-login-page-unexpectedly)
  - [వెబ్ అడ్మిన్: పాస్‌వర్డ్‌ను మర్చిపోయారు లేదా కోల్పోయారు](#web-admin-forgot-or-lost-a-password)
  - [ఇతర వినియోగదారుల కోసం డాష్బోర్డ్ డేటాను చూపదు (వెబ్)](#dashboard-shows-no-data-for-other-users-web)
  - [నేను ప్రాంప్ట్‌ను మార్చాను మరియు సవరణలను కోల్పోయాను](#i-changed-a-prompt-and-lost-the-edits)
...
![మాడల్ సెలెక్టర్](../images/screenshots/te/preset-selector.png)
...
![ఇంటర్ఫేస్ భాషా సెలెక్టర్](../images/screenshots/te/language-selector.png)
...
![అనువదించు వర్క్‌స్పేస్](../images/screenshots/te/translate.png)
...
9. ఎంపికగా ఫలితాన్ని **మరువుగా చెప్పు…** లేదా పదాల ప్రత్యామ్నాయాలతో మెరుగుపరచండి — [మీ అనువాదాన్ని మెరుగుపరచడం](#refining-translation)ని చూడండి.
...
- **అతికించినప్పుడు స్వయంచాలకంగా అమలు చేయండి** మీరు టెక్స్ట్ పేస్ట్ చేసిన వెంటనే అనువాదాన్ని అమలు చేస్తుంది.
- **ఫలితాన్ని క్లిప్బోర్డ్కు స్వయంచాలకంగా కాపీ చేయండి** విజయవంతమైన అమలుకు తర్వాత ఫలితాన్ని ఆటోమేటిక్‌గా కాపీ చేస్తుంది.
- **టైపింగ్ చేస్తున్నప్పుడు రియల్-టైమ్ అనువాదం** (⚠️ ఇది వినియోగ ఖర్చులను పెంచవచ్చు) మీరు టైప్ చేస్తున్నప్పుడు అనువాదాలను అమలు చేస్తుంది.
- **టైమ్‌ఔట్ (ms)** యాప్ రియల్-టైమ్ అనువాదాన్ని అమలు చేయడానికి ఎంత సమయం వేచి ఉంటుందో నియంత్రిస్తుంది.
- **ENTER కోసం వర్తనం** `Enter` పని నిర్వహించాలా లేదా కొత్త పంక్తిని చేర్చాలా అనే విషయాన్ని ఎంచుకుంటుంది:
  - **Enter** అనువదించు లేదా పునర్వ్యవస్థీకరించు (డిఫాల్ట్) అమలు చేస్తుంది.
  - **Shift + Enter** అనువదించు లేదా పునర్వ్యవస్థీకరించు; సాధారణ **Enter** కొత్త పంక్తిని చేర్చుతుంది.

<br/>

<a id="refining-translation"></a>
### మీ అనువాదాన్ని మెరుగుపరచడం

సఫలమైన అనువాదం తర్వాత, అవుట్పుట్ హెడ్డర్లో **మరువుగా చెప్పు…** మరియు వెర్షన్ డ్రాప్‌డౌన్ కనిపిస్తాయి, **కు:** భాష ఎంపికదారుడి పక్కన. మీరు అక్కడ ఫలితాన్ని మెరుగుపరచవచ్చు:

1. **పునర్వ్యవస్థీకరించండి…** — అవుట్‌పుట్‌లో వచనం ఎంపిక చేయబడనప్పుడు, అదే ఇన్‌పుట్ యొక్క మరొక పూర్తి అనువాదాన్ని విభిన్న పదాలతో పొందండి. మోడల్ మీకు ఇప్పటికే ఉన్న ప్రతి వెర్షన్‌ను అందుకుంటుంది, తద్వారా కొత్త పదాలు వాటి అన్నింటి నుండి భిన్నంగా ఉంటాయి. మీరు గరిష్టంగా **ఐదు** వెర్షన్‌లను నిల్వ చేయవచ్చు మరియు వెర్షన్ డ్రాప్‌డౌన్‌లో వాటి మధ్య మారవచ్చు. వచనం ఎంపిక చేయబడినప్పుడు, **పునర్వ్యవస్థీకరించండి…** ఎంపిక దగ్గర పద ప్రత్యామ్నాయాలను తెరుస్తుంది (కుడి-క్లిక్ వలె). ఎంపిక లేకుండా, మీరు ఐదు వెర్షన్‌లకు చేరుకున్న తర్వాత **పునర్వ్యవస్థీకరించండి…** నిలిపివేయబడుతుంది; ఎంపికతో, ఇది ఐదు వెర్షన్‌లలో కూడా పనిచేస్తుంది (పద ప్రత్యామ్నాయాలు మాత్రమే, వెర్షన్ 5ని అప్‌డేట్ చేస్తుంది). పూర్తి పునర్వ్యవస్థీకరణ నడుస్తున్నప్పుడు, రద్దు చేయడానికి **అనువాదాన్ని ఆపు** క్లిక్ చేయండి; పునర్వ్యవస్థీకరణ ప్రారంభమైనప్పుడు సక్రియంగా ఉన్న వెర్షన్‌కు అవుట్‌పుట్ తిరిగి వస్తుంది.
2. **పద ప్రత్యామ్నాయాలు** — అవుట్‌పుట్‌లో ఒకటి లేదా అంతకంటే ఎక్కువ పదాలు లేదా చిన్న పదబంధాన్ని ఎంచుకోండి (మీరు పదం యొక్క కొంత భాగాన్ని మాత్రమే ఎంచుకుంటే, యాప్ ఎంపికను పూర్తి పదాలకు విస్తరిస్తుంది), ఆపై కుడి-క్లిక్ చేయండి లేదా **పునర్వ్యవస్థీకరించండి…** క్లిక్ చేయండి. ఎంపిక దగ్గర ప్రత్యామ్నాయాల చిన్న జాబితా కనిపిస్తుంది; దాన్ని మార్చడానికి ఒకదానిపై క్లిక్ చేయండి. ప్రతి ఎంపిక మీ ఎంపిక కంటే కొద్దిగా విస్తృత పరిధిని భర్తీ చేయవచ్చు (ఉదాహరణకు ప్రక్కన ఉన్న ప్రిపోజిషన్ లేదా ఆర్టికల్) తద్వారా వాక్యం వ్యాకరణబద్ధంగా ఉంటుంది. మీకు ఐదు వెర్షన్‌ల కంటే తక్కువ ఉంటే, సవరించిన అవుట్‌పుట్ కొత్త వెర్షన్‌గా సేవ్ చేయబడుతుంది; ఐదు వెర్షన్‌లలో, **వెర్షన్ 5** మాత్రమే అప్‌డేట్ చేయబడుతుంది. ఎంపిక లేకుండా కుడి-క్లిక్ చేయడం కర్సర్ కింద ఉన్న పదాన్ని ఎంచుకుంటుంది (లేదా అక్కడ పదం లేకపోతే ఏమీ చేయదు). అవుట్‌పుట్‌ను మార్చకుండా రద్దు చేయడానికి **Esc** నొక్కండి లేదా జాబితా వెలుపల క్లిక్ చేయండి.
3. **ఖర్చులు** — ప్రతి పూర్తి **పునర్వ్యవస్థీకరించండి…** (ఎంపిక లేదు) మరియు ప్రతి పద-ప్రత్యామ్నాయ అభ్యర్థన మోడల్‌ను మళ్లీ ఉపయోగిస్తుంది మరియు వినియోగ ఖర్చుకు జోడించవచ్చు (సాధారణ అనువాద రన్ వలె).

<br/>

<a id="using-the-glossary"></a>
### గ్లోసరీని ఉపయోగించడం

**గ్లోసరీ** అనేది ఒక నిర్దిష్ట భాషా జత కోసం మూల/లక్ష్య పదాల జాబితా. గ్లోసరీ ఆన్‌లో ఉన్నప్పుడు, Transrewrt మోడల్‌కు సరిపోలే పదాలను పంపుతుంది, తద్వారా మీ ప్రాధాన్య పదజాలం అనువాదాలలో స్థిరంగా ఉంటుంది (ఉదాహరణకు ఒక ఉత్పత్తి పేరు, బ్రాండ్ పదం లేదా ఉద్యోగ శీర్షిక ఎల్లప్పుడూ ఒకే విధంగా అనువదించబడాలి).

**అనువదించు** పేజీలో దీన్ని ఉపయోగించడానికి:

1. ఇన్‌పుట్ ప్యానెల్‌లో **గ్లోసరీ** స్విచ్‌ను ఆన్ చేయండి (ఆటో-ఎగ్జిక్యూట్ మరియు ఆటో-కాపీ స్విచ్‌ల పక్కన).
2. మీ **నుండి** మరియు **కు** భాషలను ఎంచుకోండి మరియు యథావిధిగా అనువదించండి. ఆ భాషా జత కోసం సేవ్ చేయబడిన పదాలు స్వయంచాలకంగా వర్తిస్తాయి.
3. ఆన్ ది ఫ్లైలో కొత్త జతను సంగ్రహించడానికి, **గ్లోసరీకి జోడించు** క్లిక్ చేయండి (**నుండి:** భాష సెలెక్టర్ పక్కన). డైలాగ్ మీ ప్రస్తుత భాషలతో ముందుగా నింపబడుతుంది, కాబట్టి మీరు **మూల పదం** మరియు **లక్ష్య పదం** మాత్రమే పూరించాలి.
4. మీ అన్ని పదాలను సమీక్షించడానికి అవుట్‌పుట్ ఫుటర్‌లో **గ్లోసరీ** లింక్ (లేదా డైలాగ్‌లోని **గ్లోసరీని నిర్వహించండి** లింక్) ఉపయోగించండి [**సెట్టింగ్స్** > **గ్లోసరీ**](#glossary-settings) కు వెళ్ళడానికి.

మీరు [**సెట్టింగ్స్** > **గ్లోసరీ**](#glossary-settings) ట్యాబ్‌లో పదాలను జోడించవచ్చు, సవరించవచ్చు, దిగుమతి చేయవచ్చు మరియు ఎగుమతి చేయవచ్చు — క్రింద చూడండి.

<br/>

> ℹ️ **గమనిక**<br/>
> గ్లోసరీ పదాలు **భాషా జత** ద్వారా సరిపోలుతాయి, కాబట్టి ఇంగ్లీష్ → ఫ్రెంచ్ కోసం సేవ్ చేయబడిన పదం ఇంగ్లీష్ → జర్మన్ అనువదించేటప్పుడు వర్తించదు. మూలంగా **భాషను గుర్తించు** తో గ్లోసరీని ఉపయోగించలేరు, ఎందుకంటే పదాలను సరిపోల్చడానికి ఒక నిర్దిష్ట మూల భాష అవసరం.
...
ప్రధాన అర్థాన్ని మార్చకుండా పదాలను మెరుగుపరచాలనుకున్నప్పుడు **పునర్వ్యవస్థీకరణ**ను ఉపయోగించండి. వచనం అదే భాషలో ఉంటుంది (అది అనువదించబడదు).

![పునర్వ్యవస్థీకరణ వర్క్‌స్పేస్](../images/screenshots/te/rewrite.png)
...
<a id="rewrite-text"></a>
### వచనాన్ని పునర్వ్యవస్థీకరించండి

1. **పునర్వ్యవస్థీకరణ**ను తెరవండి.
2. ఒక **మోడ్**ను ఎంచుకోండి (ఉదాహరణకు **స్పష్టత మెరుగుపరచు** లేదా **ఔపచారికంగా చేయి**).
3. ఐచ్ఛికంగా **నుండి**ని మీ టెక్స్ట్ భాషకు సెట్ చేయండి (లేదా **భాషను గుర్తించు**ను వదిలివేయండి).
4. **ఇన్పుట్**లో టెక్స్ట్ ను టైప్ చేయండి లేదా పేస్ట్ చేయండి.
5. **పునర్వ్యవస్థీకరణ**పై క్లిక్ చేయండి.
6. **అవుట్పుట్**లో ఫలితాన్ని చదవండి.
7. ఐచ్ఛికంగా **పునర్వ్యవస్థీకరణ...** లేదా పద ప్రత్యామ్నాయాలతో ఫలితాన్ని మెరుగుపరచండి — [మీ పునర్వ్యవస్థీకరణను మెరుగుపరచడం](#refining-rewrite) చూడండి.
...
> ℹ️ **గమనిక**<br/>
> పునర్వ్యవస్థీకరణ మోడ్ **ప్రత్యామ్నాయ వర్షనులు** అవుట్పుట్లో `----` ద్వారా వేరు చేయబడిన **ఒకే** రన్లో అనేక పునర్వ్యవస్థీకరణలను అందిస్తుంది. ఇది **పునర్వ్యవస్థీకరణ...** నుండి భిన్నంగా ఉంటుంది, ఇది కాలక్రమేణా వెర్షన్ చరిత్రను నిర్మిస్తుంది (ప్రతి క్లిక్ కు ఒక కొత్త వేరియంట్). [మీ పునర్వ్యవస్థీకరణను మెరుగుపరచడం](#refining-rewrite) చూడండి.

<br/>

<a id="refining-rewrite"></a>
### మీ పునర్వ్యవస్థీకరణను మెరుగుపరచడం

విజయవంతమైన పునర్వ్యవస్థీకరణ తర్వాత, **పునర్వ్యవస్థీకరణ...** మరియు వెర్షన్ డ్రాప్డౌన్ వర్క్‌స్పేస్ యొక్క అవుట్‌పుట్ వైపు కనిపిస్తాయి (స్ప్లిట్ లేఅవుట్‌లో, అవుట్‌పుట్ కాలమ్ పైన ఉన్న టాప్ టూల్‌బార్‌లో, రన్ మెట్రిక్స్ పక్కన; స్టాక్డ్ లేఅవుట్‌లో, **నుండి:** పక్కన ఉన్న అవుట్‌పుట్ ప్యానెల్ పైన). మీరు అక్కడ ఫలితాన్ని మెరుగుపరచవచ్చు — [మీ అనువాదాన్ని మెరుగుపరచడం](#refining-translation) వలె అదే ఆలోచన, కానీ టెక్స్ట్ అదే భాషలో ఉంటుంది మరియు ప్రస్తుత పునర్వ్యవస్థీకరణ **మోడ్**ను అలాగే ఉంచుతుంది:

1. **పునర్వ్యవస్థీకరణ...** — అవుట్‌పుట్‌లో టెక్స్ట్ ఎంచుకోకుండా, అదే ఇన్‌పుట్‌ను విభిన్న పదాలతో మళ్లీ పూర్తిగా పునర్వ్యవస్థీకరించండి, ఎంచుకున్న మోడ్‌ను ఇప్పటికీ వర్తింపజేయండి (ఉదాహరణకు మరింత స్పష్టంగా, తక్కువగా లేదా మరింత అధికారికంగా). మోడల్ మీకు ఇప్పటికే ఉన్న ప్రతి వెర్షన్‌ను అందుకుంటుంది, తద్వారా కొత్త పదాలు వాటి అన్నింటికీ భిన్నంగా ఉండవచ్చు. మీరు గరిష్టంగా **ఐదు** వెర్షన్‌లను నిల్వ చేయవచ్చు మరియు వెర్షన్ డ్రాప్‌డౌన్‌లో వాటి మధ్య మారవచ్చు. టెక్స్ట్ ఎంచుకున్నప్పుడు, **పునర్వ్యవస్థీకరణ...** ఎంపిక దగ్గర పద ప్రత్యామ్నాయాలను తెరుస్తుంది (కుడి-క్లిక్ వలె). ఎంపిక లేకుండా, మీరు ఐదు వెర్షన్‌లకు చేరుకున్న తర్వాత **పునర్వ్యవస్థీకరణ...** నిలిపివేయబడుతుంది; ఎంపికతో, ఇది ఐదు వెర్షన్‌లలో కూడా పనిచేస్తుంది (పద ప్రత్యామ్నాయాలు మాత్రమే, వెర్షన్ 5ని అప్‌డేట్ చేస్తుంది). పూర్తి పునర్వ్యవస్థీకరణ నడుస్తున్నప్పుడు, రద్దు చేయడానికి **పునర్వ్యవస్థీకరణను ఆపు** క్లిక్ చేయండి; పునర్వ్యవస్థీకరణ ప్రారంభమైనప్పుడు సక్రియంగా ఉన్న వెర్షన్‌కు అవుట్‌పుట్ తిరిగి వస్తుంది.
2. **పద ప్రత్యామ్నాయాలు** — అవుట్‌పుట్‌లో ఒకటి లేదా అంతకంటే ఎక్కువ పదాలు లేదా ఒక చిన్న పదబంధాన్ని ఎంచుకోండి (మీరు ఒక పదం యొక్క భాగాన్ని మాత్రమే ఎంచుకుంటే, యాప్ ఎంపికను పూర్తి పదాలకు విస్తరిస్తుంది), ఆపై కుడి-క్లిక్ చేయండి లేదా **పునర్వ్యవస్థీకరణ...** క్లిక్ చేయండి. ఎంపిక దగ్గర ప్రత్యామ్నాయాల చిన్న జాబితా కనిపిస్తుంది; దానిని భర్తీ చేయడానికి ఒకదానిపై క్లిక్ చేయండి. ప్రతి ఎంపిక మీ ఎంపిక కంటే కొంచెం విస్తృతమైన పరిధిని భర్తీ చేయవచ్చు, తద్వారా వాక్యం వ్యాకరణబద్ధంగా ఉంటుంది. మీకు ఐదు వెర్షన్‌ల కంటే తక్కువ ఉంటే, సవరించిన అవుట్‌పుట్ కొత్త వెర్షన్‌గా సేవ్ చేయబడుతుంది; ఐదు వెర్షన్‌లలో, **వెర్షన్ 5** మాత్రమే అప్‌డేట్ చేయబడుతుంది. ఎంపిక లేకుండా కుడి-క్లిక్ చేయడం కర్సర్ కింద ఉన్న పదాన్ని ఎంచుకుంటుంది (లేదా అక్కడ పదం లేకపోతే ఏమీ చేయదు). అవుట్‌పుట్‌ను మార్చకుండా రద్దు చేయడానికి **Esc** నొక్కండి లేదా జాబితా వెలుపల క్లిక్ చేయండి.
3. **ఖర్చులు** — ప్రతి పూర్తి **పునర్వ్యవస్థీకరణ...** (ఎంపిక లేదు) మరియు ప్రతి పద-ప్రత్యామ్నాయ అభ్యర్థన మోడల్‌ను మళ్లీ ఉపయోగిస్తుంది మరియు వినియోగ ఖర్చుకు జోడించవచ్చు (సాధారణ పునర్వ్యవస్థీకరణ రన్ వలె).
...
3. **From** భాష బాక్స్ కనిపిస్తే, మీరు కావాలనుకుంటే ఒక భాషను ఎంచుకోండి.
4. **ఇన్పుట్** లో టెక్స్ట్ టైప్ చేయండి లేదా పేస్ట్ చేయండి.
...
![ప్రాంప్ట్ ను రూపొందించు](../images/screenshots/te/transform-generate.png)
...
![ట్రాన్స్‌ఫార్మ్ ప్రాంప్ట్ ఎడిటర్](../images/screenshots/te/transform-prompt-edit.png)
...
- **ఔట్‌పుట్ వివరణ (ఉదా. రూపాంతరం చేయబడింది, సారాంశీకరించబడింది, ఇతరం)**: ఫలితాన్ని వివరిస్తున్న చిన్న పదం.
- **ఉష్ణోగ్రత (0.0 → 1.0)**: మాడల్ ఎలా వర్తించాలో; క్రింద చూడండి.
- **లక్ష్య భాషను అడగండి**: ప్రాంప్ట్ అమలుకు సమయంలో భాష ఎంపికను చేర్చుతుంది.
మీకు సాంకేతిక పదం **ఉష్ణోగ్రత** కొత్తగా ఉంటే, దీన్ని ఇలా ఆలోచించండి:
...
![డాష్బోర్డ్ సారాంశం](../images/screenshots/te/dashboard-summary.png)
...
![డాష్బోర్డ్ ఫిల్టర్లు](../images/screenshots/te/dashboard-filter.png)
...
| ట్యాబ్              | డెస్క్‌టాప్ | వెబ్ (నిర్వాహకుడు) | వెబ్ (సాధారణ వాడుకరి) | గమనికలు                                        |
  ...
  | గ్లోసరీ         |   అవును   |     అవును     |        అవును         | అనువాదం సమయంలో వర్తించే పదాల జతలు        |
  | వాడుకరులు        |    -    |     అవును     |         -          |                                              |
...
- **ENTER కోసం వర్తనం** `Enter` పని నిర్వహించాలా లేదా కొత్త పంక్తిని చేర్చాలా అనే విషయాన్ని ఎంచుకుంటుంది.
- **అతికించినప్పుడు స్వయంచాలకంగా అమలు చేయండి** మీరు టెక్స్ట్ పేస్ట్ చేసిన వెంటనే అనువాదాన్ని ప్రారంభిస్తుంది.
- **ఫలితాన్ని క్లిప్బోర్డ్కు స్వయంచాలకంగా కాపీ చేయండి** విజయవంతమైన ఫలితాలను ఆటోమేటిక్‌గా కాపీ చేస్తుంది.
- **టైపింగ్ చేస్తున్నప్పుడు రియల్-టైమ్ అనువాదం** (⚠️ ఇది వినియోగ ఖర్చులను పెంచవచ్చు) మీరు టైప్ చేస్తున్నప్పుడు అనువదిస్తుంది.
...
**కాన్ఫిగరేషన్ బ్యాకప్** (డెస్క్‌టాప్ యాప్ మరియు వెబ్ నిర్వాహకులు మాత్రమే)
- **బ్యాకప్‌లో వినియోగ డేటాను చేర్చండి** - ఇది ప్రారంభించబడినప్పుడు, ZIP అమలుకు చరిత్ర మరియు API కాల్ డేటాను కూడా కలిగి ఉంటుంది.
- **బ్యాకప్ కాన్ఫిగరేషన్** - ఒకే ZIP (`transrewrt-config-backup-YYYY-MM-DD_HHMMSS.zip` స్థానిక సమయానికి) `config.json`, `state.json`, ఐచ్ఛిక ఎన్‌క్రిప్షన్ కీ, వినియోగదారులు, ప్రాధాన్యతలు, కస్టమ్ ప్రాంప్ట్‌లు, మరియు మీరు ఎంపిక చేసుకుంటే వినియోగ డేటాను కలిగి ఉంటుంది. విజయవంతమైన బ్యాకప్ తర్వాత, ధృవీకరణ సేవ్ చేసిన ఫైల్ పేరును చూపిస్తుంది.
- **బ్యాకప్ నుండి పునరుద్ధరించండి** - మొదట **ధృవీకరణ డైలాగ్** తెరుస్తుంది. డైలాగ్‌లో బ్యాకప్ ZIPను ఎంచుకోండి (**బ్రౌజ్** / ఫైల్ పికర్ లేదా మద్దతు ఉన్న చోట డ్రాగ్-అండ్-డ్రాప్), తరువాత ఎంపికలను సమీక్షించండి:
  - **వినియోగ డేటాను పునరుద్ధరించండి** - బ్యాకప్ సమయంలో వినియోగ/చరిత్రను ZIP నుండి దిగుమతి చేయండి; మీరు కేవలం సెట్టింగ్స్ మరియు ప్రాంప్ట్‌లను మాత్రమే కావాలనుకుంటే ఆపివేయండి.
  - **పునరుద్ధరించే ముందు పాత వినియోగ డేటాను క్లియర్ చేయండి** - బ్యాకప్‌ను అమలు చేయడానికి ముందు ఈ ఇన్‌స్టాల్‌లో ఉన్న పాత వినియోగ/చరిత్రను తీసివేయండి (ఐచ్ఛిక; మీరు శుభ్రమైన మార్పు కావాలనుకుంటే ఉపయోగించండి).
వెబ్ లేదా డెస్క్‌టాప్ వెర్షన్‌లో రూపొందించిన బ్యాకప్‌ను మరొకదానిలో పునరుద్ధరించవచ్చు. వెబ్ వెర్షన్‌లో డెస్క్‌టాప్ బ్యాకప్‌ను పునరుద్ధరించినప్పుడు, డేటా నిర్వాహక వినియోగదారునికి పునరుద్ధరించబడుతుంది.
...
![సెట్టింగ్స్ మోడల్స్ ట్యాబ్](../images/screenshots/te/settings-general.png)
...
### గ్లోసరీ (సెట్టింగ్స్ ట్యాబ్)

అనువాదం సమయంలో వర్తించే పద జతలను నిర్వహించడానికి **సెట్టింగ్స్** > **గ్లోసరీ**ని ఉపయోగించండి ([గ్లోసరీని ఉపయోగించడం](#using-the-glossary) చూడండి). ప్రతి పదానికి **మూల భాష**, **లక్ష్య భాష**, **మూల పదం**, మరియు **లక్ష్య పదం** ఉంటాయి.

మీరు:

- **పదాన్ని జోడించండి** — పట్టిక దిగువన ఉన్న వరుసను పూరించండి (భాషలను ఎంచుకోండి, మూల మరియు లక్ష్య పదాలను టైప్ చేయండి) మరియు **+** బటన్‌ను క్లిక్ చేయండి.
- **పదాలను కనుగొనండి** — **మూల భాష**, **లక్ష్య భాష**, లేదా ఉచిత **టెక్స్ట్** ద్వారా జాబితాను ఫిల్టర్ చేయండి; రీసెట్ చేయడానికి **ఫిల్టర్‌లను క్లియర్ చేయండి** క్లిక్ చేయండి.
- **పదాన్ని తొలగించండి** — దాని వరుసలోని ట్రాష్-బిన్ చిహ్నాన్ని క్లిక్ చేయండి.
- **దిగుమతి** — `.csv`, `.xlsx`, లేదా `.xls` ఫైల్ నుండి పదాలను లోడ్ చేయండి. ఫైల్‌లో `source_language`, `target_language`, `source_text`, మరియు `target_text` కాలమ్‌లు ఉండాలి.
- **CSV ఎగుమతి** / **XLSX ఎగుమతి** — బ్యాకప్ లేదా షేరింగ్ కోసం మీ అన్ని పదాలను డౌన్‌లోడ్ చేయండి.
- **టెంప్లేట్ CSV** / **టెంప్లేట్ XLSX** — పూరించడానికి మరియు దిగుమతి చేయడానికి సరైన కాలమ్ హెడర్‌లతో ఖాళీ ఫైల్‌ను డౌన్‌లోడ్ చేయండి.

<br/>

> ℹ️ **గమనిక**<br/>
> **డెస్క్‌టాప్ యాప్‌లో**, గ్లోసరీ స్థానికంగా నిల్వ చేయబడుతుంది. **వెబ్ వెర్షన్‌లో**, ప్రతి వినియోగదారుకు వారి స్వంత గ్లోసరీ ఉంటుంది, కాబట్టి మీ పదాలు ఇతర వినియోగదారులను ప్రభావితం చేయవు.
...
API కీలు సిస్టమ్ లేదా Docker ఎన్విరాన్‌మెంట్ వేరియబుల్స్ ద్వారా కాన్ఫిగర్ చేయబడతాయి - అవి వెబ్ UIలో నమోదు చేయబడవు. కస్టమ్ ప్రొవైడర్ కోసం, `CUSTOM_PROVIDER_NAME`, `CUSTOM_PROVIDER_URL`, మరియు `CUSTOM_PROVIDER_API_KEY` (మూడు అవసరం) సెట్ చేయండి. ఈ పేజీ ఏ ప్రొవైడర్లకు కీ కాన్ఫిగర్ చేయబడిందో చూపుతుంది మరియు `Test` బటన్‌ను క్లిక్ చేయడం ద్వారా ప్రతిదాన్ని పరీక్షించడానికి మిమ్మల్ని అనుమతిస్తుంది.
...
> 💡 **చిట్కా** <br/>
> మీరు API కీని ఉపయోగించకూడదనుకుంటే లేదా వినియోగానికి చెల్లించకూడదనుకుంటే, మీరు [Ollamaను డౌన్‌లోడ్](https://ollama.com) చేసి, మీ మెషీన్‌లో ఉచితంగా మాడల్స్ (`translategemma:4b` వంటివి) స్థానికంగా రన్ చేయవచ్చు. ప్రత్యామ్నాయంగా, మీరు వారి ఉచిత మాడల్స్‌ను ఉపయోగించడానికి ఉచిత OpenRouter ఖాతాను (క్రెడిట్ కార్డ్ అవసరం లేదు) సృష్టించవచ్చు, లేదా Cerebras, Google, Groq, Mistral AI, లేదా [NVIDIA](https://build.nvidia.com/) నుండి ఉచిత API కీని పొందవచ్చు.
...
- వేరే పూర్వ నిర్ధారణ (సులభం) లేదా మాడల్ (అధునాతన)ను ఎంచుకోండి
- చిన్న ఇన్పుట్‌ను ఉపయోగించండి
- [**సెట్టింగ్స్** > **సాధారణ సెట్టింగ్స్**](#general-settings)లో **టైపింగ్ చేస్తున్నప్పుడు రియల్-టైమ్ అనువాదం**ని ఆఫ్ చేయండి
- సులభమైన పనుల కోసం ఉచిత మాడల్స్‌ను ఉపయోగించండి (చూడండి [మాడల్స్](#models))
<br/>

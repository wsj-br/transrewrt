...
- [డాష్బోర్డ్](#dashboard)
  ...
  - [ఒక మోడల్ కోసం నిల్వ చేసిన రికార్డులను తొలగించండి](#delete-stored-records-for-a-model)
- [చరిత్ర](#history)
...
- [సాధారణ సమస్యలు](#common-issues)
  - [యాప్ పాఠ్యాన్ని అనువదించదు, పునర్వ్యవస్థీకరించదు లేదా రూపాంతరం చేయదు](#the-app-will-not-translate-rewrite-or-transform-text)
  ...
  - [ఖర్చు "అందుబాటులో లేదు" అని చూపుతుంది లేదా తప్పుగా కనిపిస్తుంది](#cost-shows-not-available-or-seems-wrong)
  ...
  - [వెబ్ యాప్: ఊహించని విధంగా లాగిన్ పేజీకి దారి మళ్ళించబడింది](#web-app-redirected-to-the-login-page-unexpectedly)
  - [వెబ్ అడ్మిన్: పాస్‌వర్డ్ మర్చిపోయాను లేదా పోగొట్టుకున్నాను](#web-admin-forgot-or-lost-a-password)
  - [ఇతర వినియోగదారుల కోసం డాష్బోర్డ్ డేటాను చూపడం లేదు (వెబ్)](#dashboard-shows-no-data-for-other-users-web)
  - [నేను ప్రాంప్ట్‌ను మార్చాను మరియు మార్పులను కోల్పోయాను](#i-changed-a-prompt-and-lost-the-edits)
...
1. **మరువుగా చెప్పు…** — అవుట్పుట్‌లో ఎటువంటి పాఠ్యం ఎంపిక చేయకపోతే, వేరే పదబంధంతో అదే ఇన్పుట్ యొక్క మరో పూర్తి అనువాదాన్ని పొందండి. మాడల్ మీకు ఇప్పటికే ఉన్న ప్రతి వెర్షన్‌ను అందిస్తుంది కాబట్టి కొత్త పదబంధం వాటిలోని వాటి నుండి భిన్నంగా ఉండవచ్చు. మీరు **ఐదు** వెర్షన్లను నిల్వ చేయవచ్చు మరియు వాటి మధ్య మారవచ్చు వెర్షన్ డ్రాప్‌డౌన్‌లో. పాఠ్యం ఎంపిక చేయబడినప్పుడు, **మరువుగా చెప్పు…** ఎంపికకు సమీపంలో పదాల ప్రత్యామ్నాయాలను తెరుస్తుంది (కుడి-క్లిక్ చేయడం వంటి). ఎంపిక లేకపోతే, మీరు ఐదు వెర్షన్లను చేరుకున్నప్పుడు **మరువుగా చెప్పు…** అచ్ఛాదితం అవుతుంది; ఎంపికతో, ఇది ఐదు వెర్షన్ల వద్ద ఇంకా పనిచేస్తుంది (పదాల ప్రత్యామ్నాయాలు మాత్రమే, వెర్షన్ 5ని నవీకరించడం). పూర్తి మరువుగా చెప్పడం జరుగుతున్నప్పుడు, రద్దు చేయడానికి **అనువదించు ఆపు** క్లిక్ చేయండి; అవుట్పుట్ మరువుగా చెప్పడం ప్రారంభించినప్పుడు యాక్టివ్ అయిన వెర్షన్‌కు తిరిగి వస్తుంది.
2. **పదాల ప్రత్యామ్నాయాలు** — అవుట్పుట్‌లో ఒకటి లేదా ఎక్కువ పదాలు లేదా చిన్న పదబంధాన్ని ఎంపిక చేయండి (మీరు పదం యొక్క కేవలం భాగాన్ని మాత్రమే ఎంపిక చేస్తే, యాప్ ఎంపికను పూర్తి పదాలకు విస్తరించుతుంది), తరువాత కుడి-క్లిక్ చేయండి లేదా **మరువుగా చెప్పు…** క్లిక్ చేయండి. ఎంపికకు సమీపంలో ప్రత్యామ్నాయాల చిన్న జాబితా కనిపిస్తుంది; దాన్ని మార్చడానికి ఒకదానిని క్లిక్ చేయండి. ప్రతి ఎంపిక మీ ఎంపిక కంటే కొంచెం విస్తృతమైన విస్తీర్ణాన్ని మార్చవచ్చు (ఉదాహరణకు, సమీపంలో ఉన్న ఒక ప్రిపోజిషన్ లేదా ఆర్టికల్) కాబట్టి వాక్యం వ్యాకరణపరంగా ఉంటుంది. మీ వద్ద ఐదు వెర్షన్ల కంటే తక్కువ ఉంటే, సవరించిన అవుట్పుట్ కొత్త వెర్షన్‌గా సేవ్ చేయబడుతుంది; ఐదు వెర్షన్ల వద్ద, కేవలం **వెర్షన్ 5** మాత్రమే నవీకరించబడుతుంది. ఎంపిక లేకుండా కుడి-క్లిక్ చేయడం ఏమీ చేయదు. అవుట్పుట్‌ను మార్చకుండా రద్దు చేయడానికి **Esc** నొక్కండి లేదా జాబితా వెలుపల క్లిక్ చేయండి.
3. **ఖర్చులు** — ప్రతి పూర్తి **మరువుగా చెప్పు…** (ఎటువంటి ఎంపిక లేదు) మరియు ప్రతి పదాల ప్రత్యామ్నాయ అభ్యర్థన మోడల్‌ను మళ్లీ ఉపయోగిస్తుంది మరియు వినియోగ ఖర్చుకు జోడించవచ్చు (సాధారణ అనువాదం నడవడం వంటి).

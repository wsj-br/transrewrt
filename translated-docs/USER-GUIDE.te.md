...
- [అనువాదం](#translate)
  - [అనువదించు](#translate-text)
  - [భాష ఎంపిక](#language-selection)
  - [సహాయక అనువాద సెట్టింగ్స్](#helpful-translation-settings)
  - [మీ అనువాదాన్ని మెరుగుపరచడం](#refining-translation)
- [పునర్వ్యవస్థీకరణ](#rewrite)
- [రూపాంతరం](#transform)
  - [ఉన్న ప్రాంప్ట్‌ను నడపండి](#run-an-existing-prompt)
  - [మీకు ప్రాంప్ట్‌లు లేకపోతే](#if-you-have-no-prompts-yet)
  - [ప్రాంప్ట్‌ను త్వరగా సృష్టించండి](#create-a-prompt-quickly)
  - [ప్రాంప్ట్‌ను సవరించండి](#edit-a-prompt)
  - [ఉపయోగించడానికి ముందు ప్రాంప్ట్‌ను పరీక్షించండి](#test-a-prompt-before-using-it)
- [డాష్బోర్డ్](#dashboard)
  - [డేటాను వడపోత](#filter-the-data)
  - [డాష్బోర్డ్ టాబ్స్](#dashboard-tabs)
  - [డేటాను ఎగుమతి](#export-data)
  - [ఒక మాడల్ కోసం నిల్వ చేసిన రికార్డులను తొలగించండి](#delete-stored-records-for-a-model)
- [చరిత్ర](#history)
  - [చరిత్రను వడపోత](#filter-the-history)
  - [చరిత్ర డేటాను ఎగుమతి](#export-history-data)
- [సెట్టింగ్స్](#settings)
  - [సాధారణ సెట్టింగ్స్](#general-settings)
  - [మాడల్స్](#models)
  - [భాషలు](#languages)
  - [వ్యయ ట్రాకింగ్](#cost-tracking)
  - [రూపాంతరం (సెట్టింగ్స్ టాబ్)](#transform-settings-tab)
  - [వినియోగదారులు](#users)
  - [API కాన్ఫిగరేషన్](#api-config)
  - [గురించి](#about)
- [సాధారణ సమస్యలు](#common-issues)
  - [యాప్ అనువదించదు, పునర్వ్యవస్థీకరించదు లేదా రూపాంతరం చేయదు](#the-app-will-not-translate-rewrite-or-transform-text)
  - [మాడల్ జాబితా ఖాళీగా ఉంది](#the-model-list-is-empty)
  - [ఫలితం చాలా నెమ్మదిగా లేదా చాలా ఖర్చుగా ఉంది](#the-result-is-too-slow-or-too-expensive)
  ...
  - [డాష్బోర్డ్ సారాంశం ఖాళీగా కనిపిస్తోంది](#dashboard-summary-looks-empty)
  ...
  - [చరిత్ర పేజీ సైడ్‌బార్ నుండి కోల్పోయింది](#the-history-page-is-missing-from-the-sidebar)
  - [వెబ్ యాప్: అనుకోకుండా లాగిన్ పేజీకి మళ్లించబడింది](#web-app-redirected-to-the-login-page-unexpectedly)
  - [వెబ్ అడ్మిన్: పాస్వర్డ్ మర్చిపోయారు లేదా కోల్పోయారు](#web-admin-forgot-or-lost-a-password)
  - [డాష్బోర్డ్ ఇతర వినియోగదారుల కోసం డేటా చూపించడం లేదు (వెబ్)](#dashboard-shows-no-data-for-other-users-web)
  - [నేను ఒక ప్రాంప్ట్‌ను మార్చాను మరియు సవరింపులను కోల్పోయాను](#i-changed-a-prompt-and-lost-the-edits)
- [త్వరిత చిట్కాలు](#quick-tips)
- [అసహ్యమైనది](#disclaimer)
- [లైసెన్స్](#license)

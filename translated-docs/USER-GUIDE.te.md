---
translation_last_updated: '2026-04-15T22:30:34.230Z'
...
- [అనువదించు](#translate)
  - [టెక్స్ట్‌ను అనువదించు](#translate-text)
...
- [సాధారణ సమస్యలు](#common-issues)
  - [అప్లికేషన్ టెక్స్ట్‌ను అనువదించదు, రీరైట్ చేయదు లేదా ట్రాన్స్‌ఫార్మ్ చేయదు](#the-app-will-not-translate-rewrite-or-transform-text)
  ...
  - [మొత్తం ఖర్చు మీ ప్రదాత బిల్లుతో సరిపోలదు](#total-cost-does-not-match-my-provider-bill)
  ...
  - [డ్యాష్‌బోర్డ్ ఇతర వినియోగదారుల కోసం డేటా చూపించడం లేదు (వెబ్)](#dashboard-shows-no-data-for-other-users-web)
...
2. ఖాతాను సృష్టించండి లేదా సైన్ ఇన్ చేయండి.
3. [Keys](https://openrouter.ai/keys) పేజీని తెరవండి.
4. కొత్త API కీని సృష్టించడానికి బటన్‌పై క్లిక్ చేయండి.
5. తర్వాత మీరు దానిని గుర్తించగలిగేలా కీకి పేరు ఇవ్వండి.
6. కొత్త API కీని కాపీ చేసుకోండి.
7. Transrewrtకి తిరిగి వెళ్లి **సెట్టింగ్‌లు** > **API కాన్ఫిగ్** తెరవండి.
8. **ఓపెన్రౌటర్ API కీ**లో ( **సెట్టింగ్‌లు** > **API కాన్ఫిగ్** కింద) కీని అతికించండి.
9. అది పనిచేస్తుందో లేదో చూడటానికి **ఓపెన్రౌటర్ కీని పరీక్షించండి**పై క్లిక్ చేయండి.
...
1. యాప్‌ని తెరవండి.
2. అవసరమైతే గ్లోబ్ ఐకాన్ నుండి మీ **ఇంటర్‌ఫేస్ భాష** ని ఎంచుకోండి.
3. మీరు **డెస్క్‌టాప్ యాప్**లో ఉంటే, [**సెట్టింగ్‌లు** > **API కాన్ఫిగ్**](#api-config) తెరిచి, కనీసం ఒక ప్రదాత కోసం (ఉదాహరణకు ఓపెన్రౌటర్) API కీని జోడించండి మరియు అది పనిచేస్తుందో లేదో నిర్ధారించడానికి **పరీక్ష** క్లిక్ చేయండి.
4. [**సెట్టింగ్‌లు** > **మోడల్‌లు**](#models) తెరిచి, ఒకటి లేదా అంతకంటే ఎక్కువ మోడల్‌లను **ఎంపిక చేసిన మోడల్‌లు**కు జోడించండి.
5. [**సెట్టింగ్‌లు** > **భాషలు**](#languages) తెరిచి, మీరు ఎక్కువగా ఉపయోగించే భాషలు మొదట కనిపించాలనుకుంటే **ప్రధాన భాషలు** ఎంచుకోండి.
6. **అనువాదం**కు వెళ్లి ప్రతిదీ సరిగా పనిచేస్తుందో నిర్ధారించడానికి సులభమైన అనువాదాన్ని నడుపుతారు.
7. అది పనిచేసిన తర్వాత, **రీరైట్** తర్వాత **ట్రాన్స్‌ఫార్మ్** ప్రయత్నించండి.
...
- **పేస్ట్ చేసినప్పుడు ఆటో-అనువాదం** మీరు పాఠ్యాన్ని పేస్ట్ చేసిన వెంటనే అనువాదాన్ని నడుపుతుంది.
- **ఫలితాన్ని క్లిప్‌బోర్డ్‌కు ఆటో-కాపీ చేయి** విజయవంతమైన అమలు తర్వాత ఫలితాన్ని స్వయంచాలకంగా కాపీ చేస్తుంది.
- **రియల్-టైమ్ అనువాదం (టైప్ చేస్తున్నప్పుడు)** మీరు టైప్ చేస్తున్నప్పుడు అనువాదాలను నడుపుతుంది.
- **టైమౌట్ (ms)** రియల్-టైమ్ అనువాదాన్ని నడుపుటకు ముందు అప్లికేషన్ ఎంతకాలం వేచి ఉంటుందో నియంత్రిస్తుంది.
...
- నోట్స్ సారాంశం
- సున్నితమైన ఇమెయిల్‌గా సురుక్కునే టెక్స్ట్‌ను మార్చడం
- కీ పాయింట్లను ఉపసంహరించుకోవడం
- టెక్స్ట్‌ను ప్రత్యేక ఫార్మాట్‌లోకి మార్చడం
- ఇన్‌పుట్ టెక్స్ట్‌తో ఏదైనా ఇతర కస్టమ్ కార్యాచరణ
...
3. ఒకవేళ **లక్ష్యం** భాష బాక్స్ కనిపిస్తే, కావలసినట్లయితే ఒక భాషను ఎంచుకోండి.
4. **ఇన్‌పుట్**లో టెక్స్ట్ ను టైప్ చేయండి లేదా అతికించండి.
...
3. మీరు ప్రాంప్ట్ చేయాలనుకుంటున్నది ఏమిటో వివరించండి.
4. ఒక మోడల్‌ని ఎంచుకోండి.
5. యాప్ మీ కోసం డ్రాఫ్ట్‌ని సృష్టించనివ్వండి.
6. డ్రాఫ్ట్‌ని సమీక్షించి **సేవ్ చేయి**పై క్లిక్ చేయండి.
...
- **ప్రాంప్ట్ సూచనలు (ఐచ్ఛికం)**: ప్రాంప్ట్‌ను నడుపుతున్నప్పుడు వాడుకరికి చూపబడే స్వల్ప సూచన.
- **మోడల్ పాత్ర**: 'మీరు సహాయకారి అసిస్టెంట్' వంటి AIకి కేటాయించిన మొత్తం పాత్ర.
- **మోడల్ సూచనలు (ఒక్కో పంక్తికి ఒకటి)**: AI అనుసరించాలనుకునే ప్రత్యేక నియమాలు.
- **అవుట్‌పుట్ వివరణ**: 'సారాంశం' లేదా 'రీరైట్' వంటి ఫలితాన్ని వివరించే చిన్న పదం.
...
- **సారాంశం** వాడకం మరియు ఖర్చు గురించి సమగ్ర సమాచారాన్ని అందిస్తుంది. ఇందులో **కాలక్రమేణా ఉపయోగం** (అనువాదం, రీరైట్ మరియు ట్రాన్స్‌ఫార్మ్ కోసం రోజుకు కూర్చిన మొత్తం **కాల్ కౌంట్లు**) మరియు **మోడల్ ద్వారా ఉపయోగం** (**మోడల్ ప్రకారం మొత్తం కాల్స్**, ట్రాన్స్‌ఫార్మ్ సహా) ఉంటాయి.
...
| టాబ్               | డెస్క్‌టాప్ | వెబ్ (కార్యదర్శి) | వెబ్ (సాధారణ వాడుకరి) |
  |-------------------|:-------:|:-----------:|:------------------:|
...
- **ENTER కోసం వ్యవహారం** `Enter` పనిని నడుపుతుందో లేదా కొత్త పంక్తిని చొప్పిస్తుందో నిర్ణయిస్తుంది.
...
- **చర్యలపై ఖర్చు సమాచారాన్ని చూపించండి** ఆపరేషన్ కు ఖర్చు (అందుబాటులో ఉంటే) మరియు అనువాదం, రీరైట్ మరియు ట్రాన్స్‌ఫార్మ్ అవుట్‌పుట్ ప్యానెల్స్ పై మొత్తం ఖర్చు ప్రదర్శనను నియంత్రిస్తుంది.
...
- **ఫాంట్ కుటుంబం** పాఠ్య ప్యానెల్స్ లో రాయడానికి ఫాంట్ ని మారుస్తుంది.
- **పరిమాణం** ఫాంట్ పరిమాణాన్ని మారుస్తుంది.

**కాన్ఫిగరేషన్ బ్యాకప్**

- **Include usage data in the backup** - ప్రారంభించినప్పుడు, ZIP అమలు చరిత్ర మరియు API కాల్ డేటాను కూడా కలిగి ఉంటుంది. 
- **Backup configuration** - `transrewrt-config-backup-YYYY-MM-DD_HHMMSS.zip` (UTC లో డిఫాల్ట్ గా) లో `config.json`, `state.json`, ఐచ్ఛిక ఎన్‌క్రిప్షన్ కీ, వినియోగదారులు, ప్రాధాన్యతలు, కస్టమ్ ప్రాంప్ట్‌లు మరియు మీరు ఎంచుకున్నట్లయితే ఉపయోగం సమాచారంతో కూడిన ఒకే ఒక ZIP ని సృష్టిస్తుంది. విజయవంతమైన బ్యాకప్ తర్వాత, ధృవీకరణ సేవ్ చేసిన ఫైల్ పేరును చూపిస్తుంది.
- **Restore from backup** - ముందుగా **ఒక ధృవీకరణ డైలాగ్‌ను** తెరుస్తుంది. డైలాగ్ లోపల బ్యాకప్ ZIP ని ఎంచుకోండి (**బ్రౌజ్** / ఫైల్ పికర్ లేదా మద్దతు ఉన్న చోట డ్రాగ్-అండ్-డ్రాప్), తర్వాత ఎంపికలను సమీక్షించండి:
  - **Restore the usage data** - ఉపయోగం చేర్చబడినప్పుడు బ్యాకప్ చేయబడిన ZIP నుండి ఉపయోగం/చరిత్రను దిగుమతి చేసుకోండి; మీరు సెట్టింగ్‌లు మరియు ప్రాంప్ట్‌లు మాత్రమే కావాలనుకుంటే దీన్ని ఆఫ్ చేయండి.
  - **Clear the old usage data before restoring** - బ్యాకప్ ను వర్తించే ముందు ఈ ఇన్‌స్టాల్ లో ఉన్న పాత ఉపయోగం/చరిత్రను తొలగించండి (ఐచ్ఛికం; మీరు శుభ్రమైన భర్తీ కావాలనుకున్నప్పుడు ఉపయోగించండి).
...
- పేరు ద్వారా మోడల్‌ను కనుగొనడానికి **మోడల్‌లను శోధించు...**
- ఒక ఇంజిన్‌కు (ఓపెన్రౌటర్, ఓపెన్ఏఐ, ఓలామా, …) జాబితాను పరిమితం చేయడానికి **ప్రదాత** చిప్స్
- ఉచిత మోడల్‌లను మాత్రమే చూపించడానికి **ఉచితవి మాత్రమే**
- జాబితాను పునఃలోడ్ చేయడానికి **రిఫ్రెష్**
- మీరు ప్రదాత ద్వారా క్రమబద్ధీకరిస్తున్నప్పుడు **అన్నీ విస్తరించు** మరియు **అన్నీ కుదించు**
...
- **విలువను కాపీ చేయి** మొత్తాన్ని క్లిప్‌బోర్డ్‌లోకి కాపీ చేస్తుంది.
...
- **ఖర్చు డేటాను తొలగించు** అన్ని డేటాను లేదా ఎంపిక చేసిన తేదీకి ముందు ఉన్న మాత్రమే ఎంట్రీలను తొలగిస్తుంది.
...
- మీరు సేవ్ చేసిన ప్రాంప్ట్‌లను సమీక్షించవచ్చు
- ప్రాంప్ట్‌లను తొలగించవచ్చు
- ఫైల్ నుండి ప్రాంప్ట్‌లను ఇంపోర్ట్ చేసుకోవచ్చు
- బ్యాకప్ లేదా షేరింగ్ కోసం ప్రాంప్ట్‌లను ఎగుమతి చేయవచ్చు
- ప్రాంప్ట్ జాబితాకు నమూనా ప్రాంప్ట్‌లు లోడ్ చేయవచ్చు
...
- [**అనువదించు**](#translate)తో ప్రారంభించండి, తర్వాత [**రీరైట్**](#rewrite) లేదా [**ట్రాన్స్‌ఫార్మ్**](#transform)కి వెళ్లే ముందు మీ సెటప్ పనిచేస్తుందో లేదో నిర్ధారించుకోండి.
- రోజువారీ పదబంధాల మెరుగుదలల కోసం [**రీరైట్**](#rewrite) ఉపయోగించండి.
- ప్రత్యేక పని కోసం పునరావృత వర్క్‌ఫ్లో అవసరమైనప్పుడు [**ట్రాన్స్‌ఫార్మ్**](#transform) ఉపయోగించండి.
- ఉపయోగం మరియు ఖర్చుపై దృష్టి ఉంచాలనుకుంటే [**డ్యాష్‌బోర్డ్**](#dashboard) ఉపయోగించండి.
- గత ఆపరేషన్లు మరియు వాటి పూర్తి ఇన్‌పుట్/అవుట్‌పుట్ టెక్స్ట్‌ను సమీక్షించడానికి [**చరిత్ర**](#history) ఉపయోగించండి.
- మీరు సురక్షితంగా ఉంచాలనుకుంటున్న ప్రాంప్ట్ లైబ్రరీని నిర్మాణం చేస్తున్నట్లయితే (చూడండి [ట్రాన్స్‌ఫార్మ్ ప్రాంప్ట్‌లు](#transform-prompts)) లేదా ఇతరులతో పంచుకోవాలనుకుంటే ప్రాంప్ట్‌లను క్రమం తప్పకుండా ఎగుమతి చేయండి.

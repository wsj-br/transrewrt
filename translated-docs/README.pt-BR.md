...
Abra [http://localhost:5000](http://localhost:5000) e altere a senha de administrador padrão. As chaves do provedor são definidas por meio de variáveis de ambiente (não pela interface web).

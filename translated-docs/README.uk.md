---
translation_last_updated: '2026-05-24T17:53:11.313Z'
...
- **Перекласти** — між десятками мов із автоматичним визначенням мови джерела
- **Переписати** — виправити граматику, покращити чіткість, формальний/неформальний стиль, скоротити, розширити, технічний текст
- **Перетворити** — користувацькі запити для ШІ; створювати та керувати запитами, необов’язкова цільова мова для кожного запиту
- **Історія** — повна історія виконання з вхідними та вихідними даними, фільтрацією та експортом
- **Простий і Розширений** - Простий режим (за замовчуванням): підібрані навички для кожного постачальника (**Безкоштовно (OpenRouter)**, **Lite**, **Розширений**, **Технічний**; відображаються лише навички, які відповідають обраному постачальнику) без вибору ідентифікаторів моделей; Розширений режим: повний список моделей від налаштованих постачальників
- **Моделі та вартість** - інформаційні панелі вартості та використання (Підсумок, За моделлю, Усі виклики) з можливістю експорту; OpenRouter показує фактичні витрати, інші постачальники використовують оцінки
...
- **Настільний додаток** - додаток на основі Electron для Windows та Linux
- **Самостійне розгортання** - образ Docker для amd64 та arm64 (готовий до використання на Raspberry Pi)

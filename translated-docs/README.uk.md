---
translation_last_updated: '2026-05-18T15:42:52.458Z'
...
- **Простий і Розширений** - Простий режим (за замовчуванням): підібрані навички для кожного постачальника (Безкоштовно, Швидко, Розширений, Технічний, Юридичний) без вибору ID моделі; Розширений режим: повний список моделей від налаштованих постачальників
- **Моделі та вартість** - панелі витрат та використання (Підсумок, За моделлю, Усі виклики) з експортом; OpenRouter показує фактичні витрати, інші постачальники використовують оцінки

---
translation_last_updated: '2026-06-02T00:06:27.490Z'
...
- **Простий і розширений** - Простий режим (за замовчуванням): підібрані налаштування для кожного постачальника (**Безкоштовно (OpenRouter)**, **Стандартний**, **Розширений**, **Технічний**; відображаються лише налаштування, що відповідають обраному постачальнику), без вибору ідентифікаторів моделей; Розширений режим: повний список моделей від ваших налаштованих постачальників

---
translation_last_updated: '2026-05-29T23:39:43.007Z'
...
- **সহজ ও উন্নত** - সহজ মোড (ডিফল্ট): প্রদানকারী অনুযায়ী পূর্বনির্ধারিত সেট (**ফ্রি (ওপেনরাউটার)**, **স্ট্যান্ডার্ড**, **উন্নত**, **টেকনিক্যাল**; শুধুমাত্র নির্বাচিত প্রদানকারীর জন্য ম্যাপিং সহ পূর্বনির্ধারিত সেটগুলি প্রদর্শিত হয়) মডেল আইডি ছাড়াই; উন্নত মোড: আপনার কনফিগার করা প্রদানকারীদের থেকে সম্পূর্ণ মডেল তালিকা
- **মডেলগুলি ও খরচ** - খরচ এবং ব্যবহারের ড্যাশবোর্ড (সারাংশ, মডেল অনুযায়ী, সমস্ত কল) রপ্তানি সহ; ওপেনরাউটার প্রকৃত ব্যয় দেখায়, অন্যান্য প্রদানকারীরা অনুমান ব্যবহার করে

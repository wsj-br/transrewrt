...
- **রূপান্তর** - কাস্টম এআই প্রম্পট; প্রম্পট তৈরি এবং পরিচালনা করুন, প্রম্পট প্রতি ঐচ্ছিক লক্ষ্য ভাষা
- **গ্লসারি** - ভাষা জোড়া প্রতি উৎস/লক্ষ্য শব্দ জোড়া সংরক্ষণ করুন এবং অনুবাদের সময় সেগুলি প্রয়োগ করুন যাতে নির্বাচিত শব্দগুলি সামঞ্জস্যপূর্ণ থাকে; সেটিংস-এ শব্দগুলি পরিচালনা করুন (যুক্ত করুন/সম্পাদনা করুন/মুছুন, CSV/XLSX আমদানি এবং টেমপ্লেট রপ্তানি)
- **ইতিহাস** - ইনপুট/আউটপুট পাঠ্য, ফিল্টারিং এবং রপ্তানিসহ সম্পূর্ণ এক্সিকিউশন ইতিহাস
- **সহজ এবং উন্নত** - সহজ মোড (ডিফল্ট): প্রদানকারী প্রতি কিউরেটেড প্রিসেট (**বিনামূল্য (OpenRouter)**, **স্ট্যান্ডার্ড**, **উন্নত**, **প্রযুক্তিগত**; শুধুমাত্র নির্বাচিত প্রদানকারীর জন্য ম্যাপিং সহ প্রিসেটগুলি প্রদর্শিত হয়) মডেল আইডি নির্বাচন না করে; উন্নত মোড: আপনার কনফিগার করা প্রদানকারীদের থেকে সম্পূর্ণ মডেল তালিকা
- **মডেল এবং খরচ** - খরচ এবং ব্যবহারের ড্যাশবোর্ড (সারাংশ, মডেল অনুযায়ী, সকল কল) রপ্তানিসহ; OpenRouter প্রকৃত ব্যয় দেখায়, অন্যান্য প্রদানকারীরা অনুমান ব্যবহার করে
- **UI** - বহুভাষিক ইন্টারফেস (৩০+ ভাষা, RTL সমর্থন), ফন্ট, ...
- **ওয়েব মোড** - অ্যাডমিন ভূমিকা সহ মাল্টি-ইউজার সমর্থন
- **ডেস্কটপ** - উইন্ডোজ এবং লিনাক্সের জন্য ইলেকট্রন অ্যাপ
- **সেলফ-হোস্টেড** - amd64 এবং arm64 (Raspberry Pi-প্রস্তুত) এর জন্য ডকার ইমেজ

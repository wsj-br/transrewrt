---
translation_last_updated: '2026-05-02T22:45:53.733Z'
...
- {{Translate}} - {{అన్నీ భాషల మధ్య, స్వయంచాలక మూల గుర్తింపుతో}}
- **{{Rewrite}}** - {{వ్యాకరణాన్ని సరిదిద్దండి, స్పష్టతను మెరుగుపరచండి, ఆధునిక/అధునాతన, సంక్షిప్తం చేయండి, విస్తరించండి, సాంకేతిక}}
- **{{Transform}}** - {{అనుకూల AI ప్రాంప్ట్‌లు; ప్రాంప్ట్‌లను సృష్టించండి మరియు నిర్వహించండి, ప్రాంప్ట్ కోసం ఐచ్ఛిక లక్ష్య భాష}}
- **{{History}}** - {{ఇన్‌పుట్/అవుట్‌పుట్ టెక్స్ట్‌తో పూర్తి అమలు చరిత్ర, ఫిల్టరింగ్, మరియు ఎగుమతి}}

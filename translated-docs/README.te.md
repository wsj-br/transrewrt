---
translation_last_updated: '2026-04-27T16:59:55.388Z'
...
అప్లికేషన్ పనిచేస్తున్న తర్వాత, పాఠాన్ని అనువదించడం, రీరైట్ చేయడం మరియు ట్రాన్స్‌ఫార్మ్ చేయడం, ప్రాంప్ట్‌లను నిర్వహించడం మరియు మోడల్‌లను కాన్ఫిగర్ చేయడం నేర్చుకోవడానికి **[వాడుకరి మార్గదర్శి](USER-GUIDE.te.md)** చూడండి.
...
- **ఆర్కిటెక్చర్ మరియు సిస్టమ్ అవర్వ్యూ:** ఫోల్డర్ స్ట్రక్చర్, టెక్ స్టాక్, డిజైన్ నిర్ణయాలు - **[dev/SYSTEM-OVERVIEW.md](../dev/SYSTEM-OVERVIEW.md)** చూడండి.

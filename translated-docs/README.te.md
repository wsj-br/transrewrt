...
- **రూపాంతరం** - కస్టమ్ AI ప్రాంప్ట్‌లు; ప్రాంప్ట్‌లను సృష్టించండి మరియు నిర్వహించండి, ప్రాంప్ట్ ప్రకారం ఐచ్ఛిక లక్ష్య భాష
- **గ్లోసరీ** - భాషా జతకు సోర్స్/టార్గెట్ టర్మ్ జతలను నిల్వ చేయండి మరియు అనువాదం సమయంలో వాటిని వర్తింపజేయండి, తద్వారా ఎంచుకున్న పదాలు స్థిరంగా ఉంటాయి; సెట్టింగ్‌లలో పదాలను నిర్వహించండి (జోడించు/సవరించు/తొలగించు, CSV/XLSX దిగుమతి మరియు టెంప్లేట్ ఎగుమతి)
- **చరిత్ర** - ఇన్‌పుట్/అవుట్‌పుట్ టెక్స్ట్‌తో పూర్తి ఎగ్జిక్యూషన్ చరిత్ర, ఫిల్టరింగ్ మరియు ఎగుమతి
- **సులభం & అధునాతన** - సులభమైన మోడ్ (డిఫాల్ట్): ప్రొవైడర్ ప్రకారం క్యూరేటెడ్ ప్రీసెట్‌లు (**ఉచితం (OpenRouter)**, **స్టాండర్డ్**, **అధునాతన**, **సాంకేతిక**; ఎంచుకున్న ప్రొవైడర్ కోసం మ్యాపింగ్ ఉన్న ప్రీసెట్‌లు మాత్రమే కనిపిస్తాయి) మోడల్ IDలను ఎంచుకోకుండా; అధునాతన మోడ్: మీ కాన్ఫిగర్ చేయబడిన ప్రొవైడర్ల నుండి పూర్తి మోడల్ జాబితా
- **మాడల్స్ & ఖర్చు** - ఖర్చు మరియు వినియోగ డాష్‌బోర్డ్‌లు (సారాంశం, మోడల్ ద్వారా, అన్ని కాల్స్) ఎగుమతితో; OpenRouter వాస్తవ ఖర్చును చూపుతుంది, ఇతర ప్రొవైడర్లు అంచనాలను ఉపయోగిస్తారు
- **UI** - బహుభాషా ఇంటర్‌ఫేస్ (30+ భాషలు, RTL మద్దతు), ఫాంట్‌లు, ...
- **వెబ్ మోడ్** - అడ్మిన్ పాత్రలతో బహుళ-వినియోగదారు మద్దతు
- **డెస్క్‌టాప్** - Windows మరియు Linux కోసం ఎలక్ట్రాన్ యాప్
- **స్వీయ-హోస్ట్ చేయబడింది** - amd64 & arm64 (Raspberry Pi-సిద్ధంగా) కోసం Docker ఇమేజ్

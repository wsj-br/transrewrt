---
translation_last_updated: '2026-04-15T22:29:41.604Z'
...
- [सामान्य समस्याएं](#common-issues)
  - [ऐप टेक्स्ट का अनुवाद, रीराइट या ट्रांसफ़ॉर्म नहीं करेगा](#the-app-will-not-translate-rewrite-or-transform-text)
  ...
  - [लागत "उपलब्ध नहीं" या गलत लगती है](#cost-shows-not-available-or-seems-wrong)
  - [कुल लागत मेरे प्रदाता के बिल से मेल नहीं खाती](#total-cost-does-not-match-my-provider-bill)
  - [हिस्ट्री पृष्ठ साइडबार से गायब है](#the-history-page-is-missing-from-the-sidebar)
...
3. यदि आप **डेस्कटॉप ऐप** पर हैं, तो [**सेटिंग्स** > **API कॉन्फ़िग**](#api-config) खोलें, कम से कम एक प्रदाता (उदाहरण के लिए OpenRouter) के लिए एक API कुंजी जोड़ें, और यह सत्यापित करने के लिए **टेस्ट** पर क्लिक करें कि यह काम करती है।
...
6. **अनुवाद करें** पर जाएँ और सब कुछ काम कर रहा है यह सुनिश्चित करने के लिए एक सरल अनुवाद चलाएँ।
...
- **पेस्ट करने पर ऑटो-अनुवाद** तब तुरंत अनुवाद चलाता है जब आप पाठ चिपकाते हैं।
- **परिणाम ऑटो-कॉपी क्लिपबोर्ड पर** सफलतापूर्वक चलने के बाद परिणाम को स्वचालित रूप से कॉपी कर देता है।
- **रीयल-टाइम अनुवाद (टाइपिंग के दौरान)** आपके टाइप करते समय अनुवाद चलाता है।
- **टाइमआउट (मिलीसेकंड)** नियंत्रित करता है कि ऐप रीयल-टाइम अनुवाद चलाने से पहले कितनी देर तक प्रतीक्षा करेगा।
- **Enter** यह नियंत्रित करता है कि जब आप `Enter` दबाएँ तो क्या होगा:
...
- पाठ को अधिक स्पष्ट बनाने के लिए (**स्पष्टता सुधारें**)
...
3. यदि एक **लक्ष्य** भाषा बॉक्स दिखाई देता है, तो चाहें तो एक भाषा चुनें।
4. **इनपुट** में पाठ टाइप करें या चिपकाएँ।
...
- **प्रॉम्प्ट निर्देश (वैकल्पिक)**: उपयोगकर्ता को प्रॉम्प्ट चलाते समय दिखाया गया एक छोटा सुझाव।
- **मॉडल भूमिका**: एआई को दी गई समग्र भूमिका, जैसे 'आप एक सहायक सहायक हैं।'
- **मॉडल निर्देश (प्रति पंक्ति एक)**: विशिष्ट नियम जिन्हें आप एआई को अनुसरण करने के लिए चाहते हैं।
...
- **सारांश** आपको उपयोग और लागत का एक अवलोकन देता है। इसमें **समय के साथ उपयोग** (अनुवाद, पुनर्लेखन और ट्रांसफ़ॉर्म के लिए दिन के अनुसार संचित **कॉल गणना** के रूप में चित्रित) और **मॉडल द्वारा उपयोग** (**प्रति मॉडल कुल कॉल**, ट्रांसफ़ॉर्म सहित) शामिल है।
...
- **पेस्ट करने पर ऑटो-अनुवाद** तुरंत अनुवाद शुरू करता है जैसे ही आप पाठ चिपकाते हैं।
...
- **क्रियाओं पर लागत जानकारी दिखाएं** ऑपरेशन प्रति लागत (यदि उपलब्ध हो) और अनुवाद, रीराइट और ट्रांसफ़ॉर्म आउटपुट पैनल पर कुल लागत के प्रदर्शन को नियंत्रित करता है।
...
- **कॉन्फ़िगरेशन बैकअप करें** - एकल ZIP (UTC में डिफ़ॉल्ट रूप से `transrewrt-config-backup-YYYY-MM-DD_HHMMSS.zip` में) बनाता है जिसमें `config.json`, `state.json`, वैकल्पिक एन्क्रिप्शन कुंजी, उपयोगकर्ता, पसंद, कस्टम प्रॉम्प्ट और उपयोग डेटा शामिल होता है यदि आपने सहमति दी है। सफल बैकअप के बाद, पुष्टि सहेजी गई फ़ाइल का नाम दिखाती है।
- **बैकअप से पुनर्स्थापित करें** - पहले एक **पुष्टि संवाद** खोलता है। संवाद के अंदर बैकअप ZIP चुनें (**ब्राउज़** / फ़ाइल पिकर या समर्थित जगहों पर ड्रैग-एंड-ड्रॉप), फिर विकल्पों की समीक्षा करें:
  - **उपयोग डेटा को पुनर्स्थापित करें** - उपयोग शामिल होने के साथ बैकअप किए जाने पर ZIP से उपयोग/इतिहास आयात करें; यदि आप केवल सेटिंग्स और प्रॉम्प्ट चाहते हैं तो बंद छोड़ दें।
  - **पुनर्स्थापित करने से पहले पुराना उपयोग डेटा साफ़ करें** - बैकअप लागू करने से पहले इस स्थापना पर मौजूदा उपयोग/इतिहास को हटा दें (वैकल्पिक; जब आप एक साफ़ प्रतिस्थापन चाहते हैं तो उपयोग करें)।
...
- नाम से मॉडल खोजने के लिए **मॉडल खोजें...**
- सूची को एक इंजन (OpenRouter, OpenAI, Ollama, …) तक सीमित करने के लिए **प्रदाता** चिप्स
- केवल मुफ्त मॉडल दिखाने के लिए **केवल मुफ़्त**
- सूची को पुनः लोड करने के लिए **रीफ़्रेश**
- प्रदाता के अनुसार छाँटते समय **सभी विस्तृत करें** और **सभी संक्षिप्त करें**
...
- **कुल लागत** चल रहे कुल योग को दिखाती है।
- **मान कॉपी करें** कुल योग को क्लिपबोर्ड पर कॉपी करता है।
- **लागत रीसेट करें** संग्रहीत कुल योग को शून्य पर रीसेट करता है।
- **API कुंजी उपयोग के साथ सिंक करें** कुल योग को आपके OpenRouter खाते द्वारा रिपोर्ट किए गए उपयोग के अनुसार सेट करता है (केवल OpenRouter)।
...
- अपनी सेटअप की जांच करने के लिए [**अनुवाद करें**](#translate) से शुरू करें इससे पहले कि आप [**रीराइट**](#rewrite) या [**ट्रांसफ़ॉर्म**](#transform) पर आगे बढ़ें।
- रोजमर्रा के शब्दावली सुधार के लिए [**रीराइट**](#rewrite) का उपयोग करें।
- किसी विशिष्ट कार्य के लिए दोहराई जा सकने वाली वर्कफ़्लो की आवश्यकता होने पर [**ट्रांसफ़ॉर्म**](#transform) का उपयोग करें।

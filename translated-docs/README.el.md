---
translation_last_updated: '2026-05-21T23:11:36.335Z'
...
- **Εύκολο & Προχωρημένο** - Λειτουργία Εύκολο (προεπιλογή): επιλεγμένες δεξιότητες ανά πάροχο (**Δωρεάν (OpenRouter)**, **Lite**, **Προχωρημένο**, **Τεχνικό**· εμφανίζονται μόνο δεξιότητες με αντιστοίχιση για τον επιλεγμένο πάροχο) χωρίς επιλογή αναγνωριστικών μοντέλων· Λειτουργία Προχωρημένο: πλήρης λίστα μοντέλων από τους διαμορφωμένους παρόχους σας

---
translation_last_updated: '2026-05-17T23:32:09.462Z'
...
- **Εύκολο & Προχωρημένο** - Λειτουργία Εύκολο (προεπιλογή): επιλεγμένες δεξιότητες ανά πάροχο (Δωρεάν, Γρήγορο, Προχωρημένο, Τεχνικό, Νομικό) χωρίς επιλογή αναγνωριστικών μοντέλων· Λειτουργία Προχωρημένο: πλήρης λίστα μοντέλων από τους διαμορφωμένους παρόχους σας
- **Μοντέλα & κόστος** - πίνακες ελέγχου κόστους και χρήσης (Περίληψη, Ανά μοντέλο, Όλες οι κλήσεις) με δυνατότητα εξαγωγής· Ο OpenRouter εμφανίζει την πραγματική δαπάνη, ενώ οι άλλοι πάροχοι χρησιμοποιούν εκτιμήσεις
- **Διεπαφή χρήστη (UI)** - πολύγλωσση διεπαφή (πάνω από 30 γλώσσες, υποστήριξη RTL), γραμματοσειρές, ...

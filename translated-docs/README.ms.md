---
translation_last_updated: '2026-03-30T00:46:19.599Z'
...
![Settings - model selection](../images/screenshots/ms/settings-models.png)
...
> ℹ️ **NOTA**<br/>
> Dalam Docker, kredensial LLM ditetapkan menggunakan pemboleh ubah persekitaran seperti `OPENROUTER_API_KEY`, `OPENAI_API_KEY`, `CEREBRAS_API_KEY`, … (bukan dalam UI web). Pada desktop (Electron), anda mengkonfigurasi kunci di **Tetapan → API**.
...
> ℹ️ **NOTA**<br/>
> Windows mungkin memaparkan salah satu amaran keselamatan berikut (biasa untuk aplikasi tanpa tanda tangan/pengguna bebas):
>   - **User Account Control (UAC)**: "Adakah anda mahu membenarkan aplikasi dari penerbit tidak diketahui ini membuat perubahan pada peranti anda?" → Klik **Ya**.
>   - **Microsoft Defender SmartScreen**: "Windows melindungi PC anda" → Klik **Maklumat lanjut** → **Jalankan sahaja**.
>
> Ini berlaku kerana aplikasi tersebut tidak ditandatangani oleh Microsoft atau penerbit utama—ia selamat jika dimuat turun dari pelepasan rasmi GitHub kami
...
- Bergantungan tambahan (Debian/Ubuntu): `sudo apt install libgtk-3-0 libnotify-dev libnss3 libxss1 libasound2 libxtst6 xauth`
...
Jangan gunakan model **Body Builder** OpenRouter ([`openrouter/bodybuilder`](https://openrouter.ai/openrouter/bodybuilder)) untuk terjemah, tulis semula, atau transformasi: ia mengembalikan muatan JSON permintaan, bukan teks lengkap untuk tugas-tugas tersebut. Rujuk [Tetapan → Model](USER-GUIDE.ms.md#models) dalam Panduan Pengguna.
...
> ⚠️ **AMARAN**<br/>
> Jika anda menggunakan Ollama daripada peranti, bekas, atau perkhidmatan lain, ingat untuk mengkonfigurasi Ollama bagi membenarkan sambungan luaran (bukan localhost sahaja).
...
| `TZ`             | `Europe/London`         | Zon masa IANA untuk masa sisi pelayan (log, dsb.); UI masih mengikut pelayar. Lihat [Docker → zon masa](#docker-timezone) |
...
> ⚠️ **AMARAN**<br/>
> Tukar kata laluan pentadbir lalai segera pada sebarang hos yang boleh diakses melalui rangkaian.

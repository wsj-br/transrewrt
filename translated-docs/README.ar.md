---
translation_last_updated: '2026-05-29T23:01:43.387Z'
...
- **سهل ومتقدم** - الوضع السهل (الافتراضي): إعدادات مُعدة مسبقًا حسب المزود (**مجاني (OpenRouter)**، **قياسي**، **متقدم**، **تقني**؛ تظهر فقط الإعدادات المسبقة التي لها تطابق مع المزود المحدد) دون الحاجة لاختيار معرفات النماذج؛ الوضع المتقدم: قائمة كاملة بالنماذج من موفريك المُهيئين
- **النماذج والتكلفة** - لوحات تحليل التكلفة والاستخدام (ملخص، حسب النموذج، جميع الطلبات) مع إمكانية التصدير؛ يعرض OpenRouter الإنفاق الفعلي، بينما يستخدم الموفرون الآخرون تقديرات
- **واجهة المستخدم** - واجهة متعددة اللغات (أكثر من 30 لغة، مع دعم الكتابة من اليمين لليسار)، خطوط، ...
- **الوضع الويب** - دعم المستخدمين المتعددين مع أدوار المسؤول

---
translation_last_updated: '2026-05-17T23:29:54.235Z'
...
- **سهل ومتقدم** - الوضع السهل (الافتراضي): مهارات مختارة حسب المزود (مجاني، سريع، متقدم، تقني، قانوني) دون الحاجة لاختيار معرفات النماذج؛ الوضع المتقدم: قائمة كاملة بالنماذج من موفريك المُعدّين
- **النماذج والتكلفة** - لوحات مراقبة التكلفة والاستخدام (ملخص، حسب النموذج، جميع الطلبات) مع إمكانية التصدير؛ يعرض OpenRouter الإنفاق الفعلي، بينما يستخدم موفرو الخدمات الآخرون تقديرات
- **واجهة المستخدم** - واجهة متعددة اللغات (أكثر من 30 لغة، مع دعم الكتابة من اليمين إلى اليسار)، خطوط، ...
- **الوضع الويب** - دعم متعدد المستخدمين مع أدوار المسؤول

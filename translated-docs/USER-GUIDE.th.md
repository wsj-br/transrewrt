---
translation_last_updated: '2026-05-02T22:46:59.368Z'
...
- แปล** - แปลงข้อความจากภาษาหนึ่งเป็นอีกภาษาหนึ่ง
- **เขียนใหม่** - เรียบเรียงข้อความใหม่ในสไตล์ที่ต่างออกไป เช่น ให้ชัดเจนขึ้น สั้นลง หรือเป็นทางการมากขึ้น
- **แปลง** - ประมวลผลข้อความโดยใช้คำสั่ง AI แบบกำหนดเองที่เรียกว่า พรอมต์
...
- ใช้ [**ประวัติการใช้งาน](#history) เพื่อทบทวนการดำเนินการก่อนหน้าและข้อความข้อมูลนำเข้า/ส่งออกทั้งหมด
- ส่งออกพรอมต์เป็นประจำหากคุณกำลังสร้างห้องสมุดพรอมต์ที่ต้องการเก็บไว้อย่างปลอดภัย (ดู [พรอมต์แปลง](#transform-prompts)) หรือหากคุณต้องการแบ่งปันกับผู้อื่น

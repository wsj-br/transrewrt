---
translation_last_updated: '2026-04-15T22:30:43.899Z'
...
- [ก่อนเริ่มต้น](#before-you-start)
  - [วิธีรับคีย์ API ฟรีจาก OpenRouter (สำหรับแอปเดสก์ท็อป)](#how-to-get-a-free-openrouter-api-key-desktop-app)
...
- [ปัญหาทั่วไป](#common-issues)
  ...
  - [ฉันแก้ไขคำสั่งแล้วแต่การแก้ไขหายไป](#i-changed-a-prompt-and-lost-the-edits)
- [เคล็ดลับการใช้งานอย่างรวดเร็ว](#quick-tips)
...
1. เข้าไปที่ [OpenRouter](https://openrouter.ai) ในเว็บเบราว์เซอร์ของคุณ  
...
3. หากคุณใช้ **แอปเดสก์ท็อป** ให้เปิด [**ตั้งค่า** > **การตั้งค่า API**](#api-config) เพิ่มคีย์ API สำหรับผู้ให้บริการอย่างน้อยหนึ่งราย (ตัวอย่างเช่น OpenRouter) และคลิก **ทดสอบ** เพื่อยืนยันว่าใช้งานได้
4. เปิด [**ตั้งค่า** > **โมเดล**](#models) และเพิ่มโมเดลหนึ่งตัวขึ้นไปใน **โมเดลที่เลือก**
5. เปิด [**ตั้งค่า** > **ภาษา**](#languages) และเลือก **ภาษาที่ใช้บ่อยที่สุด** ของคุณ หากต้องการให้ภาษาที่คุณใช้บ่อยที่สุดแสดงขึ้นก่อน
...
- **แปลอัตโนมัติเมื่อวาง** ทำงานแปลทันทีที่คุณวางข้อความ
- **คัดลอกผลลัพธ์ไปยังคลิปบอร์ดอัตโนมัติ** คัดลอกผลลัพธ์โดยอัตโนมัติหลังจากทำงานสำเร็จ
- **การแปลแบบเรียลไทม์ (ขณะพิมพ์)** ทำงานแปลขณะที่คุณพิมพ์
- **หมดเวลา (มิลลิวินาที)** ควบคุมระยะเวลาที่แอปรอ ก่อนจะเริ่มการแปลแบบเรียลไทม์
...
- สร้างรูปแบบการถ่ายทอดที่แตกต่างกันหลายแบบในการรันเดียว (**เวอร์ชันอื่น ๆ**)
...
- สรุปบันทึก
- แปลงข้อความร่างให้เป็นอีเมลที่เรียบร้อย
- ดึงประเด็นสำคัญ
...
3. ถ้าปรากฏช่อง **เป้าหมาย** ให้เลือกภาษาที่ต้องการ
4. พิมพ์หรือวางข้อความลงใน **ข้อมูลนำเข้า**
5. คลิก **แปลง**
6. อ่านผลลัพธ์ใน **ผลลัพธ์**
...
1. คลิก **คำสั่งใหม่**  
2. คลิก **สร้างพรอมต์**  
3. อธิบายสิ่งที่คุณต้องการให้คำสั่งนั้นทำ  
4. เลือกโมเดล  
...
- **{{Prompt name}}**: ชื่อที่แสดงในรายการคำสั่ง
- **{{Prompt instructions (optional)}}**: คำแนะนำสั้น ๆ ที่แสดงให้ผู้ใช้เห็นเมื่อรันคำสั่ง
- **{{Model Role}}**: บทบาทโดยรวมที่กำหนดให้กับปัญญาประดิษฐ์ เช่น 'คุณคือนักช่วยเหลือที่มีประโยชน์'
- **{{Model Instructions (one per line)}}**: กฎเฉพาะที่คุณต้องการให้ปัญญาประดิษฐ์ปฏิบัติตาม (หนึ่งบรรทัดต่อคำสั่ง)
- **{{Output description}}**: คำสั้น ๆ ที่อธิบายผลลัพธ์ เช่น 'สรุป' หรือ 'เขียนใหม่'
- **{{Temperature (0.0 → 1.0)}}**: ลักษณะการตอบสนองของโมเดล ดูคำอธิบายด้านล่าง
- **{{Ask for target language}}**: เพิ่มตัวเลือกภาษาเป้าหมายเมื่อรันคำสั่ง
...
- **สรุป** ให้ภาพรวมของการใช้งานและค่าใช้จ่าย ซึ่งรวมถึง **การใช้งานตามลำดับเวลา** (จำนวน **การเรียกใช้งาน** สะสมแบบเรียงซ้อนรายวัน สำหรับการแปล เขียนใหม่ และแปลง) และ **การใช้งานตามโมเดล** (**การเรียกใช้งานต่อโมเดล** ทั้งหมด รวมถึงการแปลง)
- **ตามการใช้งาน** แยกกิจกรรมออกตามภาษาการแปล โหมดการปรับแต่ง และคำขอเปลี่ยน
- **ตามโมเดล** แสดงว่าคุณใช้โมเดลใดไปบ้างและมีค่าใช้จ่ายเท่าใด
- **ตามวัน** แสดงยอดรวมรายวัน
- **การโทรทั้งหมด** แสดงประวัติการเรียกใช้งานทั้งหมด และให้คุณส่งออกข้อมูลได้
...
- **พฤติกรรมสำหรับ ENTER** เลือกว่า `Enter` จะรันงานหรือแทรกบรรทัดใหม่
...
- **หมดเวลา (มิลลิวินาที)** ตั้งค่าระยะเวลาการรอสำหรับการแปลแบบเรียลไทม์
...
- **แสดงข้อมูลค่าใช้จ่ายบนการดำเนินการ** ควบคุมการแสดงค่าใช้จ่ายต่อการดำเนินการ (ถ้ามี) และค่าใช้จ่ายรวมบนแผงผลลัพธ์การแปล เขียนใหม่ และแปลง
...
- **ตระกูลแบบอักษร** เปลี่ยนแบบอักษรที่ใช้เขียนในแผงข้อความ
- **ขนาด** เปลี่ยนขนาดตัวอักษร

**การสำรองข้อมูลการตั้งค่า**

- **รวมข้อมูลการใช้งานในการสำรองข้อมูล** - เมื่อเปิดใช้งาน ไฟล์ ZIP จะมีประวัติการดำเนินการและข้อมูลการเรียกใช้ API ด้วย  
- **สำรองข้อมูลการตั้งค่า** - สร้างไฟล์ ZIP เดียว (`transrewrt-config-backup-YYYY-MM-DD_HHMMSS.zip` เป็นค่าเริ่มต้นตามเวลามาตรฐานสากล) ซึ่งประกอบด้วย `config.json`, `state.json`, กุญแจการเข้ารหัสแบบเลือกได้, ผู้ใช้, ค่ากำหนด, คำสั่งที่กำหนดเอง และข้อมูลการใช้งานหากคุณเลือกใช้ เมื่อสำรองข้อมูลสำเร็จ หน้าต่างยืนยันจะแสดงชื่อไฟล์ที่บันทึกไว้  
- **กู้คืนข้อมูลจากไฟล์สำรอง** - จะเปิด **กล่องโต้ตอบยืนยันก่อน** เลือกไฟล์ ZIP สำรองข้อมูลภายในกล่องโต้ตอบ (**เรียกดู** / เลือกไฟล์ หรือลากแล้วปล่อยหากเบราว์เซอร์รองรับ) จากนั้นตรวจสอบตัวเลือก:  
  - **คืนค่าข้อมูลการใช้งาน** - นำเข้าข้อมูลการใช้งาน/ประวัติจากไฟล์ ZIP เมื่อมีการสำรองข้อมูลพร้อมข้อมูลการใช้งาน; ไม่ต้องเลือกหากต้องการเฉพาะการตั้งค่าและคำสั่ง  
  - **ล้างข้อมูลการใช้งานเก่าก่อนการกู้คืน** - ลบข้อมูลการใช้งาน/ประวัติที่มีอยู่ในการติดตั้งนี้ก่อนนำข้อมูลสำรองมาใช้ (ตัวเลือก; ใช้เมื่อต้องการแทนที่อย่างสมบูรณ์)
...
- ชิป **ผู้ให้บริการ** เพื่อจำกัดรายการให้เหลือเฉพาะหนึ่งเครื่องยนต์ (OpenRouter, OpenAI, Ollama, …)  
- **เฉพาะฟรี** เพื่อแสดงเฉพาะโมเดลที่ไม่เสียค่าใช้จ่าย  
...
- **ต้นทุนรวม** แสดงยอดรวมที่คำนวณได้
...
- **ลบข้อมูลต้นทุน** ลบข้อมูลทั้งหมด หรือเฉพาะรายการที่เก่ากว่าที่เลือก
...
- ตรวจสอบคำสั่งที่บันทึกไว้ของคุณ
- ลบคำสั่ง
- นำเข้าคำสั่งจากไฟล์
...
- เริ่มต้นด้วย [**แปล**](#translate) เพื่อให้แน่ใจว่าการตั้งค่าของคุณทำงานได้ก่อนที่คุณจะไปที่ [**เขียนใหม่**](#rewrite) หรือ [**แปลง**](#transform).
- ใช้ [**เขียนใหม่**](#rewrite) สำหรับการปรับปรุงคำพูดในชีวิตประจำวัน.
...
- ใช้ [**ประวัติ**](#history) เพื่อตรวจสอบการดำเนินการที่ผ่านมาและข้อความนำเข้าหรือข้อความนำออกทั้งหมด.
- ส่งออกคำสั่งเป็นประจำหากคุณกำลังสร้างห้องสมุดคำสั่งที่คุณต้องการเก็บให้ปลอดภัย (ดู [คำสั่งแปลง](#transform-prompts)) หรือหากคุณต้องการแบ่งปันกับผู้อื่น.

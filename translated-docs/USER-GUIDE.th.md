---
translation_last_updated: '2026-05-17T23:34:18.815Z'
...
โดยค่าเริ่มต้น แอปจะทำงานในโหมด **ง่าย**: คุณเลือก **ทักษะ** (ตัวอย่างเช่น ฟรี เร็ว หรือ เทคนิค) และ **ผู้ให้บริการ** ในส่วนตั้งค่า โดยไม่ต้องเลือกโมเดล ID เปลี่ยนไปใช้โหมด **ขั้นสูง** ได้ที่ [**ตั้งค่า** > **การตั้งค่าทั่วไป**](#general-settings) หากคุณต้องการรายการโมเดลแบบดั้งเดิมจาก [**ตั้งค่า** > **โมเดล**](#models)
...
- [ตั้งค่า](#settings)
  ...
  - [แปลง (แท็บการตั้งค่า)](#transform-settings)
  - [ผู้ใช้](#users)
...
- ในโหมด **ง่าย** **ทักษะ** คือการตั้งค่าล่วงหน้า (ฟรี เร็ว ขั้นสูง เทคนิค กฎหมาย) ที่เชื่อมโยงกับโมเดลสำหรับ **ผู้ให้บริการ** ที่คุณเลือก (OpenRouter, OpenAI, Ollama และอื่นๆ) คุณเลือกทักษะนี้จากแถบเครื่องมือในหน้าแปล เขียนใหม่ และแปลง
- ในโหมด **ขั้นสูง** **โมเดล** คือเครื่องมือปัญญาประดิษฐ์ที่คุณเลือกโดยตรง โดยโมเดล ID จะใช้คำนำหน้าจาก **ผู้ให้บริการ** (ตัวอย่างเช่น `openrouter/…`, `openai/…`, `ollama/…`)
- **คีย์ API** (หรือสำหรับ Ollama คือ **URL พื้นฐาน**) คือวิธีที่แอปใช้ติดต่อกับผู้ให้บริการนั้น

หากคุณใช้ **แอปเดสก์ท็อป** ให้เพิ่มคีย์ในส่วน [**ตั้งค่า** > **การตั้งค่า API**](#api-config) สำหรับผู้ให้บริการแต่ละรายที่คุณใช้ หากใช้เฉพาะ OpenRouter ดูคำแนะนำด้านล่างที่ [วิธีรับคีย์ API ฟรีจาก OpenRouter](#how-to-get-an-api-key-desktop-app) หากคุณไม่ต้องการใช้คีย์ API คุณสามารถติดตั้ง Ollama (จาก [ollama.com](https://ollama.com)) และใช้โมเดลในเครื่องแทน เช่น `translategemma:4b`
...
ในโหมด **ง่าย** แถบเครื่องมือจะแสดงตัวเลือก **ทักษะ** (ฟรี เร็ว ขั้นสูง เทคนิค กฎหมาย และการตั้งค่าล่วงหน้าอื่นๆ) ทักษะเหล่านี้ขึ้นอยู่กับ **ผู้ให้บริการ** ที่คุณเลือกใน [**ตั้งค่า** > **การตั้งค่าทั่วไป**](#general-settings) หาก **ผู้ให้บริการ** คือ **Ollama** แถบเครื่องมือจะแสดงโมเดลในเครื่องที่ติดตั้งไว้แทนทักษะ
...
- **Easy** (ค่าเริ่มต้น): เลือก **ผู้ให้บริการ** (OpenRouter, OpenAI, Anthropic, Google Gemini, DeepSeek, Groq, Mistral, xAI, Cerebras หรือ Ollama) ผู้ให้บริการคลาวด์ใช้ชุดค่าเริ่มต้นทักษะในแถบเครื่องมือ **Ollama** จะแสดงรายการโมเดลที่ติดตั้งในเครื่องของคุณแทนทักษะ
- **ขั้นสูง**: เลือกโมเดลแต่ละตัวในแถบเครื่องมือ; จัดการรายการภายใต้ [**ตั้งค่า** > **โมเดล**](#models)

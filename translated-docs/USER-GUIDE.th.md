...
หลังจากการแปลที่ประสบความสำเร็จ คุณสามารถปรับปรุงผลลัพธ์ในแผงข้อมูลส่งออก:

1. **แปลใหม่…** — เมื่อไม่มีข้อความที่เลือกในข้อมูลส่งออก ให้รับการแปลเต็มรูปแบบอีกครั้งของข้อมูลนำเข้าด้วยคำที่แตกต่างกัน คุณสามารถเก็บเวอร์ชันได้สูงสุด **ห้า** เวอร์ชันและสลับระหว่างพวกมันในเมนูดรอปดาวน์เวอร์ชัน เมื่อมีการเลือกข้อความ **แปลใหม่…** จะเปิดตัวเลือกคำใกล้กับการเลือก (เหมือนกับการคลิกขวา) หากไม่มีการเลือก **แปลใหม่…** จะถูกปิดใช้งานเมื่อคุณถึงห้าเวอร์ชัน; เมื่อมีการเลือก มันยังทำงานได้ที่ห้าเวอร์ชัน (ตัวเลือกคำเท่านั้น อัปเดตเวอร์ชัน 5).
2. **ตัวเลือกคำ** — เลือกหนึ่งหรือหลายคำในข้อมูลส่งออก (หากคุณเลือกเพียงบางส่วนของคำ แอปจะขยายการเลือกเป็นคำเต็ม) จากนั้นคลิกขวาหรือคลิก **แปลใหม่…** รายการตัวเลือกสั้น ๆ จะปรากฏใกล้กับการเลือก; คลิกหนึ่งเพื่อแทนที่ หากคุณมีเวอร์ชันน้อยกว่าห้า เวอร์ชันที่แก้ไขจะถูกบันทึกเป็นเวอร์ชันใหม่; ที่ห้าเวอร์ชัน จะมีการอัปเดตเฉพาะ **เวอร์ชัน 5** เท่านั้น คลิกขวาโดยไม่มีการเลือกจะไม่มีอะไรเกิดขึ้น กด **Esc** หรือคลิกนอกรายการเพื่อยกเลิกโดยไม่เปลี่ยนแปลงข้อมูลส่งออก.
3. **ค่าใช้จ่าย** — การ **แปลใหม่…** แบบเต็มแต่ละครั้ง (ไม่มีการเลือก) และการขอทางเลือกคำแต่ละครั้งจะใช้โมเดลอีกครั้งและอาจเพิ่มค่าใช้จ่ายในการใช้งาน (เช่นเดียวกับการแปลปกติ).

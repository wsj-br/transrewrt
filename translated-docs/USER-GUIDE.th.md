...
- [การแปลง](#transform)
  - [การเรียกใช้พรอมต์ที่มีอยู่](#run-an-existing-prompt)
  - [หากคุณยังไม่มีพรอมต์](#if-you-have-no-prompts-yet)
  - [การสร้างพรอมต์อย่างรวดเร็ว](#create-a-prompt-quickly)
  - [การแก้ไขพรอมต์](#edit-a-prompt)
  - [การทดสอบพรอมต์ก่อนใช้งาน](#test-a-prompt-before-using-it)
- [แดชบอร์ด](#dashboard)
  - [การกรองข้อมูล](#filter-the-data)
  - [แท็บแดชบอร์ด](#dashboard-tabs)
  - [การส่งออกข้อมูล](#export-data)
  - [การลบข้อมูลที่บันทึกไว้สำหรับโมเดล](#delete-stored-records-for-a-model)
- [ประวัติ](#history)
  - [การกรองประวัติ](#filter-the-history)
  - [การส่งออกข้อมูลประวัติ](#export-history-data)
- [การตั้งค่า](#settings)
  ...
  - [คำศัพท์ (แท็บการตั้งค่า)](#glossary-settings-tab)
  - [ผู้ใช้](#users)
...
- [ปัญหาทั่วไป](#common-issues)
  ...
  - [สรุปแดชบอร์ดดูเหมือนว่างเปล่า](#dashboard-summary-looks-empty)
  - [ค่าใช้จ่ายแสดง "ไม่พร้อมใช้งาน" หรือดูเหมือนไม่ถูกต้อง](#cost-shows-not-available-or-seems-wrong)
  - [ค่าใช้จ่ายรวมไม่ตรงกับใบแจ้งหนี้ของผู้ให้บริการของฉัน](#total-cost-does-not-match-my-provider-bill)
  - [หน้าประวัติหายไปจากแถบด้านข้าง](#the-history-page-is-missing-from-the-sidebar)
  - [เว็บแอป: เปลี่ยนเส้นทางไปยังหน้าเข้าสู่ระบบโดยไม่คาดคิด](#web-app-redirected-to-the-login-page-unexpectedly)
  - [เว็บผู้ดูแลระบบ: ลืมหรือทำรหัสผ่านหาย](#web-admin-forgot-or-lost-a-password)
  - [แดชบอร์ดไม่แสดงข้อมูลสำหรับผู้ใช้อื่น (เว็บ)](#dashboard-shows-no-data-for-other-users-web)
  - [ฉันแก้ไขพรอมต์แล้วทำสำเนาที่แก้ไขหายไป](#i-changed-a-prompt-and-lost-the-edits)

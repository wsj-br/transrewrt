---
translation_last_updated: '2026-05-27T10:08:09.017Z'
...
โดยค่าเริ่มต้น แอปจะทำงานในโหมด **ง่าย**: คุณเลือก **พรีเซ็ต** (เช่น ฟรี (OpenRouter), ไลต์ หรือ เทคนิคัล) และ **ผู้ให้บริการ** ในหน้าตั้งค่า โดยไม่ต้องเลือกโมเดล ID เปลี่ยนเป็นโหมด **ขั้นสูง** ที่ [**ตั้งค่า** > **การตั้งค่าทั่วไป**](#general-settings) หากคุณต้องการรายการโมเดลแบบคลาสสิกจาก [**ตั้งค่า** > **โมเดล**](#models)
...
- ในโหมด **ง่าย** คำว่า **พรีเซ็ต** คือพรีเซ็ต (เช่น ฟรี (OpenRouter), ไลต์, ขั้นสูง หรือ เทคนิคัล) ที่เชื่อมโยงกับโมเดลของ **ผู้ให้บริการ** ที่คุณเลือก (เช่น OpenRouter, OpenAI, Ollama และอื่นๆ) ทักษะที่มีการแมปไว้กับผู้ให้บริการปัจจุบันเท่านั้นที่จะแสดงในแถบเครื่องมือ คุณเลือกทักษะนี้ที่ปุ่มแปล เขียนใหม่ และแปลง
- ในโหมด **ขั้นสูง** คำว่า **โมเดล** คือเครื่องมือปัญญาประดิษฐ์ที่คุณเลือกโดยตรง โดยโมเดล ID จะใช้ **คำนำหน้าผู้ให้บริการ** (เช่น `openrouter/…`, `openai/…`, `ollama/…`)
...
ในโหมด **ง่าย** แถบเครื่องมือจะแสดงตัวเลือก **พรีเซ็ต** ที่มีพรีเซ็ตในตัว ได้แก่ **ฟรี (OpenRouter)**, **ไลต์**, **ขั้นสูง** และ **เทคนิคัล** พรีเซ็ตที่ปรากฏขึ้นขึ้นอยู่กับ **ผู้ให้บริการ** ที่คุณเลือกใน [**ตั้งค่า** > **การตั้งค่าทั่วไป**](#general-settings) — ตัวอย่างเช่น **ฟรี (OpenRouter)** จะแสดงเฉพาะเมื่อผู้ให้บริการคือ OpenRouter หาก **ผู้ให้บริการ** คือ **Ollama** แถบเครื่องมือจะแสดงโมเดลในเครื่องที่ติดตั้งไว้แทนพรีเซ็ต
...
- **ง่าย** (ค่าเริ่มต้น): เลือก **ผู้ให้บริการ** (OpenRouter, OpenAI, Anthropic, Google Gemini, DeepSeek, Groq, Mistral, xAI, Cerebras หรือ Ollama) ผู้ให้บริการบนคลาวด์จะใช้พรีเซ็ตในตัวที่อยู่ในแถบเครื่องมือ ส่วน **Ollama** จะแสดงรายการโมเดลที่ติดตั้งไว้ในเครื่องของคุณแทนพรีเซ็ต ในโหมดง่าย หน้า **แคตตาล็อกพรีเซ็ต** จะแสดงเวอร์ชันของแคตตาล็อกและเวลาอัปเดตล่าสุด คลิก **รีเฟรชแคตตาล็อกพรีเซ็ต** เพื่อดึงรายการทักษะล่าสุดจากที่เก็บข้อมูลโครงการ (แอปจะตรวจสอบอัตโนมัติเป็นระยะในพื้นหลัง)
...
- เลือกพรีเซ็ต (โหมดง่าย) หรือโมเดล (โหมดขั้นสูง) ตัวอื่น
- ใช้ข้อมูลนำเข้าที่สั้นลง
- ปิด **การแปลแบบเรียลไทม์ (ขณะพิมพ์)** ที่ [**ตั้งค่า** > **การตั้งค่าทั่วไป**](#general-settings)
- ใช้โมเดลฟรีสำหรับงานง่ายๆ (ดูที่ [โมเดล](#models))

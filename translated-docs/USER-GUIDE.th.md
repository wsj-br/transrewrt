---
translation_last_updated: '2026-05-21T23:14:55.544Z'
...
โดยค่าเริ่มต้น แอปจะทำงานในโหมด **ง่าย**: คุณเลือก **ทักษะ** (ตัวอย่างเช่น ฟรี (OpenRouter), Lite หรือ Technical) และ **ผู้ให้บริการ** ในส่วนตั้งค่า โดยไม่ต้องเลือก ID ของโมเดล ให้เปลี่ยนไปใช้โหมด **ขั้นสูง** ใน [**ตั้งค่า** > **การตั้งค่าทั่วไป**](#general-settings) หากคุณต้องการรายการโมเดลแบบคลาสสิกจาก [**ตั้งค่า** > **โมเดล**](#models)
...
- [ตั้งค่า](#settings)
  ...
  - [แปลง (แท็บตั้งค่า)](#transform-settings-tab)
  - [ผู้ใช้](#users)
...
- [ปัญหาทั่วไป](#common-issues)
  ...
  - [แดชบอร์ดสรุปว่างเปล่า](#dashboard-summary-looks-empty)
  - [ค่าใช้จ่ายแสดงว่า "ไม่มีอยู่" หรือดูผิดปกติ](#cost-shows-not-available-or-seems-wrong)
  - [ต้นทุนรวมไม่ตรงกับใบแจ้งหนี้จากผู้ให้บริการของฉัน](#total-cost-does-not-match-my-provider-bill)
...
- ในโหมด **ง่าย** คำว่า **ทักษะ** คือการตั้งค่าล่วงหน้า (ฟรี (OpenRouter), Lite, ขั้นสูง หรือ Technical) ที่เชื่อมโยงกับโมเดลสำหรับ **ผู้ให้บริการ** ที่คุณเลือก (OpenRouter, OpenAI, Ollama และอื่น ๆ) ทักษะที่มีการแมปสำหรับผู้ให้บริการปัจจุบันเท่านั้นที่จะปรากฏในแถบเครื่องมือ คุณเลือกทักษะนี้เมื่อใช้การแปล เขียนใหม่ หรือแปลง
- ในโหมด **ขั้นสูง** คำว่า **โมเดล** คือเครื่องมือปัญญาประดิษฐ์ที่คุณเลือกโดยตรง โดยใช้คำนำหน้าจาก **ผู้ให้บริการ** (ตัวอย่างเช่น `openrouter/…`, `openai/…`, `ollama/…`)
- **คีย์ API** (หรือสำหรับ Ollama คือ **URL พื้นฐาน**) คือวิธีที่แอปใช้ติดต่อกับผู้ให้บริการนั้น
...
5. ที่หน้า **แปล** เลือก **ทักษะ** (โหมดง่าย) หรือ **โมเดล** (โหมดขั้นสูง) ในแถบเครื่องมือ
6. เปิด [**ตั้งค่า** > **ภาษา**](#languages) และเลือก **ภาษาที่ใช้บ่อยที่สุด** หากคุณต้องการให้ภาษาที่คุณใช้บ่อยที่สุดแสดงขึ้นก่อน
7. ลองแปลข้อความง่ายๆ เพื่อยืนยันว่าทุกอย่างทำงานได้ จากนั้นลองใช้ **เขียนใหม่** และ **แปลง**

ลำดับนี้มีความสำคัญ มันช่วยป้องกันปัญหาที่พบบ่อยที่สุดสำหรับผู้ใช้ใหม่ คือการพยายามทำงานก่อนที่แอปจะมีการเชื่อมต่อ API ที่ใช้งานได้ หรือยังไม่ได้เลือกทักษะ/โมเดล
...
- ด้านซ้ายแสดงชื่อหน้าปัจจุบัน
- ด้านขวาแสดงตัวเลือก **ทักษะหรือโมเดล** และตัวควบคุม **ภาษาอินเตอร์เฟซ**

ในโหมด **ง่าย** แถบเครื่องมือจะแสดง **ตัวเลือกทักษะ** พร้อมการตั้งค่าล่วงหน้าในตัว ได้แก่ **ฟรี (OpenRouter)**, **Lite**, **ขั้นสูง** และ **Technical** ทักษะที่ปรากฏขึ้นจะขึ้นอยู่กับ **ผู้ให้บริการ** ที่คุณเลือกใน [**ตั้งค่า** > **การตั้งค่าทั่วไป**](#general-settings) — ตัวอย่างเช่น **ฟรี (OpenRouter)** จะแสดงเฉพาะเมื่อผู้ให้บริการคือ OpenRouter หาก **ผู้ให้บริการ** คือ **Ollama** แถบเครื่องมือจะแสดงโมเดลในเครื่องที่ติดตั้งไว้แทนทักษะ
...
4. เลือกทักษะ (โหมดง่าย) หรือโมเดล (โหมดขั้นสูง) ในแถบเครื่องมือ
...
- **พฤติกรรมสำหรับ ENTER** ควบคุมสิ่งที่เกิดขึ้นเมื่อคุณกด `Enter`:
  - **Enter** จะเรียกใช้การแปลหรือเขียนใหม่ (ค่าเริ่มต้น)
  - **Shift + Enter** จะเรียกใช้การแปลหรือเขียนใหม่ ส่วนการกด **Enter** ธรรมดาจะขึ้นบรรทัดใหม่
...
4. เลือกทักษะ (โหมดง่าย) หรือโมเดล (โหมดขั้นสูง)
...
เมื่อคุณใช้ **Generate prompt**, **Improve prompt** หรือ **Translate prompt** ในตัวแก้ไขพรอมต์ โหมด **Easy** จะมีตัวเลือกทักษะเหมือนกับการแปลและเขียนใหม่ ส่วนโหมด **Advanced** จะใช้รายการโมเดล
...
ในโหมด **Easy** การเลือกโมเดลจะเกิดขึ้นผ่านทักษะในแถบเครื่องมือและ **ผู้ให้บริการ** ในการตั้งค่าทั่วไป; แท็บ **โมเดล** จะถูกซ่อนไว้

<br/>

> ℹ️ **หมายเหตุ**<br/>
> ในรุ่นเว็บ ผู้ใช้แต่ละคนมีการตั้งค่าของตนเอง การตั้งค่า เช่น ประสบการณ์ AI ผู้ให้บริการ โมเดลหรือทักษะที่เลือก ภาษา ตัวเลือกทั่วไป และพรอมต์แปลง จะถูกจัดเก็บแยกตามผู้ใช้ การเปลี่ยนแปลงที่คุณทำจะไม่ส่งผลต่อผู้ใช้คนอื่น
...
- **ง่าย** (ค่าเริ่มต้น): เลือก **ผู้ให้บริการ** (OpenRouter, OpenAI, Anthropic, Google Gemini, DeepSeek, Groq, Mistral, xAI, Cerebras หรือ Ollama) ผู้ให้บริการบนคลาวด์จะใช้การตั้งค่าล่วงหน้าทักษะในตัวที่มีในแถบเครื่องมือ **Ollama** จะแสดงรายการโมเดลที่ติดตั้งไว้ในเครื่องของคุณแทนทักษะ ในโหมดง่าย **แคตตาล็อกทักษะ** จะแสดงเวอร์ชันของแคตตาล็อกและเวลาอัปเดตล่าสุด คลิก **รีเฟรชแคตตาล็อกทักษะ** เพื่อดึงรายการทักษะล่าสุดจากที่เก็บข้อมูลโครงการ (แอปจะตรวจสอบอัตโนมัติเป็นระยะในพื้นหลังด้วย)
- **ขั้นสูง**: เลือกโมเดลแต่ละตัวในแถบเครื่องมือ จัดการรายการได้ที่ [**ตั้งค่า** > **โมเดล**](#models)

ใน **เว็บแอป** ผู้ให้บริการที่ปรากฏขึ้นขึ้นอยู่กับคีย์ API ที่ตั้งไว้ในสภาพแวดล้อมของเซิร์ฟเวอร์ ส่วนใน **เดสก์ท็อปแอป** ให้ตั้งค่าคีย์ภายใต้ [**การตั้งค่า API**](#api-config)
...
**สำรองข้อมูลการตั้งค่า** (เฉพาะผู้ดูแลแอปเดสก์ท็อปและเว็บเท่านั้น)
...
- คุณได้เลือก **ทักษะ** (ง่าย) หรือ **โมเดล** (ขั้นสูง) ในแถบเครื่องมือแล้ว
- ในโหมด **ง่าย** ให้ตรวจสอบว่า [**ตั้งค่า** > **การตั้งค่าทั่วไป**](#general-settings) มีการตั้งค่า **ผู้ให้บริการ** ที่มีคีย์ใช้งานได้ (หรือ URL ของ Ollama) และมีทักษะอย่างน้อยหนึ่งรายการสำหรับผู้ให้บริการนั้น
- ในโหมด **ขั้นสูง** ต้องมีการระบุโมเดลอย่างน้อยหนึ่งโมเดลใน [**ตั้งค่า** > **โมเดล**](#models)
...
- เลือกทักษะ (โหมดง่าย) หรือโมเดล (โหมดขั้นสูง) ตัวอื่น

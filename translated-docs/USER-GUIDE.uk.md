---
translation_last_updated: '2026-05-02T22:50:42.787Z'
...
- **Переписати** - перефразувати текст в іншому стилі, наприклад чіткіше, коротше або більш формально.
- **Перетворити** - обробити текст за допомогою користувацьких інструкцій ШІ, які називаються запитами.
...
- Регулярно експортуйте підказки, якщо ви створюєте бібліотеку підказок, яку хочете зберегти (див. [Перетворені підказки](#transform-prompts)), або якщо хочете поділитися нею з іншими.

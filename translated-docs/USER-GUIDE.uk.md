...
- [Трансформація](#transform)
  - [Запуск наявного запиту](#run-an-existing-prompt)
  - [Якщо у вас ще немає запитів](#if-you-have-no-prompts-yet)
  - [Швидке створення запиту](#create-a-prompt-quickly)
...
- [Історія](#history)
  - [Фільтрація історії](#filter-the-history)
...
- [Поширені проблеми](#common-issues)
  - [Програма не перекладає, не перезаписує та не трансформує текст](#the-app-will-not-translate-rewrite-or-transform-text)
  ...
  - [Інтерфейс мовою оригіналу](#the-interface-is-in-the-wrong-language)
  - [Текст занадто дрібний або важко читається](#the-text-is-too-small-or-hard-to-read)
  ...
  - [Загальна вартість не збігається з рахунком постачальника](#total-cost-does-not-match-my-provider-bill)
  - [Сторінка історії відсутня на бічній панелі](#the-history-page-is-missing-from-the-sidebar)
  ...
  - [На панелі керування немає даних для інших користувачів (веб)](#dashboard-shows-no-data-for-other-users-web)

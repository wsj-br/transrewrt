...
export const styles = {
  ...
  summaryDashboard: "grid grid-cols-2 grid-rows-2 gap-[clamp(8px,1.5vh,20px)] flex-[1_0_auto] min-h-[360px] overflow-hidden",
  byUsageDashboard: "grid grid-cols-2 grid-rows-2 gap-[clamp(8px,1.5vh,20px)] h-full min-h-0 overflow-hidden [&>*:nth-child(3)]:col-span-full [&>*:nth-child(3)]:justify-self-center [&>*:nth-child(3)]:w-[calc((100%-20px)/2)] [&>*:nth-child(3)]:min-w-0",
  byUsageChartBlock: "flex flex-col min-h-0 min-w-0",
  ...
  summaryKpiCell: "min-h-0 min-w-0 flex flex-col",
  ...
  summaryChartCellUsageSplit: "min-h-0 min-w-0 flex flex-col",
  ...
  summaryChartCell: "min-h-0 min-w-0 flex flex-col",

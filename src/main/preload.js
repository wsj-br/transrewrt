...
const api = {
  ...
  glossary: {
    ...
    getByLangPair: (sourceLang, targetLang) => ipcRenderer.invoke('glossary:getByLangPair', sourceLang, targetLang),
    create: (term) => ipcRenderer.invoke('glossary:create', term),
    update: (id, term) => ipcRenderer.invoke('glossary:update', id, term),
    delete: (id) => ipcRenderer.invoke('glossary:delete', id),
    import: (terms) => ipcRenderer.invoke('glossary:import', terms),
  },

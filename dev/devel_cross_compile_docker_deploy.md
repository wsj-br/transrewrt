...
ssh pi-piro "docker stop transrewrt-web && docker rmi -f wsj-br/transrewrt:devel"

### 3. Transfer the image to pi-piro
docker save wsj-br/transrewrt:devel | ssh pi-piro "docker load"

### 4. Create a named volume for data persistence (if not exists)
ssh pi-piro "docker volume create transrewrt-data"

### 5. Run the image on pi-piro with volume mount
ssh pi-piro "docker run -d --rm -p 5000:5000 -v transrewrt-data:/app/data --name transrewrt-web wsj-br/transrewrt:devel"
...
- **Named volume** (recommended): `-v transrewrt-data:/app/data`

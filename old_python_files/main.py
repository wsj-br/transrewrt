...
class App(ctk.CTk):
    ...
    def update_stats(self, text, label):
        ...
        label.configure(
            text=f"Chars: {chars} | Words: {words} | Paragraphs: {paragraphs}"
        )
...
if __name__ == "__main__":
    ...
    def signal_handler(sig, frame):
        ...
        try:
            ...
            # Destroy any toplevel windows (dialogs)
    ...
    # For Windows, we need to periodically check for signals
    # since tkinter's mainloop blocks signal handling
    def check_signals():
        app.after(100, check_signals)  # Check every 100ms
